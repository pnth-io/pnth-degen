...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    78672: (e, i, t) => {
      t.d(i, { floor: () => r, convertToInt: () => o, limitedPrecision: () => l });
      var n = t(43434);
      function r(e) {
        return Math.floor(e);
      }
    ...
    85842: (e, i, t) => {
      ...
      const u = new o.TranslatedString(
        ...
        y = new o.TranslatedString('change HLC bars', (0, r.t)('change HLC bars')),
        g = new o.TranslatedString('change bar up color', (0, r.t)('change bar up color')),
        f = new o.TranslatedString('change bar down color', (0, r.t)('change bar down color')),
        b = new o.TranslatedString('change thin bars', (0, r.t)('change thin bars')),
        S = new o.TranslatedString('change line price source', (0, r.t)('change line price source')),
        w = new o.TranslatedString('change line type', (0, r.t)('change line type')),
        T = new o.TranslatedString('change line color', (0, r.t)('change line color')),
        P = new o.TranslatedString('change line width', (0, r.t)('change line width')),
        m = new o.TranslatedString('change area price source', (0, r.t)('change area price source')),
        v = new o.TranslatedString('change area line color', (0, r.t)('change area line color')),
        D = new o.TranslatedString('change area line width', (0, r.t)('change area line width')),
        _ = new o.TranslatedString('change area fill color', (0, r.t)('change area fill color')),
        C = new o.TranslatedString('change baseline price source', (0, r.t)('change baseline price source')),
        k = new o.TranslatedString('change baseline top line color', (0, r.t)('change baseline top line color')),
        M = new o.TranslatedString('change baseline top line width', (0, r.t)('change baseline top line width')),
        L = new o.TranslatedString('change baseline bottom line color', (0, r.t)('change baseline bottom line color')),
        I = new o.TranslatedString('change baseline bottom line width', (0, r.t)('change baseline bottom line width')),
        ...
        E = new o.TranslatedString('change base level', (0, r.t)('change base level')),
        V = new o.TranslatedString('change high-low body visibility', (0, r.t)('change high-low body visibility')),
        j = new o.TranslatedString('change high-low body color', (0, r.t)('change high-low body color')),
        N = new o.TranslatedString(
          'change high-low borders visibility',
          (0, r.t)('change high-low borders visibility'),
        ),
        $ = new o.TranslatedString('change high-low border color', (0, r.t)('change high-low border color')),
        A = new o.TranslatedString('change high-low labels visibility', (0, r.t)('change high-low labels visibility')),
        W = new o.TranslatedString('change high-low labels color', (0, r.t)('change high-low labels color')),
        x = new o.TranslatedString('change high-low labels font size', (0, r.t)('change high-low labels font size')),
        z =
          (new o.TranslatedString('change renko wick visibility', (0, r.t)('change renko wick visibility')),
          new o.TranslatedString('change renko wick up color', (0, r.t)('change renko wick up color')),
          new o.TranslatedString('change renko wick down color', (0, r.t)('change renko wick down color')),
          new o.TranslatedString(
            'change the display of real prices on price scale (instead of Heiken-Ashi price)',
            (0, r.t)('change the display of real prices on price scale (instead of Heiken-Ashi price)'),
          ),
          new o.TranslatedString('change range thin bars', (0, r.t)('change range thin bars')),
          new o.TranslatedString(
            'change {candleType} body visibility',
            (0, r.t)('change {candleType} body visibility'),
          )),
        H = new o.TranslatedString('change {candleType} up color', (0, r.t)('change {candleType} up color')),
        F = new o.TranslatedString('change {candleType} down color', (0, r.t)('change {candleType} down color')),
        ...
        J = new o.TranslatedString('change {candleType} wick up color', (0, r.t)('change {candleType} wick up color')),
        K = new o.TranslatedString(
          'change {candleType} wick down color',
          (0, r.t)('change {candleType} wick down color'),
        ),
        q =
          (new o.TranslatedString('change {chartType} up color', (0, r.t)('change {chartType} up color')),
          new o.TranslatedString('change {chartType} down color', (0, r.t)('change {chartType} down color')),
          new o.TranslatedString(
      ...
      function fe(e, i, t, n) {
        ...
        return [
          (0, l.createTwoColorsPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(e, i.drawBody, z.format({ candleType: t })),
              color1: (0, l.getColorDefinitionProperty)(e, i.upColor, null, H.format({ candleType: t })),
              color2: (0, l.getColorDefinitionProperty)(e, i.downColor, null, F.format({ candleType: t })),
            },
            { id: `${n}Symbol${r}CandlesColor`, title: ie },
          ),
          (0, l.createTwoColorsPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(e, i.drawBorder, U.format({ candleType: t })),
              color1: (0, l.getColorDefinitionProperty)(e, i.borderUpColor, null, R.format({ candleType: t })),
              color2: (0, l.getColorDefinitionProperty)(e, i.borderDownColor, null, Y.format({ candleType: t })),
            },
            { id: `${n}Symbol${r}BordersColor`, title: te },
          ),
          (0, l.createTwoColorsPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(e, i.drawWick, G.format({ candleType: t })),
              color1: (0, l.getColorDefinitionProperty)(e, i.wickUpColor, null, J.format({ candleType: t })),
              color2: (0, l.getColorDefinitionProperty)(e, i.wickDownColor, null, K.format({ candleType: t })),
            },
        ...
        switch (t) {
            ...
            return (function (e, i, t) {
              return [
                (0, l.createCheckablePropertyDefinition)(
                  { checked: (0, l.convertToDefinitionProperty)(e, i.barColorsOnPrevClose, u) },
                  { id: t + 'SymbolBarStyleBarColorsOnPrevClose', title: q },
                ),
                (0, l.createCheckablePropertyDefinition)(
                  { checked: (0, l.convertToDefinitionProperty)(e, i.dontDrawOpen, y) },
          ...
          case 1:
            return (function (e, i, t) {
              return [
                ...
                ...fe(e, i, new o.TranslatedString('candle', (0, r.t)('candle')), t),
              ];
            ...
            return (function (e, i, t, n, r) {
              return [
                (0, l.createOptionsPropertyDefinition)(
                  { option: (0, l.convertToDefinitionProperty)(e, i.priceSource, S) },
                  { id: r + 'SymbolLinePriceSource', title: re, options: new (c())(t) },
                ),
                (0, l.createOptionsPropertyDefinition)(
                  { option: (0, l.convertToDefinitionProperty)(e, i.styleType, w) },
                  { id: r + 'SymbolStyleType', title: oe, options: new (c())(n) },
                ),
                (0, l.createLinePropertyDefinition)(
                  {
                    color: (0, l.getColorDefinitionProperty)(e, i.color, null, T),
          ...
          case 3:
            return (function (e, i, t, n) {
              return [
                (0, l.createOptionsPropertyDefinition)(
                  { option: (0, l.convertToDefinitionProperty)(e, i.priceSource, m) },
                  { id: n + 'SymbolAreaPriceSource', title: re, options: new (c())(t) },
                ),
                (0, l.createLinePropertyDefinition)(
                  {
                ...
                (0, l.createTwoColorsPropertyDefinition)(
                  {
                    color1: (0, l.getColorDefinitionProperty)(e, i.color1, i.transparency, _),
                    color2: (0, l.getColorDefinitionProperty)(e, i.color2, i.transparency, _),
                  },
          ...
          case 9:
            return fe(
              ...
              new o.TranslatedString('hollow candles', (0, r.t)('hollow candles')),
              h,
            );
          case 10:
            return (function (e, i, t, n) {
              return [
                (0, l.createOptionsPropertyDefinition)(
                  { option: (0, l.convertToDefinitionProperty)(e, i.priceSource, C) },
                  { id: n + 'SymbolBaseLinePriceSource', title: re, options: new (c())(t) },
                ),
                (0, l.createLinePropertyDefinition)(
                  {
                    color: (0, l.getColorDefinitionProperty)(e, i.topLineColor, null, k),
                    width: (0, l.convertToDefinitionProperty)(e, i.topLineWidth, M),
                  },
                  { id: n + 'SymbolBaseLineTopLine', title: se },
                ),
                (0, l.createLinePropertyDefinition)(
                  {
                    color: (0, l.getColorDefinitionProperty)(e, i.bottomLineColor, null, L),
                    width: (0, l.convertToDefinitionProperty)(e, i.bottomLineWidth, I),
                  },
                  { id: n + 'SymbolBaseLineBottomLine', title: ae },
                ),
                (0, l.createTwoColorsPropertyDefinition)(
                  {
                    color1: (0, l.getColorDefinitionProperty)(e, i.topFillColor1, null, B),
                    color2: (0, l.getColorDefinitionProperty)(e, i.topFillColor2, null, B),
                  },
                  { id: n + 'SymbolBaseLineTopFills', title: de },
                ),
                (0, l.createTwoColorsPropertyDefinition)(
                  {
                    color1: (0, l.getColorDefinitionProperty)(e, i.bottomFillColor1, null, O),
                    color2: (0, l.getColorDefinitionProperty)(e, i.bottomFillColor2, null, O),
                  },
                  { id: n + 'SymbolBaseLineBottomFills', title: pe },
                ),
                (0, l.createNumberPropertyDefinition)(
                  { value: (0, l.convertToDefinitionProperty)(e, i.baseLevelPercentage, E, [p.floor]) },
                  {
          ...
          return (function (e, i, t) {
            ...
            return (
              n.push(
                ...
                ...fe(e, i, new o.TranslatedString('Heikin Ashi', (0, r.t)('Heikin Ashi')), t),
              ),
              n
            );
          ...
          return (function (e, i, t, n) {
            const r = (0, l.createColorPropertyDefinition)(
              ...
              o = (0, l.createColorPropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(e, i.showBorders, N),
                  color: (0, l.getColorDefinitionProperty)(e, i.borderColor, null, $),
                },
              ...
              (0, l.createTextPropertyDefinition)(
                {
                  ...
                  color: (0, l.getColorDefinitionProperty)(e, i.labelColor, null, W),
                  size: (0, l.convertToDefinitionProperty)(e, i.fontSize, x),
                },
                { id: n + 'SymbolLabels', title: ge, isEditable: !1, isMultiLine: !1, sizeItems: s },
              ),
            ];
    ...
    25019: (e, i, t) => {
      ...
      var n = t(16282),
        ...
        u = t(85842),
        y = t(78672);
      const g = new o.TranslatedString('change {inputName} property', (0, r.t)('change {inputName} property'));
      function f(e) {
        ...
        return (
          t.forEach((t) => {
            ...
            if ('options' in t) {
              ...
              u.push(
                (0, l.createOptionsPropertyDefinition)(
                  { option: (0, l.convertToDefinitionProperty)(e, S, g.format({ inputName: P })) },
              ...
              if ('float' === t.type) {
                ...
                return (
                  ...
                  void u.push(
                    (0, l.createNumberPropertyDefinition)(
                      { value: (0, l.convertToDefinitionProperty)(e, S, g.format({ inputName: P })) },
                      { id: `${h}${t.name}`, title: T, type: 1, min: n, max: new (d())(t.max), defval: t.defval },
                    ),
                  )
                );
              }
              'text' !== t.type
                ? 'bool' !== t.type ||
                  u.push(
                    (0, l.createCheckablePropertyDefinition)(
                      { checked: (0, l.convertToDefinitionProperty)(e, S, g.format({ inputName: P })) },
                      { id: `${h}${t.name}`, title: T },
                    ),
                  )
                : u.push(
                    (0, l.createTextPropertyDefinition)(
                      { text: (0, l.convertToDefinitionProperty)(e, S, g.format({ inputName: P })) },
                      { id: `${h}${t.name}`, title: T, isEditable: !0, isMultiLine: !1 },
                    ),
                  );
            } else
              u.push(
                (0, l.createNumberPropertyDefinition)(
                  { value: (0, l.convertToDefinitionProperty)(e, S, g.format({ inputName: P }), [y.floor]) },
                  {
                    id: `${h}${t.name}`,
                    title: T,
                    type: 0,
      ...
      const P = (0, S.getLogger)('Chart.Definitions.Series'),
        m = new o.TranslatedString('change decimal places', (0, r.t)('change decimal places')),
        v = new o.TranslatedString('change timezone', (0, r.t)('change timezone')),
        D =
          (new o.TranslatedString('adjust data for dividends', (0, r.t)('adjust data for dividends')),
          new o.TranslatedString(
            'use settlement as close on daily interval',
            (0, r.t)('use settlement as close on daily interval'),
          ),
          new o.TranslatedString('adjust for contract changes', (0, r.t)('adjust for contract changes')),
          new o.TranslatedString('change session', (0, r.t)('change session')),
          new o.TranslatedString('change extended hours color', (0, r.t)('change extended hours color'))),
        _ = new o.TranslatedString('change pre market color', (0, r.t)('change pre market color')),
        C = new o.TranslatedString('change post market color', (0, r.t)('change post market color')),
        k = new o.TranslatedString('change price line visibility', (0, r.t)('change price line visibility')),
        M = new o.TranslatedString('change price line color', (0, r.t)('change price line color')),
        L = new o.TranslatedString('change price line width', (0, r.t)('change price line width')),
        I =
          (new o.TranslatedString(
          ...
          new o.TranslatedString('change pre market line color', (0, r.t)('change pre market line color')),
          new o.TranslatedString('change post market line color', (0, r.t)('change post market line color')),
          new o.TranslatedString(
            'change bid and ask lines visibility',
            (0, r.t)('change bid and ask lines visibility'),
          ),
          new o.TranslatedString('change bid line color', (0, r.t)('change bid line color')),
          new o.TranslatedString('change ask line color', (0, r.t)('change ask line color')),
          new o.TranslatedString(
        ...
        G = { [(0, p.chartStyleStudyId)(12)]: [7, 8, 9, 10, 11, 12, 14, 16, 20, 24, 28, 32, 40] },
        J = [
      ...
      class X {
        ...
        _updateDefinitions() {
          null !== this._definitions && (0, l.destroyDefinitions)(this._definitions),
            (this._definitions = null),
            this._unsubscribeInputsUpdate(),
            this._createSeriesDefinitions().then((e) => {
              if (this._isDestroyed) throw new Error('SeriesPropertyDefinitionsViewModel already destroyed');
              (0, n.ensureNotNull)(this._propertyPages)[0].definitions.setValue(e);
            });
        }
        _getDefinitions() {
          ...
          return new Promise((e) => {
            ...
            null !== l
              ? this._model
                  ...
                  .catch((i) => {
                    P.logWarn('Find meta info for create series definitions with error - ' + (0, w.errorToString)(i)),
                      e(null);
                  })
              : e(null);
          }).then((i) => {
            ...
            const t = (0, u.getSeriesStylePropertiesDefinitions)(
              ...
              e,
              r,
              { seriesPriceSources: K, lineStyleTypes: q, isJapaneseChartsAvailable: !0, defaultSeriesFontSizes: G },
              'mainSeries',
            );
            null !== i && t.push(...i);
            const n = (0, l.createOptionsPropertyDefinition)(
                { option: (0, l.convertToDefinitionProperty)(this._undoModel, e.minTick, m) },
                { id: o + 'SymbolMinTick', title: E, options: new (d())(Q()) },
              ),
              s = (0, l.createOptionsPropertyDefinition)(
                { option: (0, l.convertToDefinitionProperty)(this._undoModel, this._timezonePropertyObj.property, v) },
                { id: o + 'SymbolTimezone', title: V, options: new (d())(this._timezonePropertyObj.values) },
              );
            return (
              (this._definitions = [
        ...
        _createOutOfSessionDefinition(e) {
          ...
          return (0, l.createColorPropertyDefinition)(
            { color: (0, l.getColorDefinitionProperty)(this._undoModel, i.color, i.transparency, D) },
        ...
        _createPrePostMarketDefinition(e) {
          const i = this._model.sessions(),
            ...
            n = i.properties().childs().graphics.childs().backgrounds.childs().postMarket.childs();
          return (0, l.createTwoColorsPropertyDefinition)(
            {
              color1: (0, l.getColorDefinitionProperty)(this._undoModel, t.color, t.transparency, _),
              color2: (0, l.getColorDefinitionProperty)(this._undoModel, n.color, n.transparency, C),
            },
            { id: e + 'SymbolExtendedHoursColors', title: B },
          );
        }
        _seriesPriceLinesDefinitions(e) {
          ...
          if (this._series.hasClosePrice()) {
            const n = (0, l.createLinePropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._undoModel, t.showPriceLine, k),
                color: (0, l.getColorDefinitionProperty)(this._undoModel, t.priceLineColor, null, M),
                width: (0, l.convertToDefinitionProperty)(this._undoModel, t.priceLineWidth, L),
              },
          ...
          const n = t.highLowAvgPrice.childs(),
            r = (0, T.combineProperty)((e, i) => e || i, n.highLowPriceLinesVisible, new (a())(!1)),
                ...
                checked: (0, l.convertToDefinitionProperty)(
                  ...
                  (e) => {
                    this._undoModel.beginUndoMacro(I),
                      this._undoModel.setProperty(n.highLowPriceLinesVisible, e, null),
