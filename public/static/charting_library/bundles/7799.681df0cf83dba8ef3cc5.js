  ...
  [7799],
  {
    ...
    62638: (e, t, n) => {
      ...
      function v(e) {
        ...
        return o.createElement(
          ...
          {
            ...C,
            className: i()(u.itemRow, h && !g && u.active, p && u.mobile, g && u.selected),
          ...
          E &&
            ...
            o.createElement(s.FavoriteButton, {
              className: i()(u.favoriteButton, b && u.favorite, l.CheckMobile.any() && u.mobile),
              isActive: h && !g,
              isFilled: b,
          ...
          o.createElement(
            ...
            o.createElement(
              'div',
              { className: i()(u.title, h && !g && u.active, p && u.mobile), 'data-name': 'list-item-title' },
              t,
            ),
            o.createElement('div', { className: i()(u.details, h && !g && u.active, p && u.mobile) }, n),
          ),
    ...
    27947: (e, t, n) => {
      ...
      function u(e) {
        ...
        (0, o.useEffect)(() => {
          ...
          return (
            E ? (m && m(), e && (e.addEventListener('mousemove', x), e.addEventListener('mouseup', L))) : h && h(),
            () => {
              e && (e.removeEventListener('mousemove', x), e.removeEventListener('mouseup', L));
            }
          );
        }, [E]);
        const N = t / n || 0,
        ...
        return o.createElement(
          'div',
          {
            ...
            onMouseDown: function (e) {
              ...
              const r = n - t;
              let i = B(e.nativeEvent, (0, l.ensureNotNull)(b.current)) - w.current;
              i < 0
                ? ((i = 0), (w.current = B(e.nativeEvent, (0, l.ensureNotNull)(b.current))))
                : i > r * N * D &&
                  ((i = r * N * D), (w.current = B(e.nativeEvent, (0, l.ensureNotNull)(b.current)) - i));
              v(i / N / D), C(!0);
            },
          },
          o.createElement(
            'div',
            {
              ...
              onMouseDown: function (e) {
                e.preventDefault(), (w.current = B(e.nativeEvent, (0, l.ensureNotNull)(p.current))), C(!0);
              },
            },
            o.createElement('div', { className: i()(f.barInner, d && f['barInner--horizontal']) }),
          ),
        );
        function x(e) {
      ...
      function f(e) {
        ...
        return o.createElement(
          'div',
          { ...p, ref: t, className: r(n, d.scrollWrap), style: { visibility: g || b || E ? 'visible' : 'hidden' } },
          w &&
            o.createElement(u, {
              size: i - k,
              scrollSize: s - k,
    ...
    65043: (e, t, n) => {
      ...
      var o = n(79881),
        ...
        c = n(23204),
        a = n(69560);
      const u = { add: (0, o.t)('Add to favorites'), remove: (0, o.t)('Remove from favorites') };
      function v(e) {
        const { className: t, isFilled: n, isActive: o, onClick: v, ...d } = e;
        return r.createElement(l.Icon, {
          ...d,
          className: i(a.favorite, 'apply-common-tooltip', n && a.checked, o && a.active, t),
          icon: n ? s : c,
          onClick: v,
        ...
        const n = (0, o.useRef)(null),
          ...
          [v, d] = (0, o.useState)({
            ...
            onVerticalChange: function (e) {
              d((t) => ({ ...t, scrollPosTop: e })), ((0, r.ensureNotNull)(c.current).scrollTop = e);
            },
            onHorizontalChange: function (e) {
              d((t) => ({ ...t, scrollPosLeft: e })), ((0, r.ensureNotNull)(c.current).scrollLeft = e);
            },
            visible: a,
          }),
          f = (0, o.useCallback)(() => {
      ...
      function d(e) {
        ...
        return o.createElement(
          u,
          {
            ...
            role: n,
            'aria-selected': a,
            className: r(d, T.item, p && T.withIcon, { [T.isActive]: E, [T.isDisabled]: C || N, [T.hovered]: w }),
            title: f,
            href: S,
            target: I,
            rel: x,
            ...
            onClick: function (t) {
              const { dontClosePopup: n, onClick: o, onClickArg: r, trackEventObject: s } = e;
              if (C) return;
          ...
          void 0 !== p && o.createElement('div', { className: T.icon, dangerouslySetInnerHTML: { __html: p } }),
          o.createElement(
            'div',
            { className: r(T.labelRow, m) },
            o.createElement('div', { className: r(T.label, h) }, k),
          ),
          (void 0 !== g || b) && o.createElement('div', { className: T.shortcut }, (H = g) && H.split('+').join(' + ')),
          void 0 !== L &&
            o.createElement('div', { onClick: A ? v : void 0, className: r(T.toolbox, { [T.showOnHover]: D }) }, L),
        );
        var H;
      }
    },
    ...
    14303: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r.createElement(l.Icon, {
          ...f,
          'data-name': d,
          className: i(c.button, 'apply-common-tooltip', n && c.active, v && c.hidden, t),
          icon: s,
          onClick: o,
          title: u || a.remove,
        });
