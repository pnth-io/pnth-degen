(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8434],
  {
    ...
    66406: (e) => {
      e.exports = { loaderWrap: 'loaderWrap-2SapxxDI', big: 'big-2SapxxDI', loader: 'loader-2SapxxDI' };
    },
    30160: (e) => {
      e.exports = {
        item: 'item-f5BaKrKq',
      ...
      class c extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            'span',
            { className: r(l().loader, n && l().static, e, this._getStateClass()) },
        ...
        render() {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement('td', { className: i(a.iconCell), 'data-icon-cell': !0 }, this._icon(a)),
              s.createElement(
                'td',
                ...
                s.createElement(
                  ...
                  !e &&
                    t &&
                    !u.CheckMobile.any() &&
                    s.createElement(d.Hint, { className: i(o && a.invisibleHotkey), text: t }),
                  !e && !t && n && s.createElement(d.Hint, { text: n }),
                ),
              ),
            ),
            s.createElement('tr', { className: a.subMenu }, s.createElement('td', null, this.props.children)),
          );
        }
        _icon(e) {
      ...
      class I extends s.PureComponent {
        ...
        render() {
          ...
          const o = null !== (e = this.state.jsxLabel) && void 0 !== e ? e : this.state.label,
            r = (null === (t = this.context) || void 0 === t ? void 0 : t.current)
        ...
        _trackEvent() {
          ...
          (0, E.trackEvent)('ContextMenuClick', this.props.menuStatName || '', e);
        }
        _getStatName() {
    ...
    90590: (e, t, n) => {
      ...
      function d(e) {
        const {
          ...
          M = !!g.length;
        return n
          ? s.createElement('li', { className: r()(m.item, m.loading, m[N]) }, s.createElement(i.Loader, null))
          : s.createElement(
              'li',
              {
                className: r()(
              ...
              s.createElement('span', { className: r()(m.label) }, null != y ? y : E),
              !!w &&
                s.createElement(a.Icon, {
                  onClick: function () {
                    w && w.action();
    ...
    14303: (e, t, n) => {
      ...
      function u(e) {
        ...
        return o.createElement(a.Icon, {
          ...m,
          'data-name': p,
          className: r(l.button, 'apply-common-tooltip', n && l.active, h && l.hidden, t),
          icon: i,
          onClick: s,
          title: u || c.remove,
        });
