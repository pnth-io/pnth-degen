(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6456],
  {
    ...
    80511: (e, t, n) => {
      ...
      function d(e) {
        const { size: t, startIcon: n, icon: r, iconOnly: o, children: s, endIcon: c } = e,
          d = null != n ? n : r;
        return i.createElement(
          i.Fragment,
          null,
          d && 'xsmall' !== t && i.createElement(a.Icon, { icon: d, className: l()['start-icon-wrap'] }),
          s && i.createElement('span', { className: l().content }, s),
          c && !o && 'xsmall' !== t && i.createElement(a.Icon, { icon: c, className: l()['end-icon-wrap'] }),
        );
      }
      var u = n(94618),
        h = n(74818);
      ...
      function p(e) {
        const { reference: t, ...n } = e,
          { isGrouped: r, cellState: o, disablePositionAdjustment: a } = (0, i.useContext)(u.ControlGroupContext),
          s = c({ ...n, isGrouped: r, cellState: o, disablePositionAdjustment: a });
        return i.createElement('button', { ...m(n), className: s, ref: t }, i.createElement(d, { ...n }));
      }
      ...
      function b(e) {
        const { intent: t, size: n, appearance: i, useFullWidth: r, icon: o, ...a } = e;
        return { ...a, color: v(t), size: f(n), variant: g(i), stretch: r, startIcon: o };
      }
      function E(e) {
    ...
    40834: (e, t, n) => {
      ...
      function d(e) {
        ...
        return i.createElement(
          ...
          r && i.createElement('div', { className: c.cancel, onClick: r }, (0, a.t)('Cancel')),
        );
      }
      function u(e) {
        const {
    ...
    45745: (e, t, n) => {
      ...
      function h(e) {
        ...
        return i.createElement(
          'div',
          { ...h, className: o()(l.tab, p && l.isTablet, m && l.isMobile, d && l.active), onClick: u },
    ...
    36108: (e, t, n) => {
      ...
      function m(e) {
        ...
        const {
          ...
          m =
            (null == u ? void 0 : u.isChartPattern) || n.includes('CP@tv-basicstudies')
              ? 'chart-patterns'
              : l().getPackageName(n);
        return {
          id: n,
          ...
          isFundamental: !1,
          studyData: { id: n, version: d, descriptor: { type: 'java', studyId: e.id }, packageName: m },
          isGrayed: h,
        };
      }
      var p = n(94184),
      ...
      function _(e) {
        ...
        return i.createElement('div', { ref: t, className: g()(x.container, n), ...r, 'data-role': 'dialog-content' });
      }
      var w = n(77850);
      function C(e) {
        const { children: t, className: n, disabled: r } = e;
        return i.createElement('span', { className: g()(w.title, r && w.disabled, n) }, t);
      }
      ...
      function L(e) {
        const t = (0, i.useContext)(R),
          ...
          O = (0, S.useWatchedValueReadonly)({ watchedValue: N.watchedTheme }) === I.StdTheme.Dark ? T.dark : T.light,
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            i.createElement(
              C,
              { disabled: a.isGrayed },
              i.createElement(k.HighlightedText, { queryString: s, rules: l, text: a.title }),
            ),
            !1,
            c && i.createElement(BadgeIndicator, { type: 'beta', className: T.badge }),
            d && i.createElement(BadgeIndicator, { type: 'new', className: T.badge }),
            u && i.createElement(BadgeIndicator, { type: 'updated', className: T.badge }),
            x &&
              i.createElement(BadgeIndicator, { type: 'ep', className: T.badge, tooltip: (0, o.t)("Editors' picks") }),
          ),
          y &&
            i.createElement(
              'a',
              { href: y.authorLink, className: T.author, target: '_blank', onClick: D },
              y.authorName,
            ),
          'mobile' !== r && y && i.createElement('span', { className: T.likes }, y.likesCount),
          !1,
        );
      }
      function P(e, t) {
      ...
      function Z(e) {
        ...
        return i.createElement(
          ...
          a && s && i.createElement(A.Button, { onClick: s, className: q.button }, a),
        );
      }
      function H(e) {
      ...
      var W = n(65802),
        V = n(44809);
      function G(e) {
        const { reference: t, data: n, isOpened: r, onClose: a, applyStudy: s } = e,
          [l, c] = (0, i.useState)(''),
                    ...
                    S
                      ...
                      : u.length
                        ? i.createElement(
                            i.Fragment,
                            null,
                            i.createElement(M, null, i.createElement(B, { title: (0, o.t)('Script name') })),
                            u.map((e) => {
      ...
      class U extends class {
        ...
        _applyStudy(e, t) {
          var n, i;
          e.isGrayed
            ? j.emit('onGrayedObjectClicked', { type: 'study', name: e.shortDescription })
            : (b.CheckMobile.any() || null === (n = this._searchInputRef.current) || void 0 === n || n.select(),
    ...
    65802: (e, t, n) => {
      'use strict';
      n.d(t, { rankedSearch: () => r, createRegExpList: () => o, getHighlightedChars: () => a });
      var i = n(47903);
      function r(e) {
        const {
          data: t,
                ...
                return (
                  ...
                  t && t.toLowerCase() === r.toLowerCase()
                    ...
                    : (0, i.isString)(t) && h.test(t)
                      ? ((d = 2), void (c = null === (a = t.match(h)) || void 0 === a ? void 0 : a.index))
                      : (0, i.isString)(o) && h.test(o)
                        ? ((d = 1), void (c = null === (s = o.match(h)) || void 0 === s ? void 0 : s.index))
                        : void (
                            (0, i.isString)(o) &&
                            u.test(o) &&
