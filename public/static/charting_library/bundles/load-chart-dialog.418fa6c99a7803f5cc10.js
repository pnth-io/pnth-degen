  ...
  [5009],
  {
      ...
      function s(e, t) {
        return (o, s) => {
          const d = (0, l.ensureNotNull)(e).getBoundingClientRect(),
            ...
            C = { x: x - (g === a.FromRightToLeft ? o : 0) + f, y: S - (m === i.FromBottomToTop ? s : 0) + y };
    ...
    59879: (e, t, o) => {
      ...
      function y(e) {
        ...
        return n.createElement(
          'div',
          {
            ...r,
            ref: i,
            className: d(v.sortButton, 'apply-common-tooltip', 'common-tooltip-vertical'),
            onClick: function () {
              l(!a);
            },
          },
      ...
      function C(e) {
        ...
        return n.createElement(x.PopupMenuItem, {
          ...
          label: n.createElement(
            ...
            n.createElement(g.Icon, { className: S.icon, icon: 0 === a ? f : p }),
      ...
      var L = o(27947),
        z = o(2789);
      function P(e) {
        const { className: t, onScroll: o, onTouchStart: r, reference: i, children: a, scrollbar: l, ...s } = e,
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              'div',
              { ...('overlay' === l && g), className: u()(z.container, t), onTouchStart: r, onScrollCapture: o },
              'overlay' === l && n.createElement(L.OverlayScrollContainer, { ...h, className: z.overlayScrollWrap }),
      ...
      var H = o(54041),
        ...
        q = o(65802),
        $ = o(69040);
      const j = (0, a.t)("Do you really want to delete Chart Layout '{name}' ?");
      ...
      function X(e) {
        ...
        return (
          ...
          n.createElement(B.DialogContentItem, {
            url: g,
            title: n.createElement(V.HighlightedText, { className: y, queryString: l, rules: v, text: t.title }),
            subtitle: n.createElement(
              n.Fragment,
              null,
              n.createElement(V.HighlightedText, { className: y, queryString: l, rules: v, text: t.description }),
              ' ',
              '(',
        ...
        ee = (function (e) {
          ...
          return (0, n.forwardRef)(({ style: e, ...r }, i) => {
            ...
            return n.createElement('div', {
              ref: i,
              style: { ...e, height: ((0, b.isNumber)(a) ? a : parseFloat(a)) + t + o + 'px' },
              ...r,
            });
          });
        })({ paddingBottom: 6 });
      ...
      function oe(e) {
        const { charts: t, onClose: o, favoriteChartsService: r, chartWidgetCollection: d } = e,
          ...
          [D, b] = (0, n.useState)(() => l.getJSON('loadChartDialog.viewState', Y)),
          N = (0, n.useRef)(null),
          T = (0, n.useRef)(null),
          I = (0, n.useMemo)(() => t.map((e) => ({ ...e, description: `${e.symbol}, ${te(e.interval)}` })), [t]);
        (0, n.useEffect)(() => {
        ...
        return n.createElement(s.AdaptivePopupDialog, {
          ...
          render: function () {
            return n.createElement(
              n.Fragment,
              null,
              n.createElement(E.DialogSearch, { reference: N, onChange: O, placeholder: (0, a.t)('Search') }),
              n.createElement(
                w,
                null,
        ...
        function V(e, t) {
          ...
          b(o), l.setValue('loadChartDialog.viewState', JSON.stringify(o), { forceFlush: !0 }), W();
        }
      }
      var ne = o(58738);
      class re extends ne.DialogRenderer {
        ...
        show() {
          r.render(n.createElement(oe, { ...this._options, onClose: () => this.hide() }), this._container),
              ...
              o.forEach((e) => {
                ...
                return (
                  ...
                  t && t.toLowerCase() === r.toLowerCase()
                    ? ((d = 3), void (s = null === (o = t.match(m)) || void 0 === o ? void 0 : o.index))
                    : (0, n.isString)(t) && m.test(t)
                      ? ((d = 2), void (s = null === (a = t.match(m)) || void 0 === a ? void 0 : a.index))
                      : (0, n.isString)(i) && m.test(i)
                        ? ((d = 1), void (s = null === (l = i.match(m)) || void 0 === l ? void 0 : l.index))
                        : void (
                            (0, n.isString)(i) &&
                            u.test(i) &&
                            ((d = 1), (s = null === (c = i.match(u)) || void 0 === c ? void 0 : c.index))
                          )
                );
              }),
    ...
    11945: (e, t, o) => {
      ...
      function l(e) {
        const { queryString: t, rules: o, text: l, className: c } = e,
          s = (0, n.useMemo)(() => (0, i.getHighlightedChars)(t, l, o), [t, o, l]);
        return n.createElement(
          n.Fragment,
          null,
          s.length
            ? l
                ...
                .map((e, t) =>
                  n.createElement(
                    ...
                    { key: t },
                    s[t]
                      ? n.createElement('span', { className: r(a.highlighted, c) }, e)
