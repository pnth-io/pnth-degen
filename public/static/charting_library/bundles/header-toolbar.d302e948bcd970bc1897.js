  ...
  [3005],
  {
    ...
    49775: (e, t, a) => {
      ...
      const r = s.forwardRef((e, t) => {
        const { icon: a = '', ...r } = e;
        return s.createElement('span', { ...r, ref: t, dangerouslySetInnerHTML: { __html: a } });
      });
    },
    24084: (e, t, a) => {
      'use strict';
    ...
    48186: (e, t, a) => {
      ...
      function g(e) {
        ...
        return s.createElement(
          ...
          y.hasNewHeaderToolbarStyles &&
            !d &&
            s.createElement('div', { className: S.separatorWrap }, s.createElement('div', { className: S.separator })),
          s.createElement(
            'div',
            {
      ...
      class A extends s.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleMouseOver = (e) => {
              (0, T.hoverMouseEventFilter)(e) && this.setState({ isHovered: !0 });
            }),
            (this._handleMouseOut = (e) => {
              (0, T.hoverMouseEventFilter)(e) && this.setState({ isHovered: !1 });
            }),
              ...
              return e.map((e) =>
                s.createElement(
                  ...
                  'Button' === e.type
                    ...
                    : s.createElement(r.Dropdown, { displayMode: a, params: e.params }),
                ),
              );
            }),
        ...
        render() {
          ...
          return s.createElement(
                    ...
                    s.createElement(
                      ...
                      !o &&
                        s.Children.toArray([
                          ...
                          e.DateRange && s.createElement(g, { key: 'range' }, s.createElement(e.DateRange, null)),
                          e.Intervals &&
                            s.createElement(
                              g,
                              { key: 'intervals' },
                          ...
                          !y.hasNewHeaderToolbarStyles &&
                            ...
                            s.createElement(
                              g,
                              { key: 'undo-redo' },
                              s.createElement(e.UndoRedo, { id: u ? void 0 : k.UndoRedo }),
                            ),
                          e.ScalePercentage &&
                            s.createElement(g, { key: 'percentage' }, s.createElement(e.ScalePercentage, null)),
                          e.ScaleLogarithm &&
                            s.createElement(g, { key: 'logarithm' }, s.createElement(e.ScaleLogarithm, null)),
                          ...E,
                        ]),
                      (function (e) {
                        const t = e.findIndex(
                        ...
                        s.Children.toArray([
                          o &&
                            s.createElement(
                              g,
                              { key: 'view-only-badge', removeSeparator: y.hasNewHeaderToolbarStyles },
                          ...
                          (!o || y.hasNewHeaderToolbarStyles) &&
                            ...
                            s.createElement(
                              g,
                              { key: 'layout', removeSeparator: y.hasNewHeaderToolbarStyles && o },
                              !o && s.createElement(e.Layout, { id: u ? void 0 : k.Layouts }),
                              y.hasNewHeaderToolbarStyles &&
                                e.SaveLoad &&
                          ...
                          t.showLaunchInPopupButton &&
                            e.OpenPopup &&
                            s.createElement(g, { key: 'popup' }, s.createElement(e.OpenPopup, null)),
                          (!o || y.hasNewHeaderToolbarStyles) &&
                            e.Properties &&
                            s.createElement(
                              g,
                              { key: 'properties', removeSeparator: y.hasNewHeaderToolbarStyles && o },
                              !o &&
                          ...
                          !y.hasNewHeaderToolbarStyles &&
                            ...
                            s.createElement(
                              g,
                              { key: 'screenshot' },
                              s.createElement(e.Screenshot, { id: u ? void 0 : k.Screenshot, className: W.iconButton }),
                            ),
                          !o &&
                            e.Publish &&
                            s.createElement(
                              ...
                              s.createElement(e.Publish, { id: u ? void 0 : k.PublishMobile }),
                            ),
                          ..._,
                        ]),
                      ),
            ...
            e.Publish && !o && !u && s.createElement(e.Publish, { id: k.PublishDesktop, className: W.desktopPublish }),
          );
        }
        _onLoginStateChange() {
          0;
      ...
      class Z {
        constructor(e) {
          (this._customIntervalsService = J),
            ...
            z.linking.supportedResolutions.subscribe(this._fireSupportedIntervalsMayChange),
        ...
        destroy() {
          z.linking.supportedResolutions.unsubscribe(this._fireSupportedIntervalsMayChange),
            z.linking.range.unsubscribe(this._fireSupportedIntervalsMayChange),
            z.linking.seconds.unsubscribe(this._fireSupportedIntervalsMayChange),
            z.linking.ticks.unsubscribe(this._fireSupportedIntervalsMayChange),
            z.linking.intraday.unsubscribe(this._fireSupportedIntervalsMayChange);
        }
        getDefaultIntervals() {
        ...
        add(e, t, a) {
          ...
          return this._isIntervalDefault(s) || r.includes(s)
            ? null
            : (this._customIntervalsService.set((0, P.sortResolutions)([...r, s])), s);
        }
        remove(e) {
      ...
      class ae {
        ...
        favId(e) {
          return (0, Y.isPineIdString)(e) ? e : (0, Y.extractPineId)(e) || (0, Q.extractStudyId)(e);
        }
        favorites() {
      ...
      function ue(e = []) {
        return (0, P.mergeResolutions)(e, c.enabled('star_some_intervals_by_default') ? ce : []);
      }
      ...
      class Se extends s.PureComponent {
        constructor(e) {
          ...
          (this._showScrollbarWhen = (0, n.ensureDefined)(e.allowedModes).slice(-1)),
          ...
          (this._favoriteIntervalsService = h || new O(q.TVXWindowEvents, K, _)),
            (this._intervalsMenuViewStateService = new oe(q.TVXWindowEvents, K)),
        ...
        componentDidUpdate(e, t) {
          ...
          a !== t.isVisible && (h.emit('toggle_header', a), this._negotiateResizer()), s || this._setDisplayMode();
        }
        render() {
          const { resizerBridge: e, allowedModes: t, ...a } = this.props,
            { displayMode: r, isVisible: o, leftCustomElements: l, rightCustomElements: d } = this.state,
            c = {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                'div',
                { className: i(pe.toolbar, { [pe.isHidden]: !o }), onClick: this.props.onClick },
                s.createElement(
                  'div',
        ...
        addButton(e, t = 'left') {
          const a = new (D())(0),
            s = (0, ve.parseHtmlElement)(`<div class="apply-common-tooltip ${pe.customButton}">`),
            r = { type: 'Button', params: { key: Number(new Date()), element: s, width: a }, id: e },
      ...
      class ge {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            r.render(s.createElement(Se, { ...t, ref: this._handleRef }), this._container);
        }
        destroy() {
    ...
    53178: (e, t, a) => {
      'use strict';
      a.d(t, { validateRegistry: () => o, RegistryProvider: () => l, registryContextType: () => d });
      var s = a(67294),
        r = a(45697),
        n = a.n(r);
    ...
    11086: (e, t, a) => {
      'use strict';
      a.d(t, { hoverMouseEventFilter: () => n, useAccurateHover: () => i, useHover: () => r });
      var s = a(67294);
      function r() {
