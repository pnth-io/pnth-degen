  ...
  [8537],
  {
    34954: (e, t, i) => {
      ...
      function h(e, t) {
        return {
          ...
          info: { typeX: 0, minX: new (s())(-5e4), maxX: new (s())(15e3), stepX: new (s())(1) },
        };
      }
      function g(e, t, i, r, o, l) {
        ...
        return (0, n.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, a.removeSpaces)(`${l}Coordinates${o}`), title: o, ...s.info, ...c.info },
        );
      }
    },
    78672: (e, t, i) => {
      i.d(t, { floor: () => o, convertToInt: () => n, limitedPrecision: () => l });
      var r = i(43434);
      function o(e) {
        return Math.floor(e);
      }
    ...
    88101: (e, t, i) => {
      ...
      const a = new o.TranslatedString(
        ...
        c = new o.TranslatedString('change {title} extension', (0, r.t)('change {title} extension')),
    ...
    46566: (e, t, i) => {
      ...
      const d = new o.TranslatedString(
        ...
        v = new o.TranslatedString('change {title} angle visibility', (0, r.t)('change {title} angle visibility')),
        b = new o.TranslatedString('change {title} always show stats', (0, r.t)('change {title} always show stats')),
        _ = new o.TranslatedString('change {title} stats position', (0, r.t)('change {title} stats position')),
        D = [
      ...
      function M(e, t, i, r) {
        ...
        const B = (0, l.createCheckablePropertyDefinition)(
          ...
          { id: o + 'ShowPriceLabels', title: (r && r.showPriceLabelsTitle) || w },
        );
        s.push(B);
        const N = [],
        ...
        if ((N.push(z), 'showDateTimeRange' in t)) {
          const n = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showDateTimeRange, u.format({ title: i })) },
        ...
        if ('showDistance' in t) {
          const n = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showDistance, f.format({ title: i })) },
        ...
        const E = (0, l.createOptionsPropertyDefinition)(
          ...
          { id: o + 'StatsPosition', title: (r && r.statsPosition) || P, options: new (a())(D) },
        );
        return N.push(E), s.push((0, l.createPropertyDefinitionsGeneralGroup)(N, o + 'StatsGroup', A)), s;
      }
    },
    62684: (e, t, i) => {
      ...
      const s = new o.TranslatedString(
        ...
        a = new o.TranslatedString('change {toolName} line width', (0, r.t)('change {toolName} line width')),
        c = new o.TranslatedString('change {toolName} line style', (0, r.t)('change {toolName} line style')),
        p = new o.TranslatedString('change {toolName} line color', (0, r.t)('change {toolName} line color')),
        d = new o.TranslatedString(
          'change {toolName} line extending left',
          (0, r.t)('change {toolName} line extending left'),
        ),
        h = new o.TranslatedString('change {toolName} line left end', (0, r.t)('change {toolName} line left end')),
        g = new o.TranslatedString(
          'change {toolName} line extending right',
          (0, r.t)('change {toolName} line extending right'),
        ),
        y = new o.TranslatedString('change {toolName} line right end', (0, r.t)('change {toolName} line right end')),
        u = (0, r.t)('Line'),
        f = (0, r.t)('Extend left line'),
        v = (0, r.t)('Extend right line');
      function b(e, t, i, r, o) {
        const b = {},
          _ = { id: `${(0, l.removeSpaces)(i.originalText())}${r}`, title: (o && o.line) || u };
        return (
          void 0 !== t.showLine &&
            (b.checked = (0, n.convertToDefinitionProperty)(e, t.showLine, s.format({ toolName: i }))),
          void 0 !== t.lineWidth &&
            (b.width = (0, n.convertToDefinitionProperty)(e, t.lineWidth, a.format({ toolName: i }))),
          void 0 !== t.lineStyle &&
            (b.style = (0, n.convertToDefinitionProperty)(e, t.lineStyle, c.format({ toolName: i }))),
          void 0 !== t.lineColor &&
            (b.color = (0, n.getColorDefinitionProperty)(e, t.lineColor, null, p.format({ toolName: i }))),
          void 0 !== t.extendLeft &&
            ((b.extendLeft = (0, n.convertToDefinitionProperty)(e, t.extendLeft, d.format({ toolName: i }))),
            (_.extendLeftTitle = (o && o.extendLeftTitle) || f)),
          void 0 !== t.leftEnd &&
            (b.leftEnd = (0, n.convertToDefinitionProperty)(e, t.leftEnd, h.format({ toolName: i }))),
          void 0 !== t.extendRight &&
            ((b.extendRight = (0, n.convertToDefinitionProperty)(e, t.extendRight, g.format({ toolName: i }))),
            (_.extendRightTitle = (o && o.extendRightTitle) || v)),
          void 0 !== t.rightEnd &&
            (b.rightEnd = (0, n.convertToDefinitionProperty)(e, t.rightEnd, y.format({ toolName: i }))),
    ...
    92785: (e, t, i) => {
      ...
      const s = new o.TranslatedString(
        ...
        a = new o.TranslatedString('change {toolName} text color', (0, r.t)('change {toolName} text color')),
        c = new o.TranslatedString('change {toolName} text font size', (0, r.t)('change {toolName} text font size')),
        p = new o.TranslatedString('change {toolName} text font bold', (0, r.t)('change {toolName} text font bold')),
        d = new o.TranslatedString(
          'change {toolName} text font italic',
          (0, r.t)('change {toolName} text font italic'),
        ),
        h = new o.TranslatedString('change {toolName} text', (0, r.t)('change {toolName} text')),
        g = new o.TranslatedString(
        ...
        T = new o.TranslatedString('change {toolName} text wrap', (0, r.t)('change {toolName} text wrap')),
        w = (0, r.t)('Background'),
        P = (0, r.t)('Border'),
        S = (0, r.t)('Text wrap');
      function m(e, t, i, r) {
        ...
        if (
          (void 0 !== t.showText &&
            (o.checked = (0, n.convertToDefinitionProperty)(e, t.showText, s.format({ toolName: i }))),
          void 0 !== t.textColor &&
          ...
          void 0 !== t.fontSize &&
            (o.size = (0, n.convertToDefinitionProperty)(e, t.fontSize, c.format({ toolName: i }))),
          void 0 !== t.bold && (o.bold = (0, n.convertToDefinitionProperty)(e, t.bold, p.format({ toolName: i }))),
          void 0 !== t.italic &&
            (o.italic = (0, n.convertToDefinitionProperty)(e, t.italic, d.format({ toolName: i }))),
          void 0 !== t.text &&
            ((o.text = (0, n.convertToDefinitionProperty)(e, t.text, h.format({ toolName: i }))),
          ...
          void 0 !== t.textOrientation &&
            (o.orientation = (0, n.convertToDefinitionProperty)(e, t.textOrientation, u.format({ toolName: i }))),
          ...
          void 0 !== t.backgroundTransparency && (r = t.backgroundTransparency),
            (o.backgroundColor = (0, n.getColorDefinitionProperty)(e, t.backgroundColor, r, v.format({ toolName: i })));
        }
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (m.backgroundTitle = (r.customTitles && r.customTitles.backgroundTitle) || w),
          void 0 !== t.borderVisible &&
            (o.borderVisible = (0, n.convertToDefinitionProperty)(e, t.borderVisible, b.format({ toolName: i }))),
          void 0 !== t.borderWidth &&
            (o.borderWidth = (0, n.convertToDefinitionProperty)(e, t.borderWidth, _.format({ toolName: i }))),
          void 0 !== t.borderColor &&
            (o.borderColor = (0, n.getColorDefinitionProperty)(e, t.borderColor, null, D.format({ toolName: i }))),
          (void 0 === t.borderVisible && void 0 === t.borderColor && void 0 === t.borderWidth) ||
            (m.borderTitle = (r.customTitles && r.customTitles.borderTitle) || P),
          void 0 !== t.wrap &&
            ((o.wrap = (0, n.convertToDefinitionProperty)(e, t.wrap, T.format({ toolName: i }))),
    ...
    68854: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        l = i(3619),
        s = i(68680);
      const a = new o.TranslatedString('change arrow color', (0, r.t)('change arrow color')),
        c = (0, r.t)('Text'),
        p = (0, r.t)('Arrow');
    ...
    60810: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        s = i(5225),
        a = i(92785);
      const c = new o.TranslatedString('change {title} color', (0, r.t)('change {title} color')),
        p = (0, r.t)('Color'),
        d = (0, r.t)('Text');
    ...
    23478: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        p = i(78672),
        d = i(5225);
      const h = new o.TranslatedString('change {title} color', (0, r.t)('change {title} color')),
        g = new o.TranslatedString('change {title} mode', (0, r.t)('change {title} mode')),
        y = new o.TranslatedString('change {title} mirrored', (0, r.t)('change {title} mirrored')),
        u = new o.TranslatedString('change {title} flipped', (0, r.t)('change {title} flipped')),
        f = (0, r.t)('Color'),
        v = (0, r.t)('Mode'),
        b = (0, r.t)('Mirrored'),
        _ = (0, r.t)('Flipped'),
        ...
        _stylePropertyDefinitions() {
          ...
          return [
            (0, l.createColorPropertyDefinition)(
              {
                color: (0, l.getColorDefinitionProperty)(this._propertyApplier, e.color, null, h.format({ title: i })),
              },
              { id: r + 'Color', title: f },
            ),
            ...
            (0, l.createCheckablePropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.mirrored, y.format({ title: i })),
              },
              { id: r + 'Mirrored', title: b },
            ),
            (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.flipped, u.format({ title: i })) },
    ...
    72862: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        p = new o.TranslatedString('change {title} background color', (0, r.t)('change {title} background color')),
        d = (0, r.t)('Background');
      class h extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
    ...
    60312: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        c = i.n(a),
        p = i(5225);
      const d = new o.TranslatedString('change {title} color', (0, r.t)('change {title} color')),
        h = new o.TranslatedString('change {title} degree', (0, r.t)('change {title} degree')),
        g = (0, r.t)('Color'),
        y = (0, r.t)('Wave'),
        u = (0, r.t)('Degree');
        ...
        _stylePropertyDefinitions() {
          ...
          return [
            ...
            (0, s.createOptionsPropertyDefinition)(
              ...
              { id: t + 'Degree', title: u, options: new (c())(this._source.availableDegreesValues()) },
            ),
          ];
        }
      }
    ...
    40804: (e, t, i) => {
      ...
      const d = new n.TranslatedString(
        ...
        h = new n.TranslatedString('change {title} levels visibility', (0, o.t)('change {title} levels visibility')),
        ...
        f = new n.TranslatedString('change {title} all lines color', (0, o.t)('change {title} all lines color')),
    ...
    58481: (e, t, i) => {
      ...
      const y = new n.TranslatedString(
        ...
        v = new n.TranslatedString('change {title} all lines color', (0, o.t)('change {title} all lines color')),
        b = new n.TranslatedString(
          'change {title} background visibility',
          (0, o.t)('change {title} background visibility'),
        ),
        ...
        D = new n.TranslatedString('change {title} reverse', (0, o.t)('change {title} reverse')),
        T = new n.TranslatedString('change {title} prices visibility', (0, o.t)('change {title} prices visibility')),
        w = new n.TranslatedString('change {title} labels alignment', (0, o.t)('change {title} labels alignment')),
        P = new n.TranslatedString('change {title} style', (0, o.t)('change {title} style')),
      ...
      class $ extends a.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          const p = t.levelsStyle.childs(),
            ...
            O = { line: x };
          'extendLines' in t && (($.extendRight = t.extendLines), (O.extendRightTitle = L)),
            'extendLinesLeft' in t && (($.extendLeft = t.extendLinesLeft), (O.extendLeftTitle = A)),
            'extendRight' in t && (($.extendRight = t.extendRight), (O.extendRightTitle = C)),
            'extendLeft' in t && (($.extendLeft = t.extendLeft), (O.extendLeftTitle = k));
          const F = (0, l.createLineStyleDefinition)(this._propertyApplier, $, a, 'LevelsStyleLine', O);
          e.push(F);
          const I = [],
          ...
          const H = (0, s.createPropertyDefinitionsLeveledLinesGroup)(I, o + 'LeveledLinesGroup');
          e.push((0, s.createPropertyDefinitionsGeneralGroup)([H], o + 'Group'));
          ...
          if ('reverse' in X) {
            const t = (0, s.createCheckablePropertyDefinition)(
              { checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, X.reverse, D.format({ title: a })) },
          ...
          const K = (0, s.createCheckablePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.showPrices, T.format({ title: a })),
            },
            { id: o + 'Prices', title: V },
          );
          e.push(K);
          const q = (0, s.createOptionsPropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.showCoeffs, P.format({ title: a })),
          ...
          if ((e.push(J), 'fibLevelsBasedOnLogScale' in t && null !== this._disabledBasedOnLog)) {
    ...
    8545: (e, t, i) => {
      ...
      class m extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const M = (0, s.createCheckablePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.fullCircles, _.format({ title: a })),
            },
    ...
    84061: (e, t, i) => {
      ...
      const p = new n.TranslatedString(
        ...
        g = new n.TranslatedString('change {title} all lines color', (0, o.t)('change {title} all lines color')),
        y = new n.TranslatedString(
          'change {title} background visibility',
          (0, o.t)('change {title} background visibility'),
        ),
        ...
        D = new n.TranslatedString('change {title} reverse', (0, o.t)('change {title} reverse')),
        T = new n.TranslatedString('change {title} grid visibility', (0, o.t)('change {title} grid visibility')),
        w = new n.TranslatedString('change {title} grid line color', (0, o.t)('change {title} grid line color')),
        P = new n.TranslatedString('change {title} grid line width', (0, o.t)('change {title} grid line width')),
        S = new n.TranslatedString('change {title} grid line style', (0, o.t)('change {title} grid line style')),
      ...
      class W extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const R = (0, l.createPropertyDefinitionsLeveledLinesGroup)(W, o + 'HLeveledLinesGroup'),
            ...
            $ = (0, l.createPropertyDefinitionsGeneralGroup)([R, E, G], o + 'HLevelGroup', C);
          e.push($);
          const O = [],
          ...
          const I = (0, l.createPropertyDefinitionsLeveledLinesGroup)(O, o + 'VLeveledLinesGroup'),
            ...
            Y = (0, l.createPropertyDefinitionsGeneralGroup)([I, U, H], o + 'VLevelGroup', k);
          e.push(Y);
          ...
          const K = t.grid.childs(),
            q = (0, l.createLinePropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, K.visible, T.format({ title: s })),
                color: (0, l.getColorDefinitionProperty)(this._propertyApplier, K.color, null, w.format({ title: s })),
                width: (0, l.convertToDefinitionProperty)(this._propertyApplier, K.linewidth, P.format({ title: s })),
                style: (0, l.convertToDefinitionProperty)(this._propertyApplier, K.linestyle, S.format({ title: s })),
              },
              { id: o + 'GridLine', title: B },
            );
          e.push(q);
          const J = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.reverse, D.format({ title: s })) },
    ...
    73546: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        l = i(3619),
        s = i(5225);
      const a = new o.TranslatedString('change {title} line color', (0, r.t)('change {title} line color')),
        c = new o.TranslatedString('change {title} line width', (0, r.t)('change {title} line width')),
        p = new o.TranslatedString('change {title} line style', (0, r.t)('change {title} line style')),
        d = new o.TranslatedString('change {title} counterclockwise', (0, r.t)('change {title} counterclockwise')),
        h = (0, r.t)('Line'),
            ...
            (0, n.createLinePropertyDefinition)(
              {
                ...
                width: (0, n.convertToDefinitionProperty)(this._propertyApplier, e.linewidth, c.format({ title: r })),
                style: (0, n.convertToDefinitionProperty)(this._propertyApplier, e.linestyle, p.format({ title: r })),
              },
              { id: i + 'Line', title: h },
            ),
    ...
    46446: (e, t, i) => {
      ...
      const h = new n.TranslatedString(
        ...
        D = new n.TranslatedString('change {title} labels visibility', (0, o.t)('change {title} labels visibility')),
        T = new n.TranslatedString('change {title} labels alignment', (0, o.t)('change {title} labels alignment')),
        w = (0, o.t)('Use one color'),
        P = (0, o.t)('Background'),
        S = (0, o.t)('Labels'),
        m = [
      ...
      class C extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const L = (0, l.createTwoOptionsPropertyDefinition)(
            ...
            { id: o + 'Labels', title: S, optionsItems1: new (c())(x), optionsItems2: new (c())(m) },
          );
          return e.push(L), e;
        }
      }
    ...
    84017: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        n = i(3619),
        l = i(68680);
      const s = new o.TranslatedString('change flag color', (0, r.t)('change flag color')),
        a = (0, r.t)('Flag');
      class c extends n.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs();
    ...
    96832: (e, t, i) => {
      ...
      const u = new n.TranslatedString(
        ...
        b = new n.TranslatedString('change {title} all lines color', (0, o.t)('change {title} all lines color')),
        _ = new n.TranslatedString(
          'change {title} background visibility',
          (0, o.t)('change {title} background visibility'),
        ),
        ...
        T = new n.TranslatedString('change {title} reverse', (0, o.t)('change {title} reverse')),
        ...
        k = new n.TranslatedString('change top margin', (0, o.t)('change top margin')),
        L = (0, o.t)('Reverse'),
      ...
      class E extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const E = (0, s.createPropertyDefinitionsLeveledLinesGroup)(c, o + 'LeveledLinesGroup');
          e.push((0, s.createPropertyDefinitionsGeneralGroup)([E], o + 'LevelGroup', N));
          const G = [],
          ...
          const U = (0, s.createPropertyDefinitionsLeveledLinesGroup)(F, o + 'ArcsLeveledLinesGroup');
          e.push((0, s.createPropertyDefinitionsGeneralGroup)([U], o + 'ArcsLinesGroup', z));
          ...
          const X = (0, s.createCheckablePropertyDefinition)(
            { checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.reverse, T.format({ title: a })) },
          ...
          if ((e.push(X), R(this._source))) {
            const t = this._source,
              ...
              r = (0, s.createNumberPropertyDefinition)(
                {
                  value: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.scaleRatio, k, [
    ...
    96634: (e, t, i) => {
      ...
      const p = new n.TranslatedString(
        ...
        y = new n.TranslatedString('change {title} all lines color', (0, o.t)('change {title} all lines color')),
        u = new n.TranslatedString(
          'change {title} background visibility',
          (0, o.t)('change {title} background visibility'),
        ),
        ...
        v = new n.TranslatedString('change {title} labels visibility', (0, o.t)('change {title} labels visibility')),
          ...
          for (let i = 1; i <= T; i++) {
            const r = t['level' + i].childs(),
              n = (0, l.createLeveledLinePropertyDefinition)(
                ...
                { id: `${o}LineLevel${i}`, title: `${r.coeff1.value()}/${r.coeff2.value()}` },
              );
            e.push(n);
          }
    ...
    12101: (e, t, i) => {
      ...
      const p = new n.TranslatedString(
        ...
        f = new n.TranslatedString('change {title} reverse', (0, o.t)('change {title} reverse')),
        v = new n.TranslatedString(
          'change {title} left labels visibility',
          (0, o.t)('change {title} left labels visibility'),
        ),
        ...
        T = new n.TranslatedString('change {title} fans visibility', (0, o.t)('change {title} fans visibility')),
        w = new n.TranslatedString('change {title} fans line color', (0, o.t)('change {title} fans line color')),
      ...
      class B extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const W = (0, l.createPropertyDefinitionsLeveledLinesGroup)(B, o + 'HLeveledLinesGroup'),
            ...
            G = (0, l.createPropertyDefinitionsGeneralGroup)([W, z, R, E], o + 'HLevelGroup', m);
          e.push(G);
          const $ = [],
          ...
          const F = (0, l.createPropertyDefinitionsLeveledLinesGroup)($, o + 'VLeveledLinesGroup'),
            ...
            Y = (0, l.createPropertyDefinitionsGeneralGroup)([F, I, U, H], o + 'VLevelGroup', x);
          e.push(Y);
          const j = (0, l.createColorPropertyDefinition)(
            {
              color: (0, l.getColorDefinitionProperty)(
          ...
          const X = t.fans.childs(),
            K = (0, l.createColorPropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, X.visible, T.format({ title: s })),
                color: (0, l.getColorDefinitionProperty)(this._propertyApplier, X.color, null, w.format({ title: s })),
              },
              { id: o + 'FansLines', title: M },
            );
          e.push(K);
          const q = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.reverse, f.format({ title: s })) },
    ...
    44558: (e, t, i) => {
      ...
      const p = new o.TranslatedString(
        ...
        d = new o.TranslatedString('change {title} background color', (0, r.t)('change {title} background color')),
        h = new o.TranslatedString('change {title} extend top', (0, r.t)('change {title} extend top')),
        g = new o.TranslatedString('change {title} extend bottom', (0, r.t)('change {title} extend bottom')),
        y = new o.TranslatedString('change {title} extend left', (0, r.t)('change {title} extend left')),
        u =
          (new o.TranslatedString('change {title} stats visibility', (0, r.t)('change {title} stats visibility')),
          (0, r.t)('Line')),
        f = (0, r.t)('Border'),
        v = (0, r.t)('Background'),
        b = (0, r.t)('Extend top'),
        ...
        _stylePropertyDefinitions() {
          ...
          }
          {
            const i = (0, l.createTextStyleDefinition)(
              ...
              s,
              { isEditable: !0, isMultiLine: !0, customTitles: { text: w, backgroundTitle: P } },
            );
            e.push(i);
          }
          return e;
    ...
    24708: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        a = i.n(s),
        c = i(5225);
      const p = new o.TranslatedString('change {title} candle up color', (0, r.t)('change {title} candle up color')),
        d = new o.TranslatedString('change {title} candle down color', (0, r.t)('change {title} candle down color')),
        h = new o.TranslatedString(
        ...
        f = new o.TranslatedString('change {title} candle wick color', (0, r.t)('change {title} candle wick color')),
        v = new o.TranslatedString('change {title} transparency', (0, r.t)('change {title} transparency')),
        b = new o.TranslatedString('change {title} average HL value', (0, r.t)('change {title} average HL value')),
        _ = new o.TranslatedString('change {title} variance value', (0, r.t)('change {title} variance value')),
        D = (0, r.t)('Candles'),
        T = (0, r.t)('Borders'),
        w = (0, r.t)('Wick'),
      ...
      class x extends n.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return [
            ...
            (0, l.createColorPropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, n.drawWick, u.format({ title: r })),
                color: (0, l.getColorDefinitionProperty)(
                  this._propertyApplier,
                  n.wickColor,
                  null,
        ...
        _inputsPropertyDefinitions() {
          ...
          return [
            (0, l.createNumberPropertyDefinition)(
              ...
              { id: i + 'AvgHL', title: S, type: 0, min: new (a())(1), max: new (a())(5e4), step: new (a())(1) },
            ),
            (0, l.createNumberPropertyDefinition)(
              { value: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.variance, _.format({ title: r })) },
              { id: i + 'Variance', title: m, type: 0, min: new (a())(1), max: new (a())(100), step: new (a())(1) },
            ),
          ];
        }
      }
    ...
    93619: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        l = i(68680),
        s = i(5225);
      const a = new o.TranslatedString('change {title} color', (0, r.t)('change {title} color')),
        c = (0, r.t)('Color');
    ...
    3619: (e, t, i) => {
      ...
      class D {
        ...
        _createCoordinatesPropertyPage() {
          ...
          return null !== e ? (0, s.createPropertyPage)(e, 'coordinates', u) : null;
        }
    ...
    94222: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        s = i(68680),
        a = i(5225);
      const c = new o.TranslatedString('change {title} background color', (0, r.t)('change {title} background color')),
        p = (0, r.t)('Label');
      class d extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
    ...
    79641: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        s = i(62684),
        a = i(5225);
      const c = new o.TranslatedString('change {title} extending left', (0, r.t)('change {title} extending left')),
        p = new o.TranslatedString('change {title} extending right', (0, r.t)('change {title} extending right')),
        d = new o.TranslatedString(
          'change {title} background visibility',
          (0, r.t)('change {title} background visibility'),
        ),
        h = new o.TranslatedString('change {title} background color', (0, r.t)('change {title} background color')),
        g = (0, r.t)('Background'),
    ...
    39942: (e, t, i) => {
      ...
      class p extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = new o.TranslatedString(this._source.name(), this._source.title());
          return [
            (0, l.createTextStyleDefinition)(
              this._propertyApplier,
              { textColor: e.textcolor, fontSize: e.fontsize, bold: e.bold, italic: e.italic },
    ...
    19530: (e, t, i) => {
      ...
      var r = i(16282),
        ...
        c = i(5225),
        p = i(3925);
      const d = new n.TranslatedString('change {title} extend lines', (0, o.t)('change {title} extend lines')),
        h = new n.TranslatedString(
          'change {title} level {index} line visibility',
          (0, o.t)('change {title} level {index} line visibility'),
        ),
    ...
    18775: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        a = i(32856),
        c = i.n(a);
      const p = new o.TranslatedString('change {title} style', (0, r.t)('change {title} style')),
        d = (0, r.t)('Style'),
        h = [
        ...
        _stylePropertyDefinitions() {
          const e = super._stylePropertyDefinitions(),
            ...
            l = (0, n.createOptionsPropertyDefinition)(
              { option: (0, n.convertToDefinitionProperty)(this._propertyApplier, t.style, p.format({ title: r })) },
    ...
    93786: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        h = new o.TranslatedString('change {title} target text color', (0, r.t)('change {title} target text color')),
        g = new o.TranslatedString(
        ...
        u = new o.TranslatedString('change {title} success text color', (0, r.t)('change {title} success text color')),
        f = new o.TranslatedString(
          'change {title} success background color',
          (0, r.t)('change {title} success background color'),
        ),
        v = new o.TranslatedString('change {title} failure text color', (0, r.t)('change {title} failure text color')),
        b = new o.TranslatedString(
    ...
    75256: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        s = i(68680),
        a = i(5225);
      const c = new o.TranslatedString('change {title} line color', (0, r.t)('change {title} line color')),
        p = (0, r.t)('Label text'),
        d = (0, r.t)('Text'),
        h = (0, r.t)('Line color'),
    ...
    92557: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        p = new o.TranslatedString('change {title} background color 2', (0, r.t)('change {title} background color 2')),
        d = (0, r.t)('Border'),
        h = (0, r.t)('Background');
      class g extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
    ...
    29286: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        l = i(32454),
        s = i(92785);
      const a = new o.TranslatedString('change {title} extending left', (0, r.t)('change {title} extending left')),
        c = new o.TranslatedString('change {title} extending right', (0, r.t)('change {title} extending right')),
        p = (0, r.t)('Text'),
        d = (0, r.t)('Extend left'),
      ...
      class y extends l.GeneralFiguresDefinitionsViewModelBase {
        _stylePropertyDefinitions() {
          ...
          const s = (0, n.createCheckablePropertyDefinition)(
            {
              checked: (0, n.convertToDefinitionProperty)(this._propertyApplier, e.extendLeft, a.format({ title: i })),
            },
    ...
    57591: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        d = i.n(p),
        h = i(5225);
      const g = new o.TranslatedString('change {title} stop color', (0, r.t)('change {title} stop color')),
        y = new o.TranslatedString('change {title} target color', (0, r.t)('change {title} target color')),
        u = new o.TranslatedString(
          'change {title} price labels visibility',
          (0, r.t)('change {title} price labels visibility'),
        ),
        f = new o.TranslatedString('change {title} compact stats mode', (0, r.t)('change {title} compact stats mode')),
        v = new o.TranslatedString('change {title} always show stats', (0, r.t)('change {title} always show stats')),
        b = new o.TranslatedString('change {title} account size', (0, r.t)('change {title} account size')),
        _ = new o.TranslatedString('change {title} lot size', (0, r.t)('change {title} lot size')),
        D = new o.TranslatedString('change {title} risk', (0, r.t)('change {title} risk')),
        T = new o.TranslatedString('change {title} risk display mode', (0, r.t)('change {title} risk display mode')),
        w = new o.TranslatedString('change {title} entry price', (0, r.t)('change {title} entry price')),
        P = new o.TranslatedString('change {title} profit level', (0, r.t)('change {title} profit level')),
        S = new o.TranslatedString('change {title} profit price', (0, r.t)('change {title} profit price')),
        m = new o.TranslatedString('change {title} stop level', (0, r.t)('change {title} stop level')),
        x = new o.TranslatedString('change {title} stop price', (0, r.t)('change {title} stop price')),
        C = (0, r.t)('Lines'),
        k = (0, r.t)('Stop color'),
      ...
      class H extends s.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          return [
            ...
            (0, a.createCheckablePropertyDefinition)(
              { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.compact, f.format({ title: r })) },
        ...
        _inputsPropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            s = (0, a.createNumberPropertyDefinition)(
              { value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.lotSize, _.format({ title: r })) },
              {
                id: i + 'LotSize',
                title: E,
                type: 1,
            ...
            c = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.risk, D.format({ title: r }), [
                  (e) => parseFloat(e),
                ]),
            ...
            p = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.entryPrice, w.format({ title: r })),
              },
            ...
            f = (0, a.createPropertyDefinitionsGeneralGroup)([y, u], i + 'ProfitLevel', W),
            v = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.stopLevel, m.format({ title: r })),
              },
              {
                id: i + 'StopLevelTicks',
                title: V,
          ...
          return [g, f, (0, a.createPropertyDefinitionsGeneralGroup)([v, C], i + 'StopLevel', z)];
        }
    ...
    69172: (e, t, i) => {
      ...
      const h = new o.TranslatedString(
        ...
        g = new o.TranslatedString('change {title} emoji visibility', (0, r.t)('change {title} emoji visibility')),
        y = new o.TranslatedString(
          'change {title} image background color',
          (0, r.t)('change {title} image background color'),
        ),
        u = new o.TranslatedString('change {title} emoji', (0, r.t)('change {title} emoji')),
        f = (0, r.t)('#1 (vertical position %, bar)', { context: 'linetool point' }),
        v = (0, r.t)('Emoji pin');
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return [
            (0, a.createCoordinatesPropertyDefinition)(
              ...
              { id: (0, n.removeSpaces)(`${t}Coordinates${f}`), title: f, ...i.info, ...r.info },
            ),
          ];
        }
        _stylePropertyDefinitions() {
          ...
          return [
            (0, a.createEmojiPropertyDefinition)(
              {
                checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.showImage, g.format({ title: i })),
                ...
                emoji: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.emoji, u.format({ title: i })),
              },
    ...
    27138: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        c = i(34954),
        p = i(46566);
      const d = new o.TranslatedString('change angle', (0, r.t)('change angle')),
        h = (0, r.t)('Angle'),
        g = (0, r.t)('Text'),
    ...
    72487: (e, t, i) => {
      ...
      const y = new n.TranslatedString(
        ...
        _ = new n.TranslatedString('change {title} all lines color', (0, o.t)('change {title} all lines color')),
        D = new n.TranslatedString(
          'change {title} background visibility',
          (0, o.t)('change {title} background visibility'),
        ),
        ...
        w = new n.TranslatedString('change {title} labels visibility', (0, o.t)('change {title} labels visibility')),
        P = new n.TranslatedString('change {title} labels alignment', (0, o.t)('change {title} labels alignment')),
        S = (0, o.t)('Trend line'),
        m = (0, o.t)('Use one color'),
        x = (0, o.t)('Background'),
        C = (0, o.t)('Labels');
        ...
        _stylePropertyDefinitions() {
          const e = [],
            ...
            L = (0, l.createLineStyleDefinition)(
              this._propertyApplier,
              { showLine: k.visible, lineColor: k.color, lineStyle: k.linestyle, lineWidth: k.linewidth },
              p,
              'TrendLine',
              { line: S },
            );
          ...
          const B = (0, s.createTwoOptionsPropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.showCoeffs, w.format({ title: p })),
              option1: (0, s.convertToDefinitionProperty)(
                this._propertyApplier,
                i.horzLabelsAlign,
                P.format({ title: p }),
