  ...
  [2306],
  {
    19303: (t) => {
      ...
      t.exports = function (t, i) {
        ...
        for (var s = 0; s < r.length; s++) if (!e.call(i, r[s]) || !o(t[r[s]], i[r[s]])) return !1;
        return !0;
      };
    },
    54395: () => {},
    ...
    80511: (t, e, o) => {
      ...
      function c(t) {
        const { size: e, startIcon: o, icon: r, iconOnly: n, children: a, endIcon: d } = t,
          c = null != o ? o : r;
        return i.createElement(
          i.Fragment,
          null,
          c && 'xsmall' !== e && i.createElement(s.Icon, { icon: c, className: l()['start-icon-wrap'] }),
          a && i.createElement('span', { className: l().content }, a),
          d && !n && 'xsmall' !== e && i.createElement(s.Icon, { icon: d, className: l()['end-icon-wrap'] }),
        );
      }
      var h = o(94618),
        p = o(74818);
      ...
      function g(t) {
        const { reference: e, ...o } = t,
          { isGrouped: r, cellState: n, disablePositionAdjustment: s } = (0, i.useContext)(h.ControlGroupContext),
          a = d({ ...o, isGrouped: r, cellState: n, disablePositionAdjustment: s });
        return i.createElement('button', { ...u(o), className: a, ref: e }, i.createElement(c, { ...o }));
      }
      ...
      function b(t) {
        const { intent: e, size: o, appearance: i, useFullWidth: r, icon: n, ...s } = t;
        return { ...s, color: m(e), size: v(o), variant: _(i), stretch: r, startIcon: n };
      }
      function w(t) {
    ...
    45650: (t, e, o) => {
      ...
      const a = i.forwardRef((t, e) => {
        ...
        return i.createElement(n.ToolWidgetButton, { 'data-name': a, ...l, ref: e, className: r(o, s.button) });
      });
    },
    55753: (t, e, o) => {
      'use strict';
      ...
      class _ extends r.FloatingToolbar {
        ...
        _onFavoriteRemoved(t) {
          this.removeWidget(this._linetoolsWidgets[t]),
            ...
            0 === n.LinetoolsFavoritesStore.favoritesCount() && (this._canBeShownValue.setValue(!1), this.hide());
        }
        _onFavoriteMoved() {
        ...
        _attachHandlers() {
          n.LinetoolsFavoritesStore.favoriteAdded.subscribe(this, this._onFavoriteAdded),
            n.LinetoolsFavoritesStore.favoriteRemoved.subscribe(this, this._onFavoriteRemoved),
            n.LinetoolsFavoritesStore.favoriteMoved.subscribe(this, this._onFavoriteMoved),
            ...
            this.onWidgetsReordered().subscribe(this, (t, e) => {
              if (
                (n.LinetoolsFavoritesStore.favoriteMoved.unsubscribe(this, this._onFavoriteMoved),
                !n.LinetoolsFavoritesStore.moveFavorite(n.LinetoolsFavoritesStore.favorite(t), e))
              )
                throw new Error('Something went wrong');
              n.LinetoolsFavoritesStore.favoriteMoved.subscribe(this, this._onFavoriteMoved);
            }),
            this.onContextMenu((t) => {
              t.preventDefault(), d.ContextMenuManager.showMenu([this._hideAction], t);
            }),
    ...
    77625: (t, e, o) => {
                ...
                (this._helper.raf = requestAnimationFrame(() => {
                  null !== this._helper &&
                    (null !== this._helper.nextTop &&
                      ((r.style.top = this._helper.nextTop + 'px'), (this._helper.nextTop = null)),
                    null !== this._helper.nextLeft &&
                      ((r.style.left = this._helper.nextLeft + 'px'), (this._helper.nextLeft = null)),
      ...
      class w {
        ...
        _getEventTarget() {
          return v.CheckMobile.iOS() || ((0, v.isMac)() && r.touch) ? window.document.documentElement : this._handle;
        }
        _dispatchEvent(t) {
          switch (t.type) {
      ...
      class S {
        ...
        addWidget(t, e = {}) {
          ...
          const r = e.index === o ? null : this._content.childNodes.item(e.index);
        ...
        _loadPosition() {
          ...
          } else t = (0, s.getJSON)(this._options.positionSettingsKey, this._options.defaultPosition);
    ...
    34708: (t, e, o) => {
      ...
      function x(t) {
        ...
        return a && a.length
                        ...
                        r.map((o, r) => {
                          ...
                          return n
                            ? o.showForSmallScreen
                              ...
                              : null
                            : i.createElement(o.component, { ...o.props, key: `${o.props.title}_${r}`, className: C });
                        }),
                    ),
                ),
            )
          : l();
        function l() {
          return null === e ? null : i.createElement(e.component, { ...e.props, isDrawingFinished: n, className: C });
        }
      }
      var T = o(87438),
        S = o(45650),
      ...
      function I(t) {
        ...
        return i.createElement(B.ToolButton, { className: L(e, k.button), tooltipPosition: 'horizontal', ...o });
      }
      var F = o(96750),
        A = o(62618);
      function R(t) {
        const { activeChartWidget: e, className: o } = t,
          ...
          s = (0, E.useProperty)(r),
          a = s ? { title: (0, n.t)('Unlock'), icon: F } : { title: (0, n.t)('Lock'), icon: A };
      ...
      var N = o(49775),
        ...
        Q = o(62781);
      function Y(t) {
        const { title: e, activeChartWidget: r, isSmallScreen: s, className: a } = t,
          l = r.model(),
                      ...
                      e = (function () {
                            ...
                            new G.Action({
                              ...
                              onExecute: () => {
                                l.cloneLineTools(i, !1),
                                  (0, T.trackEvent)('GUI', 'Context action on drawings', 'Clone');
                              },
                            }),
                          );
                        ...
                        if (s.length > 0) {
                          const o = {
                            ...
                            onExecute: () => {
                              r.chartWidgetCollection().clipboard.uiRequestCopy(s);
                            },
                          };
                        ...
                        if (
                          !(function () {
                            if (!(null == r ? void 0 : r.isMultipleLayout())) return !1;
                            return d.some((t) => t.isSynchronizable());
                          })()
                        )
                          return t;
                        return t.push(...(0, q.createSyncDrawingActions)(r, d)), t;
                      })();
                ...
                ? function (t) {
                    u.contextMenuActionsForSources(d).then((e) => {
                      window.matchMedia(f.DialogBreakpoints.TabletSmall).matches
                        ? $.ContextMenuManager.showMenu(J(e), t, { mode: 'drawer', 'data-name': 'more-menu' })
                        : h(J(e));
                    });
                  }
                : void 0,
      ...
      var X = o(64417),
        ...
        ot = o(74295);
      function it(t) {
        const { property: e, propertyApplier: o, title: r, undoText: s, className: a } = t,
          l = (0, E.useProperty)(e),
          d = (0, i.useMemo)(
            () => [
              new G.Action({
      ...
      function st(t) {
        const { property: e, propertyApplier: o, title: r, undoText: n, className: s } = t,
          a = (0, E.useProperty)(e),
          l = nt.map(
            (t) =>
              new G.Action({
      ...
      class dt extends y.FloatingToolbar {
        ...
        setGroupedWidgetState(t, e) {
          const o = this._ensuredGetWidgetDataForId(t);
          (0, g.assert)(-1 !== dt._getStateIndexById(o.statedWidget, e), `Unknown stateId (${e})`),
        ...
        _createPopup(t) {
          ...
          t.statedWidget.states.forEach((i, r) => {
            ...
            n.addEventListener('click', s),
              ...
              n.classList.add('tv-grouped-floating-toolbar__sub-widget--slide-right-' + r),
              n.classList.add('tv-grouped-floating-toolbar__sub-widget--slide-left-' + (o - r + 1)),
        ...
        _updateWidgetPreview(t) {
          ...
          t.toolbarWidget.firstChild
            ...
            : (t.toolbarWidget.appendChild(o), t.toolbarWidget.appendChild(dt._createCaret()));
        }
          ...
          if (this.isVertical())
            ...
            i.left + r.width > window.innerWidth
              ...
              e.bottom + r.height > window.innerHeight
                ...
                : (n.classList.remove('tv-grouped-floating-toolbar__popup--at-top'), (n.style.top = ''));
          }
        }
      ...
      var ct = o(6535),
        ...
        pt = o(80538),
        ut = o(85103);
      const gt = new s.TranslatedString('change line tool(s) font size', (0, n.t)('change line tool(s) font size')),
        _t = new s.TranslatedString('change line tool(s) line style', (0, n.t)('change line tool(s) line style')),
        mt = (0, n.t)('Settings'),
        vt = (0, n.t)('Remove'),
        bt = (0, n.t)('More'),
        wt = (0, n.t)('Style'),
      ...
      class ft {
        constructor(t) {
          (this._isDrawingFinished = new (d())(!0)),
            ...
            (this._floatingToolbar = new dt({
              defaultPosition: { top: ct.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15, left: window.innerWidth / 2 },
        ...
        _unmountToolbar() {
          null !== this._container && (r.unmountComponentAtNode(this._container), (this._toolbarRendered = !1));
        }
        ...
        _prepareProperties(t) {
          const e = this.selectedSources().filter((e) => (0, h.isLineTool)(e) && e.properties()[t]);
        ...
        _createProperty(t, e, o, i) {
          ...
          if (t && t.visible())
            return this._isWidthProperty(t)
              ...
              : new b.CollectibleColorPropertyDirectWrapper(new u.MultipleLineColorsProperty([t]));
        }
    ...
    45466: (t, e, o) => {
      ...
      var h = o(37821),
        ...
        _ = new r('change line tool(s) background color', i('change line tool(s) background color')),
        m = new r('change line tool(s) text color', i('change line tool(s) text color')),
        v = new r('change line tool(s) line width', i('change line tool(s) line width')),
        b = i('Color'),
      ...
      class F extends s {
        ...
        onSourceChanged(t) {
          ...
          if ((this._createCommonButtons(), 1 === t.length)) {
            ...
            e.isAvailableInFloatingWidget() && this.findSourceOnWidget(e)
              ? (!e.userEditEnabled() ||
                  (!a(e.toolname) && this.activeChartWidget().model().lineBeingCreated()) ||
        ...
        _createWidthsButton(t, e) {
          if (
            (this._lineWidthsProperty && (this._lineWidthsProperty.destroy(), (this._lineWidthsProperty = null)),
            (this._lineWidthsProperty = this._createProperty(t, e, 'linesWidths', v)),
        ...
        _createColorsButton(t, e) {
          return (
            this._lineColorsProperty && (this._lineColorsProperty.destroy(), (this._lineColorsProperty = null)),
            (this._lineColorsProperty = this._createProperty(t, e, 'linesColors', g)),
        ...
        _createBackgroundsButton(t, e) {
          return (
            ...
            (this._backgroundsProperty = this._createProperty(t, e, 'backgroundsColors', _)),
        ...
        _createTextColorsButton(t, e) {
          return (
            ...
            (this._textColorsProperty = this._createProperty(t, e, 'textsColors', m)),
        ...
        showPropertiesOf(t, e, o) {
          ...
          if ((this._clearProperties(), (this._propertiesVisible = !1), i.length)) {
            for (var r = {}, n = 0; n < i.length; n++) {
              for (var s = i[n], a = e, l = s.name.split('.'), c = 0; c < l.length; ++c) a = a && a[l[c]];
              var h = s.showIf;
        ...
        _defaultToolProperties() {
          return [
            ...
            { name: 'linesWidths', inputType: 'combobox', factory: F.prototype._createWidthsButton },
            { name: 'linestyle', title: T, inputType: 'combobox', factory: F.prototype._createLineStyleButton },
          ];
        }
        _regressionToolExceptionCases() {
          return [{ name: 'linesWidths', inputType: 'combobox', factory: F.prototype._createWidthsButton }];
        }
        _pathExceptionCases() {
          return [
            {
        ...
        _textPropertiesExceptionCases() {
          return [
            { name: 'color', title: y, inputType: 'colorPicker', iconSvgCode: u, dataName: 'text-color', undoText: m },
            {
              name: 'backgroundColor',
              title: C,
              inputType: 'colorPicker',
            ...
            { name: 'fontsize', title: S, inputType: 'combobox', factory: F.prototype._createFontSizeButton },
          ];
        }
    ...
    91800: (t, e, o) => {
      ...
      var i = o(67294),
        ...
        _ = o(79224);
      function m(t) {
        const { property: e, icon: o, propertyApplier: r, title: m, undoText: v, className: b } = t,
          w = (0, g.useProperty)(e),
          y = (0, i.useRef)(null),
        ...
        return i.createElement(
          ...
          i.createElement(h.ColorPicker, {
            ...
            onColorChange: function (t, e) {
              const o = w ? (0, d.alphaToTransparency)((0, l.parseRgba)(w)[3]) : 0;
              E((0, d.generateColor)(String(t), o, true)), e || (0, s.ensureNotNull)(y.current).close();
            },
    ...
    31071: (t, e, o) => {
      ...
      function w(t) {
        const { multipleProperty: e, title: o, undoText: c, propertyApplier: h, className: p, isSmallScreen: u } = t,
        ...
        return i.createElement(
          a.ToolWidgetMenu,
          {
            ...
            content: i.createElement(
              ...
              null,
              w
                ? i.createElement('div', { className: m.multiWidth }, i.createElement(s.Icon, { icon: _ }))
                : i.createElement(
                    'div',
                    { className: m.buttonWrap },
                    !u && i.createElement(s.Icon, { icon: y }),
                    i.createElement('div', { className: r(!u && m.buttonLabel) }, g + 'px'),
                  ),
            ),
          },
    ...
    14236: (t, e, o) => {
      ...
      class s extends i.Component {
        ...
        shouldComponentUpdate(t, e) {
          return !n()(t, this.props) || !n()(e.rules, this.state.rules) || !n()(e.matches, this.state.matches);
        }
        componentDidMount() {
          this._migrate(null, this.state.queries);
        }
        componentDidUpdate(t, e) {
          n()(t.rules, this.props.rules) || this._migrate(e.queries, this.state.queries);
        }
