  ...
  [607],
  {
    34954: (e, t, i) => {
      ...
      var r = i(79881),
        ...
        l = i.n(s),
        a = i(5225);
      const p = new o.TranslatedString('change price Y coordinate', (0, r.t)('change price Y coordinate')),
        c = new o.TranslatedString('change bar X coordinate', (0, r.t)('change bar X coordinate'));
      function u(e, t, i) {
        return { property: (0, n.convertToDefinitionProperty)(e, t.price, p), info: { typeY: 1, stepY: i } };
      }
      function h(e, t) {
        return {
      ...
      function d(e, t, i, r, o, s) {
        ...
        return (0, n.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, a.removeSpaces)(`${s}Coordinates${o}`), title: o, ...l.info, ...p.info },
        );
      }
    },
    39884: (e, t, i) => {
      ...
      var r = i(16282),
        ...
        a = i.n(l),
        p = i(5225);
      const c = new n.TranslatedString('change {inputName} property', (0, o.t)('change {inputName} property'));
      function u(e, t) {
        const i = e.id;
        return (
        ...
        for (const _ of t) {
          ...
          if ('resolution' === _.type)
            P = (0, s.createOptionsPropertyDefinition)(
              { option: (0, s.convertToDefinitionProperty)(e, i[_.id], c.format({ inputName: g })) },
              { id: 'StudyInput' + t, title: f, options: new (a())(p.resolutionItems) },
            );
            ...
            P = (0, s.createSessionPropertyDefinition)(
              { session: (0, s.convertToDefinitionProperty)(e, i[_.id], c.format({ inputName: g })) },
              { id: 'StudyInput' + t, title: f },
            );
          else if ('bool' === _.type)
            P = (0, s.createCheckablePropertyDefinition)(
              { checked: (0, s.convertToDefinitionProperty)(e, i[_.id], c.format({ inputName: g })) },
              { id: 'StudyInput' + t, title: f },
            );
          else if ('integer' === _.type || 'float' === _.type || 'price' === _.type) {
            const r = {
              id: 'StudyInput' + t,
              title: f,
            ...
            void 0 !== _.min && (r.min = new (a())(_.min)),
              ...
              void 0 !== _.step && isFinite(_.step) && _.step > 0 && (r.step = new (a())(_.step)),
              (P = (0, s.createNumberPropertyDefinition)(
                { value: (0, s.convertToDefinitionProperty)(e, i[_.id], c.format({ inputName: g })) },
                r,
              ));
          } else
            P = (0, s.createTextPropertyDefinition)(
              { text: (0, s.convertToDefinitionProperty)(e, i[_.id], c.format({ inputName: g })) },
              { id: 'StudyInput' + t, title: f, isEditable: !0, isMultiLine: !1 },
            );
          y.push(P);
        }
    ...
    3619: (e, t, i) => {
      ...
      class v {
        ...
        _createCoordinatesPropertyPage() {
          ...
          return null !== e ? (0, l.createPropertyPage)(e, 'coordinates', _) : null;
        }
    ...
    30042: (e, t, i) => {
      ...
      const a = new o.TranslatedString(
        ...
        p = new o.TranslatedString('change {title} base line color', (0, r.t)('change {title} base line color')),
        c = new o.TranslatedString('change {title} base line width', (0, r.t)('change {title} base line width')),
        u = new o.TranslatedString('change {title} base line style', (0, r.t)('change {title} base line style')),
        h = new o.TranslatedString('change {title} up line visibility', (0, r.t)('change {title} up line visibility')),
        d = new o.TranslatedString('change {title} up line color', (0, r.t)('change {title} up line color')),
        y = new o.TranslatedString('change {title} up line width', (0, r.t)('change {title} up line width')),
        _ = new o.TranslatedString('change {title} up line style', (0, r.t)('change {title} up line style')),
        f = new o.TranslatedString(
          'change {title} down line visibility',
          (0, r.t)('change {title} down line visibility'),
        ),
        g = new o.TranslatedString('change {title} down line color', (0, r.t)('change {title} down line color')),
        P = new o.TranslatedString('change {title} down line width', (0, r.t)('change {title} down line width')),
        S = new o.TranslatedString('change {title} down line style', (0, r.t)('change {title} down line style')),
        v = new o.TranslatedString('change {title} extend lines', (0, r.t)('change {title} extend lines')),
        b = new o.TranslatedString("change {title} show pearson's r", (0, r.t)("change {title} show pearson's r")),
        m = (0, r.t)('Base'),
        D = (0, r.t)('Up'),
        w = (0, r.t)('Down'),
        I = (0, r.t)("Pearson's R"),
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs().styles.childs(),
            ...
            C = (0, n.createLinePropertyDefinition)(
              {
                checked: (0, n.convertToDefinitionProperty)(this._propertyApplier, s.visible, a.format({ title: r })),
                ...
                width: (0, n.convertToDefinitionProperty)(this._propertyApplier, s.linewidth, c.format({ title: r })),
                style: (0, n.convertToDefinitionProperty)(this._propertyApplier, s.linestyle, u.format({ title: r })),
              },
            ...
            M = (0, n.createLinePropertyDefinition)(
              {
                checked: (0, n.convertToDefinitionProperty)(this._propertyApplier, V.visible, h.format({ title: r })),
                color: (0, n.getColorDefinitionProperty)(
                  this._propertyApplier,
                  V.color,
                  e.transparency,
                ...
                width: (0, n.convertToDefinitionProperty)(this._propertyApplier, V.linewidth, y.format({ title: r })),
                style: (0, n.convertToDefinitionProperty)(this._propertyApplier, V.linestyle, _.format({ title: r })),
              },
              { id: i + 'UpLine', title: D },
            ),
            A = e.downLine.childs();
          return [
            ...
            (0, n.createLinePropertyDefinition)(
              {
                checked: (0, n.convertToDefinitionProperty)(this._propertyApplier, A.visible, f.format({ title: r })),
                color: (0, n.getColorDefinitionProperty)(
                  this._propertyApplier,
                  A.color,
                  e.transparency,
                ...
                width: (0, n.convertToDefinitionProperty)(this._propertyApplier, A.linewidth, P.format({ title: r })),
                style: (0, n.convertToDefinitionProperty)(this._propertyApplier, A.linestyle, S.format({ title: r })),
              },
              ...
              i.push(
                (0, o.createCoordinatesPropertyDefinition)(
                  { x: l.property },
                  {
                    ...
                    title: (0, r.t)('#{count} (bar)', { context: 'linetool point' }).format({
                      count: (n + 1).toString(),
                    }),
                    ...l.info,
                  },
    ...
    28603: (e, t, i) => {
      ...
      const g = (0, r.t)('Style'),
        P = (0, r.t)('Inputs'),
        S = (0, r.t)('Visibility'),
        v = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map((e) => ({
          value: e,
      ...
      var b = i(85842),
        m = i(5225),
        D = i(25436);
      const w = new o.TranslatedString('change study overlay style', (0, r.t)('change study overlay style')),
        I = new o.TranslatedString('change price line visibility', (0, r.t)('change price line visibility')),
        T = new o.TranslatedString('change study overlay min tick', (0, r.t)('change study overlay min tick')),
        C = (0, r.t)('Bars'),
        V = (0, r.t)('Candles'),
      ...
      class O extends class {
        ...
        _inputsPropertyDefinitions() {
          ...
          return (
            null !== this._sourceInput && (this._inputSourceItems = new (h())(this._getInputSourceItems())),
        ...
        _getInputSourceItems() {
          ...
          if (
            ...
            this._source &&
            (this._source.isChildStudy() || y().canBeChild(this._source.metaInfo()))
          ) {
              ...
              .forEach((t) => {
                ...
                if (1 === l.length) e.push({ id: r, value: r, title: i });
                  ...
                  const t = l.reduce((e, t, o) => {
                    ...
                    let l;
                    try {
                      l = (0, n.ensureDefined)((0, n.ensureDefined)(s)[t.id]).title;
                    } catch (e) {
                      l = t.id;
                    }
                    return { ...e, [`${r}$${o}`]: `${i}: ${l}` };
        ...
        _stylePropertyDefinitions() {
          ...
          const e = this._source.properties().childs(),
            t = (0, l.createOptionsPropertyDefinition)(
              { option: (0, l.convertToDefinitionProperty)(this._undoModel, e.style, w) },
              { id: 'StudyOverlayStyle', title: W, options: this._availableStylesWV },
            ),
            i = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._undoModel, e.showPriceLine, I) },
              { id: 'StudyOverlayPriceLine', title: L },
            ),
            r = (0, l.createOptionsPropertyDefinition)(
              { option: (0, l.convertToDefinitionProperty)(this._undoModel, e.minTick, T) },
              { id: 'StudyOverlayMinTick', title: N, options: new (h())((0, c.seriesPrecisionValues)()) },
            ),
          ...
          return B.map((t) =>
            t.readonly
              ...
              : {
                  ...
                  value: t.value,
                  title: t.title,
                  disabled: (0, D.isCloseBasedSymbol)(e) && !(0, D.isSingleValueBasedStyle)(t.value),
                },
          );
        }
      }
