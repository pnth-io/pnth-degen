    ...
    38868: (t, e, n) => {
      ...
      function _(t) {
        ...
        return o.createElement(
          ...
          c && o.createElement(i.Icon, { className: f().icon, icon: null != l ? l : L[e] }),
          o.createElement(
            'div',
          ...
          h && o.createElement(v, { 'aria-label': w, onClick: d, className: f()['close-button'], size: 'xs' }),
        );
      }
      var C = n(68174);
      function M(t) {
      ...
      class k {
        ...
        show(t) {
          this._wrap &&
            ...
            s.render(o.createElement(M, { text: t, bottomPadding: this._bottomPadding }), this._wrap),
            this._debouncedHide());
        }
        hide() {
