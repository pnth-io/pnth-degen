(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4093],
  {
    ...
    91967: (e, t, n) => {
      'use strict';
      n.d(t, { StylePropertyContext: () => r, StylePropertyContainer: () => a, bindPropertyContext: () => i });
      var s = n(67294),
        o = n(82675);
    ...
    7202: (e, t, n) => {
      ...
      var s = n(67294),
        ...
        u = n(33237);
      function c() {
        document.removeEventListener('scroll', c), document.removeEventListener('touchstart', c), (0, i.hide)();
      }
      function h(e) {
        l.mobiletouch &&
    ...
    36135: (e, t, n) => {
      'use strict';
      n.d(t, { isGroup: () => o, isInputInlines: () => r, getInputGroups: () => a });
      var s = n(16282);
      function o(e) {
              ...
              if (void 0 !== r)
                if (void 0 !== a)
                  if (n.has(r)) {
                    ...
                    let l;
                    o.has(t) ? (l = (0, s.ensureDefined)(o.get(t))) : ((l = new Map()), o.set(t, l)),
    ...
    22489: (e, t, n) => {
      ...
      function i(e) {
        ...
        return s.createElement('div', { className: o(a.inputGroup, n && a.inlineGroup, t) }, e.children);
      }
    },
    38754: (e, t, n) => {
      'use strict';
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              void 0 !== e ? e : (0, s.t)((0, r.ensureDefined)(n).name, { context: 'input' }),
            ),
            o.createElement(
              i.PropertyTable.Cell,
    ...
    4093: (e, t, n) => {
      ...
      const d = (0, l.makeSwitchGroupItem)(
        (((s = class extends o.PureComponent {
          ...
          render() {
            const e = p(this.props.className, h().radio, { [h().reverse]: Boolean(this.props.labelPositionReverse) }),
              t = p(h().label, { [h().disabled]: this.props.disabled }),
              n = p(h().box, { [h().noOutline]: -1 === this.props.tabIndex });
            let s = null;
            return (
              this.props.label && (s = o.createElement('span', { className: t }, this.props.label)),
              o.createElement(
                'label',
                { className: e },
                o.createElement(
      ...
      var m = n(16282),
        ...
        f = n(38869);
      function y(e) {
        const { children: t, input: n, disabled: s, onChange: p, grouped: u, tooltip: c } = e,
              ...
              onChange: function (e) {
                x(e),
                  'main-symbol' === e
                    ...
                    : 'another-symbol' === e && _ && (0, v.setter)(b, p)(_, n.id, n.name);
              },
            },
            o.createElement(
              i.PropertyTable.Row,
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(b.BoolInput, { label: e, input: t, hasTooltip: Boolean(n) }),
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement('span', { className: u()(N.label, s && N.hasTooltip) }, n),
      ...
      function R(e) {
        ...
        return 'symbol' === t.type && t.optional
          ...
          : 'bool' === t.type
            ? o.createElement(T, { label: (0, r.t)(t.name, { context: 'input' }), input: t, tooltip: n })
            : 'text_area' === t.type
              ? o.createElement(V, { label: (0, r.t)(t.name, { context: 'input' }), input: t, tooltip: n })
          ...
          o.createElement(
            ...
            t.children.map(
              (e, s) => (
                ...
                o.createElement(R, { key: e.id, input: e, tooltip: s === t.children.length - 1 ? n : void 0 })
              ),
            ),
          ),
        );
          ...
          ? (0, D.isInputInlines)(t)
            ...
            : o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(k.GroupTitleSection, { title: (0, r.t)(t.id, { context: 'input' }), name: t.id }),
                ),
                t.children.map((e) =>
                  (0, D.isGroup)(e)
                    ? o.createElement(M, { key: e.id, content: e })
                    : o.createElement(R, { key: e.id, input: e, tooltip: e.tooltip }),
                ),
      ...
      class G extends o.PureComponent {
        render() {
          const { reference: e, inputs: t, property: n, study: s, model: r, onStudyInputChange: a } = this.props,
            { offset: l, offsets: p } = n;
          return o.createElement(
            i.PropertyTable,
            { reference: e },
            o.createElement(z, { study: s, model: r, property: n.inputs, inputs: t, onStudyInputChange: a }),
      ...
      class C extends s.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onBlur = (e) => {
              this.setState({ displayValue: f(this.props, this.props.value), focused: !1 }),
            ...
            (this._onValueByStepChange = (e) => {
              ...
              if (i.res) {
                const s = new a.Big(i.value),
                  r = s.minus(o).mod(n);
                let u = s.plus(e * l);
                !r.eq(0) && t && (u = u.plus((e > 0 ? 0 : 1) * l).minus(r)), (p = u.toNumber());
              }
              const { isPassed: u, clampedValue: c } = this._checkValueBoundaries(p);
              (p = u ? p : c),
          ...
          const { value: t } = e;
          this.state = { value: t, displayValue: f(e, t), focused: !1, errorMsg: d };
        }
        render() {
          var e;
        ...
        _checkValueBoundaries(e) {
          ...
          const { min: a = -1 / 0, max: i = v } = this.props,
            l = (function (e, t, n) {
              const s = e >= t,
                o = e <= n;
              return { passMin: s, passMax: o, pass: s && o, clamped: (0, h.clamp)(e, t, n) };
            })(e, a, i);
          let p;
          return (
            l.passMax ||
            ...
            l.passMin ||
              (p =
                null !==
                  (o = null === (s = this.props.boundariesErrorMessages) || void 0 === s ? void 0 : s.lessThanMin) &&
                void 0 !== o
                  ? o
    ...
    64512: (e, t, n) => {
              ...
              .forEach((e) => {
                ...
                if (1 === a.length) o[n + '$0'] = t;
                  ...
                  const e = a.reduce((e, s, o) => {
                    ...
                    let a;
                    try {
                      a = (0, f.ensureDefined)((0, f.ensureDefined)(r)[s.id]).title;
                    } catch (e) {
                      a = s.id;
                    }
                    return { ...e, [`${n}$${o}`]: `${t}: ${a}` };
          ...
          return (
            ...
            s.createElement(D.Select, {
              ...
              items:
                ...
                u.map((e) => ({
                  value: e,
                  content: '' === e ? (0, _.t)('Chart') : (0, M.getTranslatedResolutionModel)(e).hint,
                }))),
              value: a,
              onChange: this._onChange,
              disabled: n,
        ...
        _getColorInputWithContext(e) {
          ...
          if ('properties' in i || 'tempProperties' in i) {
            ...
            return s.createElement(
              ...
              { model: a, property: e },
              s.createElement(z.ColorWithThicknessSelect, { className: p()(r && d.hasTooltip), color: e, disabled: o }),
            );
          }
          return null;
        }
      ...
      class q extends s.PureComponent {
        render() {
          const { input: e, disabled: t, onChange: n, tzName: l, hasTooltip: p } = this.props;
          if ((0, o.isStudyInputOptionsInfo)(e))
            return s.createElement(N.SelectInput, { input: e, disabled: t, onChange: n, hasTooltip: p });
          switch (e.type) {
            case 'integer':
              return s.createElement(r.IntegerInput, { input: e, disabled: t, onChange: n, hasTooltip: p });
            case 'float':
            case 'price':
              return s.createElement(a.FloatInput, { input: e, disabled: t, onChange: n, hasTooltip: p });
            case 'bool':
              return s.createElement(i.BoolInput, { input: e, disabled: t, onChange: n, hasTooltip: p });
            case 'text':
              return s.createElement(v, { input: e, disabled: t, onChange: n, hasTooltip: p });
            case 'symbol':
              return s.createElement(C.SymbolInput, { input: e, disabled: t, onChange: n, hasTooltip: p });
            case 'session':
              return s.createElement(x, { input: e, disabled: t, onChange: n, hasTooltip: p });
            case 'source':
              return s.createElement(k, { input: e, disabled: t, onChange: n, hasTooltip: p });
            case 'resolution':
              return s.createElement(G, { input: e, disabled: t, onChange: n, hasTooltip: p });
            case 'time':
              return null;
            case 'color':
              return s.createElement(K, { input: e, disabled: t, onChange: n, hasTooltip: p });
    ...
    78736: (e, t, n) => {
      ...
      var s = n(67294),
        ...
        u = n(37763),
        c = n(87438);
      const h = new a.TranslatedString('change thickness', (0, r.t)('change thickness')),
        ...
        constructor() {
          super(...arguments),
            ...
            (this._getColorValueInHex = () => {
              const { color: e } = this.props,
                t = (0, u.getPropertyValue)(e);
              return t ? ((0, i.isHexColor)(t) ? t : (0, o.rgbToHexString)((0, o.parseRgb)(t))) : null;
            }),
            ...
            (this._onPopupClose = () => {
              this._trackEventLabel &&
                ((0, c.trackEvent)('GUI', 'Study settings', this._trackEventLabel), (this._trackEventLabel = null));
            });
        }
        componentWillUnmount() {
          this._onPopupClose();
