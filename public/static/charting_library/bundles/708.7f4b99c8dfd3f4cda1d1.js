  ...
  [708],
  {
                    ...
                    (r = [].concat(t(r), [d])),
                      ...
                      (e.ontouchmove = function (t) {
                        ...
                        1 === t.targetTouches.length &&
                          ...
                          !u(o.target) &&
                            ((n && 0 === n.scrollTop && 0 < r) ||
                            ((s = n) && s.scrollHeight - s.scrollTop <= s.clientHeight && r < 0)
                              ? h(o)
                              : o.stopPropagation()));
                      }),
                      i || (document.addEventListener('touchmove', h, o ? { passive: !1 } : void 0), (i = !0));
                  }
                } else {
                  (m = n),
                    setTimeout(function () {
                ...
                (e.clearAllBodyScrollLocks = function () {
                  s
                    ? (r.forEach(function (e) {
                      ...
                      i && (document.removeEventListener('touchmove', h, o ? { passive: !1 } : void 0), (i = !1)),
                      (r = []),
                      (a = -1))
                    : (d(), (r = []));
                }),
                (e.enableBodyScroll = function (e) {
                  if (s) {
                    ...
                    (e.ontouchstart = null),
                      ...
                      i &&
                        0 === r.length &&
                        (document.removeEventListener('touchmove', h, o ? { passive: !1 } : void 0), (i = !1));
                  } else
    ...
    53400: (e, t, o) => {
      ...
      function l(e) {
        ...
        return n.createElement(
          ...
          n.createElement('span', { className: t }, n.createElement(r.Icon, { icon: i, className: c().icon })),
        );
      }
    },
    43001: (e, t, o) => {
          ...
          b &&
            n.createElement(
              u.PopupMenu,
              {
                ...
                onClose: E,
                position: function () {
                  const e = (0, c.ensureNotNull)(_.current).getBoundingClientRect();
      ...
      class y extends n.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = (e) => {
              ...
              if (!o) return;
              const n = (0, c.ensureNotNull)(this._container).getBoundingClientRect(),
                s = e.clientX - n.left,
                r = e.clientY - n.top;
              let i = s / n.width;
              i < 0 ? (i = 0) : i > 1 && (i = 1);
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement('div', { className: w.pointer, style: { left: 100 * o + '%', top: 100 * (1 - s) + '%' } }),
          );
        }
      }
      var k = o(70351);
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = (e) => {
              ...
              if (!n) return;
              const s = (0, c.ensureNotNull)(this._container).getBoundingClientRect();
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement('div', { className: k.pointer, style: { top: 100 * t + '%' } }),
            ),
          );
        }
      }
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              'div',
              { className: N.form },
              n.createElement('div', { className: N.swatch, style: { backgroundColor: e } }),
              n.createElement(
                'div',
                { className: N.inputWrap },
                n.createElement('span', { className: N.inputHash }, '#'),
                n.createElement('input', { type: 'text', className: N.input, value: o, onChange: this._handleInput }),
              ),
              n.createElement(
                'div',
                { className: N.buttonWrap },
                n.createElement(_.Button, { size: 's', onClick: this._handleAddColor }, I),
              ),
            ),
            n.createElement(
              'div',
              { className: N.hueSaturationWrap },
              n.createElement(y, { className: N.saturation, hsv: t, onChange: this._handleHSV }),
              n.createElement(S, { className: N.hue, hsv: t, onChange: this._handleHSV }),
            ),
          );
        }
      }
      ...
      class O extends n.PureComponent {
        ...
        render() {
          ...
          return c
            ? n.createElement(P, { color: e, onSelect: this._handleSelectColor, onAdd: this._handleAddColor })
            : n.createElement(
                'div',
                { className: T.container },
                n.createElement(f, { colors: p.basic, color: e, onSelect: this._handleSelectColor }),
                n.createElement(f, { colors: p.extended, color: e, onSelect: this._handleSelectColor }),
                ...
                s &&
                  n.createElement(
                    ...
                    n.createElement(C.Opacity, { color: e, opacity: l, onChange: this._handleOpacity }),
                  ),
              );
        }
        _onToggleCustom(e) {
    ...
    6347: (e, t, o) => {
      ...
      function c() {
        ...
        i('add_new_custom_color', (o) => t(l(o, e))), i('remove_custom_color', (o) => t(u(o, e)));
        const o = (0, n.useCallback)(
            (t) => {
              const o = t ? (0, a.parseRgb)(t) : null;
              e.some((e) => null !== e && null !== o && (0, a.areEqualRgb)((0, a.parseRgb)(e), o)) ||
                (r.emit('add_new_custom_color', t), (0, s.setJSON)('pickerCustomColors', l(t, e)));
            },
            [e],
          ),
          c = (0, n.useCallback)(
      ...
      function d(e) {
        ...
        return n.createElement(
          u,
          {
            ...
            role: o,
            'aria-selected': l,
            className: s(d, D.item, C && D.withIcon, { [D.isActive]: _, [D.isDisabled]: b || w, [D.hovered]: E }),
            title: p,
            href: k,
            target: N,
            rel: I,
            ...
            onClick: function (t) {
              const { dontClosePopup: o, onClick: n, onClickArg: s, trackEventObject: a } = e;
              if (b) return;
            ...
            onContextMenu: function (t) {
              ...
              o && n && (0, i.trackEvent)(o.category, o.event, o.label + '_rightClick');
            },
            onMouseUp: function (t) {
              const { trackEventObject: o, trackMouseWheelClick: n } = e;
              if (1 === t.button && k && o) {
                let e = o.label;
                n && (e += '_mouseWheelClick'), (0, i.trackEvent)(o.category, o.event, e);
              }
            },
            onMouseOver: M,
            onMouseOut: x,
          },
          void 0 !== C && n.createElement('div', { className: D.icon, dangerouslySetInnerHTML: { __html: C } }),
          n.createElement(
            'div',
            { className: s(D.labelRow, m) },
            n.createElement('div', { className: s(D.label, v) }, y),
          ),
          (void 0 !== g || f) && n.createElement('div', { className: D.shortcut }, (A = g) && A.split('+').join(' + ')),
          void 0 !== P &&
            n.createElement('div', { onClick: O ? h : void 0, className: s(D.toolbox, { [D.showOnHover]: S }) }, P),
        );
        var A;
      }
    },
