  ...
  [8625],
  {
      ...
      function c(e, t) {
        return (n, c) => {
          const d = (0, l.ensureNotNull)(e).getBoundingClientRect(),
            ...
            E = { x: w - (h === a.FromRightToLeft ? n : 0) + f, y: y - (p === i.FromBottomToTop ? c : 0) + b };
    ...
    3220: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        s = n(31929);
      function c(e) {
        const { id: t, fontSize: n, fontSizes: r = [], className: c, disabled: d, fontSizeChange: u } = e;
        return o.createElement(a.Select, {
          id: t,
          disabled: d,
          className: i()(c, s.defaultSelect),
          menuClassName: s.defaultSelect,
          items: ((p = r), p.map((e) => ({ value: e.value, content: e.title }))),
          value: n,
          onChange: u,
    ...
    93265: (e, t, n) => {
      ...
      function c(e) {
        ...
        return o.createElement(a.Select, { ...n, menuItemClassName: i()(t, s.itemWrap) });
      }
      function d(e) {
      ...
      function u(e) {
        return o.createElement(
          'div',
          { className: s.item },
          o.createElement(l.Icon, { className: i()(s.icon, e.iconClassName), icon: e.icon }),
        ...
        render() {
          ...
          let d = (function (e) {
            ...
            return (
              ...
              t.map((e) => ({
                value: e.type,
                selectedContent: r.createElement(s.DisplayItem, { icon: e.icon }),
                content: r.createElement(s.DropItem, { icon: e.icon, label: e.label }),
              }))
            );
          })(c);
          return (
      ...
      function s(e) {
        ...
        function p(e, t) {
          ...
          return o.createElement(
            'div',
            { className: a.item },
            o.createElement('div', { className: r(a.bar, { [a.isActive]: e === n && !t }), style: i }, ' '),
          );
        }
      }
      var c = n(82653);
    ...
    63544: (e, t, n) => {
      'use strict';
      n.d(t, { ControlCustomWidthContext: () => r, ControlCustomHeightContext: () => i });
      var o = n(67294);
    ...
    9102: (e, t, n) => {
      ...
      function s(e) {
        ...
        return o.createElement(l.CommonSection, { id: t, offset: s, checked: n, title: i, disabled: e.disabled || c });
      }
      var c = n(94184),
        d = n.n(c),
        u = n(41615),
      ...
      function m(e) {
        ...
        return o.createElement(p.LineStyleSelect, { ...e, lineStyle: n, lineStyleChange: r });
      }
      var h = n(98687),
        f = n(93302),
        v = n(16282);
      ...
      function x(e) {
        const { property: t, ...n } = e,
          ...
          [l, s] = (0, a.useDefinitionProperty)({ property: t, handler: () => i(performance.now()) }),
          c = b(l, s, r);
      ...
      class M extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onBlur = (e) => {
              (this._selection = null),
                this.setState({ displayValue: P(this.props, this.props.value, V(this.props)), focused: !1 }),
            ...
            (this._onValueChange = (e) => {
              ...
              this.setState({ displayValue: o }),
                ...
                i.value && P(this.props, r) === o && this.props.onValueChange(r, 'input');
            }),
            (this._onValueByStepChange = (e) => {
              ...
              this._checkValueBoundaries(r).value &&
                (this.setState({ displayValue: P(this.props, r, V(this.props)) }), this.props.onValueChange(r, 'step'));
            }),
            (this.state = {
        ...
        static getDerivedStateFromProps(e, t) {
          ...
          if (t.value !== o || t.valueHash !== n) {
            return { value: o, valueHash: n, displayValue: P(e, o, t.focused && t.valueHash === n ? void 0 : V(e)) };
          }
          return null;
        }
        _saveSelection(e) {
        ...
        _checkValueBoundaries(e) {
          ...
          return {
            value: (function (e, t, n) {
              const o = e >= t,
                r = e <= n;
              return { passMin: o, passMax: r, pass: o && r, clamped: (0, E.clamp)(e, t, n) };
            })(e, t, n).pass,
          };
        }
      }
      ...
      class J extends o.PureComponent {
        ...
        render() {
          const { id: e, lineEnd: t, className: n, lineEndChange: r, isRight: i, disabled: a } = this.props;
      ...
      function te(e) {
        const {
            definition: {
              id: t,
              properties: { checked: n, disabled: r, leftEnd: i, rightEnd: s, value: d, extendLeft: p, extendRight: f },
              title: v,
              valueMin: g,
              valueMax: b,
              valueStep: w,
          ...
          M = (0, $.useWatchedValueReadonly)({ watchedValue: g, defaultValue: void 0 }),
          z = (0, $.useWatchedValueReadonly)({ watchedValue: b, defaultValue: void 0 }),
          k = (0, $.useWatchedValueReadonly)({ watchedValue: w, defaultValue: void 0 }),
          P = (0, $.useWatchedValueReadonly)({ watchedValue: y, defaultValue: void 0 }),
          V = e.disabled || !D;
        return o.createElement(
          o.Fragment,
          null,
                ...
                (function () {
                  ...
                  if (n)
                    return o.createElement(
                      ...
                      o.createElement(I, { color: n, thickness: r, disabled: V, thicknessItems: i }),
                    );
                  return (
                    r &&
                    o.createElement(
                ...
                (function () {
                  ...
                  return (
                    ...
                    o.createElement(
                      'span',
                      { className: ee.control },
                      o.createElement(m, { id: (0, u.createDomId)(t, 'line-style-select'), property: n, disabled: V }),
                    )
                  );
                })(),
              ),
        ...
        return o.createElement(
          ...
          p === ne.ColorType.Solid
            ...
            : o.createElement(
                o.Fragment,
                null,
                o.createElement(I, { className: ae.firstColorPicker, color: s, disabled: n, noAlpha: r }),
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            n.hasOwnProperty('type')
              ? o.createElement(se, { id: t, properties: n, disabled: h, noAlpha: i })
      ...
      function fe(e) {
        ...
        return o.createElement(
          ...
          o.createElement(q.CellWrap, null, o.createElement(he, { property: n, disabled: p })),
        );
      }
      var ve = n(87390);
      function ge(e) {
        ...
        return o.createElement(
          ...
          o.createElement(q.CellWrap, { className: ve.twoColors }, v(n, d), v(r, u)),
        );
        function v(e, t) {
          return o.createElement(
            'span',
      ...
      function ye(e) {
        const {
          ...
          C = (0, $.useWatchedValueReadonly)({ watchedValue: d, defaultValue: void 0 }),
          S = (0, $.useWatchedValueReadonly)({ watchedValue: p, defaultValue: void 0 }),
          D = (0, $.useWatchedValueReadonly)({ watchedValue: m, defaultValue: void 0 }),
          N = (0, $.useWatchedValueReadonly)({ watchedValue: f, defaultValue: void 0 }),
      ...
      function Ee(e) {
        ...
        return o.createElement(
          o.Fragment,
          null,
          o.createElement(l.CommonSection, { id: t, offset: c, checked: n, title: s, disabled: e.disabled || u }),
          i.map((e) => o.createElement(Qt, { key: e.id, disabled: p, definition: e, offset: !0 })),
        );
      }
      var Ce = n(3220);
      function Se(e) {
      ...
      function Ne(e) {
        ...
        return o.createElement(
          'div',
          {
            className: d()(t, De.container, n && !i && De.active, i && De.disabled),
            onClick: i ? void 0 : a,
            'data-role': 'button',
      ...
      const Re = (e) => ({ content: e.title, title: e.title, value: e.value, id: e.id }),
        Be = (e) => ({ content: e.title, title: e.title, value: e.value, id: e.id });
      function Fe(e) {
        const {
            definition: {
              id: t,
          ...
          [F, L] = (0, a.useDefinitionProperty)({ property: h, defaultValue: void 0 }),
          [W, j] = (0, a.useDefinitionProperty)({ property: f, defaultValue: 'horizontal' }),
          [U, O] = (0, a.useDefinitionProperty)({ property: m, defaultValue: void 0 }),
        ...
        return o.createElement(
          ...
          (function () {
            if (C)
              return o.createElement(
                l.CommonSection,
                { id: t, offset: A, checked: i, title: C, disabled: e.disabled || B },
            ...
            return o.createElement(
              ...
              o.createElement(
                ...
                { placement: 'first', colSpan: 2, offset: A, 'data-section-name': t },
                X(),
                Z(),
              ),
            );
          ...
          (m || h) &&
            o.createElement(
              ...
              o.createElement(
                ke.PropertyTable.Cell,
                { placement: 'first', verticalAlign: 'adaptive', offset: A, 'data-section-name': t },
        ...
        function K(e, t, n) {
          return e
            ? o.createElement(Me, { className: Te.fontStyleButton, icon: t, property: e, disabled: G, 'data-name': n })
            : null;
        }
        function X() {
          return o.createElement(
            o.Fragment,
            null,
            n && o.createElement('div', { className: Te.colorPicker }, o.createElement(I, { color: n, disabled: G })),
            r &&
              S &&
              o.createElement(Se, {
        ...
        function Z() {
          return o.createElement(o.Fragment, null, K(c, _e, 'toggle-bold'), K(d, Ae, 'toggle-italic'));
        }
        function $(e, n, r, i, a, s) {
          return r || n
            ? o.createElement(
                l.CommonSection,
                { id: t + 'ColorSelect', offset: A, checked: n, title: e, disabled: G },
                r && o.createElement(I, { color: r, thickness: a, thicknessItems: s, disabled: G || i }),
              )
            : null;
        }
      }
      ...
      function Le(e) {
        const {
          ...
          g = (0, $.useWatchedValueReadonly)({ watchedValue: a, defaultValue: void 0 }),
          b = (0, $.useWatchedValueReadonly)({ watchedValue: l, defaultValue: void 0 }),
          w = (0, $.useWatchedValueReadonly)({ watchedValue: s, defaultValue: void 0 }),
          y = (0, $.useWatchedValueReadonly)({ watchedValue: c, defaultValue: void 0 }),
          E = (0, $.useWatchedValueReadonly)({ watchedValue: d, defaultValue: void 0 }),
          C = (0, $.useWatchedValueReadonly)({ watchedValue: u, defaultValue: void 0 });
        return o.createElement(
          ke.PropertyTable.Row,
          null,
          o.createElement(
            ke.PropertyTable.Cell,
            { verticalAlign: 'adaptive', placement: 'first', offset: f, 'data-section-name': i },
      ...
      class Ye extends o.PureComponent {
        ...
        render() {
          const { className: e, disabled: t, from: n, to: r, min: i, max: a } = this.props,
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                'div',
                { className: He.rangePointerWrap },
                o.createElement('div', { className: c(He.pointer, s && He.dragged), style: { [m]: 100 * p + '%' } }),
              ),
            ),
          );
        }
        ...
        _getNewPosition(e) {
          ...
          return (0, Oe.isRtl)() && (s = a.width - s - l), (0, E.clamp)(s / (a.width - l), 0, 1) * o + t;
        }
      ...
      function Ke(e) {
        const {
          ...
          w = (0, $.useWatchedValueReadonly)({ watchedValue: p, defaultValue: void 0 }),
          y = (0, $.useWatchedValueReadonly)({ watchedValue: u, defaultValue: void 0 }),
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            (function () {
              if (!w || !y) return null;
              return o.createElement(Ge.MatchMedia, { rule: 'screen and (max-width: 460px)' }, (e) =>
                o.createElement(
                  Q,
                  { breakPoint: 'Medium' },
                  o.createElement(
                    ...
                    o.createElement(
                      ...
                      e
                        ? o.createElement('span', { className: Je.rangeSlider }, '—')
                        : o.createElement(Ye, {
                            className: d()(Je.rangeSlider, R && Je.rangeSlider_mixed),
                            from: R ? w : z,
                            to: R ? y : _,
                            min: w,
                            max: y,
      ...
      function et(e) {
        const {
            definition: {
              id: t,
              properties: { disabled: n, checked: r, color: i, level: l, width: s, style: c },
              title: p,
              widthValues: h,
              styleValues: f,
            },
        ...
        return o.createElement(
          ...
          l && o.createElement(x, { className: d()(Qe.input, Qe.control), property: l, disabled: b }),
          i && o.createElement(I, { className: Qe.control, disabled: b, color: i, thickness: s, thicknessItems: h }),
          c &&
            o.createElement(m, {
      ...
      function ct(e) {
        ...
        return o.createElement(
          ...
          n.map(({ title: e, icon: n }) =>
            o.createElement(lt, { key: e, tab: e, icon: n, isActive: t === e, onTabClick: r }),
          ),
        );
      }
      var dt = n(33093),
      ...
      const bt = o.memo((e) => {
        ...
        return o.createElement(
          ...
          t.map((e) => o.createElement(vt, { key: e, className: gt.emojiItem, emoji: e, size: n, onClick: r })),
        );
      });
      var wt = n(86615),
        yt = n(36843);
      ...
      function Ct(e) {
        const { listRef: t, emojiGroups: n, emojiSize: r, onSelect: i, onContentRendered: a } = e;
        (0, o.useEffect)(() => {
          var e;
      ...
      const St = o.memo((e) => {
        ...
        return 'title' === i.type
          ? o.createElement('div', { style: t }, o.createElement(pt, { title: i.relatedTitle }))
          : o.createElement(
              'div',
              { style: t },
              o.createElement(bt, { emojis: i.content, itemSize: a, onEmojiClick: l }),
            );
      });
      var xt = n(80663);
      function Dt(e) {
        ...
        const { className: n, emojis: r, onSelect: i } = e,
              ...
              (function (e, t) {
                ...
                return (
                  e.forEach(({ title: e, emojis: o }) => {
                    ...
                    let r = [];
                    for (const i of o)
                      r.length < t ? r.push(i) : (n.push({ type: 'emojiRow', relatedTitle: e, content: r }), (r = [i]));
          ...
          u = (function (e, t = []) {
            ...
            const a = (0, o.useCallback)(
              (e) => {
                (n.current = e), null !== r.current && (r.current.disconnect(), null !== e && r.current.observe(e));
              },
              [n, r],
            );
            return (
        ...
        return o.createElement(
          ...
          o.createElement(
            'div',
            { ref: u },
            o.createElement(Ct, { listRef: a, emojiGroups: c, emojiSize: 38, onSelect: i, onContentRendered: m }),
          ),
        );
      }
      var Nt = n(15530),
        ...
        Tt = n(71770);
      const Rt = [
        { title: (0, L.t)('recently used', { context: 'emoji_group' }), emojis: [], icon: Nt },
        {
      ...
      function Ht(e) {
        ...
        return o.createElement(
          ...
          o.createElement('div', { className: d()(Ot.childrenContainer, r && Ot.disabled) }, t),
      ...
      function Kt(e) {
        ...
        const m = (0, o.useCallback)(
          ...
          h = ((f = l), (0, o.useMemo)(() => ((Rt[0].emojis = f), [...Rt]), [f]));
        var f;
        return o.createElement(
          o.Fragment,
          null,
                  ...
                  : o.createElement(
                      Bt.PopupMenu,
                      {
                        ...
                        position: (0, jt.getPopupPositioner)(i.current, {
                          horizontalDropDirection: jt.HorizontalDropDirection.FromLeftToRight,
                          horizontalAttachEdge: jt.HorizontalAttachEdge.Left,
                        }),
                        onClickOutside: u,
                        onClose: Gt,
                      },
                      o.createElement(Dt, { className: Yt.desktopSize, emojis: h, onSelect: m }),
                    ),
              ),
          ),
        );
      ...
      function Xt(e) {
        const {
          ...
          [s, c] = (0, a.useDefinitionProperty)({ property: r, defaultValue: !1 }),
          [d, u] = (0, a.useDefinitionProperty)({ property: i, defaultValue: '🙂' }),
          [p, m] = (0, a.useDefinitionProperty)({ property: l, defaultValue: ue.colorsPalette['color-tv-blue-a600'] });
        return o.createElement(
          'div',
          ...
          o.createElement(B.ColorSelect, { className: qt.colorSelect, disabled: !s, color: p, onColorChange: m }),
        );
      }
      function Qt(e) {
        ...
        if (
          ...
          return o.createElement(
            o.Fragment,
            null,
            t.title && o.createElement(qe.GroupTitleSection, { title: t.title, name: t.id }),
            i &&
              ((n = i.value()),
              n.reduce((e, t) => {
                ...
                Array.isArray(n)
                  ? o.createElement(Ze, { key: n[0].id, name: t.id, definitions: n })
                  : o.createElement(Qt, { key: n.id, ...e, definition: n }),
              ),
            'general' === t.groupType && o.createElement(ke.PropertyTable.GroupSeparator, { size: 1 }),
          );
        }
        switch (t.propType) {
          case 'line':
          ...
          case 'symbol':
            return o.createElement(i.SymbolInputsButton, { ...e, definition: t });
          case 'text':
            return o.createElement(Fe, { ...e, definition: t });
          case 'checkableSet':
    ...
    57374: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        p = n(64526);
      function m(e) {
        const { position: t = 'Bottom', onClose: n, children: m, className: h, theme: f = p } = e,
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              g === v.currentDrawer && o.createElement('div', { className: p.backdrop, onClick: n }),
              o.createElement(
                'div',
                {
          ...
          return o.createElement(
            l.DisclosureMenuView,
            {
              ...
              onListboxKeyDown: function (e) {
                S && 27 === (0, a.hashFromEvent)(e) && (e.stopPropagation(), z());
              },
            },
            g,
            o.createElement('span', { className: d.invisibleFocusHandler, tabIndex: 0, 'aria-hidden': !0, onFocus: z }),
          );
        });
    ...
    14303: (e, t, n) => {
      ...
      function d(e) {
        ...
        return r.createElement(a.Icon, {
          ...m,
          'data-name': p,
          className: i(s.button, 'apply-common-tooltip', n && s.active, u && s.hidden, t),
          icon: l,
          onClick: o,
          title: d || c.remove,
        });
