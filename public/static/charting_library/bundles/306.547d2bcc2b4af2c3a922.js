      ...
      const o = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = n.parentNode) || void 0 === t || t.removeChild(n), (e = i - r);
          }
          return e;
        };
      })();
      ...
      function a(e) {
        ...
        if (e && 1 == ++d) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (i(n, 'right', o() + 'px'), (t.style.paddingRight = d + o() + 'px'), (l = !0)),
            t.classList.add('i-no-scroll');
        } else if (!e && d > 0 && 0 == --d && (t.classList.remove('i-no-scroll'), l)) {
          i(n, 'right', '0px');
          let e = 0;
      ...
      class l extends o.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            i.createPortal(o.createElement(a.Provider, { value: this }, this.props.children), e)
          );
        }
        moveToTop() {
