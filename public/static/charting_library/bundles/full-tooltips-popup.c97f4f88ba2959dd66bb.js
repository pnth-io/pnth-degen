  ...
  [8643],
  {
                ...
                if (r) {
                  ...
                  if (
                    ...
                    (a = [].concat(t(a), [m])),
                      ...
                      i || (document.addEventListener('touchmove', u, n ? { passive: !1 } : void 0), (i = !0));
                  }
                } else {
                  (v = o),
                    setTimeout(function () {
                ...
                (e.clearAllBodyScrollLocks = function () {
                  r
                    ? (a.forEach(function (e) {
                      ...
                      i && (document.removeEventListener('touchmove', u, n ? { passive: !1 } : void 0), (i = !1)),
                      (a = []),
                      (l = -1))
                    : (m(), (a = []));
                }),
                (e.enableBodyScroll = function (e) {
                  if (r) {
                    ...
                    (e.ontouchstart = null),
                      ...
                      i &&
                        0 === a.length &&
                        (document.removeEventListener('touchmove', u, n ? { passive: !1 } : void 0), (i = !1));
                  } else
    ...
    36783: (e, t, n) => {
      ...
      function w(e) {
        ...
        const n = t.map((t) => {
          const { title: n, titleColor: r, icon: a, iconClassName: i, html: l, action: s, size: p } = t;
          ...
          return (
            ...
            o.createElement(
              ...
              o.createElement(m.Icon, { className: d(f.icon, i, f[p]), icon: a || void 0 }),
              o.createElement(
                'div',
                { className: f.desc },
      ...
      function y(e) {
        ...
        return o.createElement(
          s.DrawerManager,
          null,
          o.createElement(i.MatchMedia, { rule: 'screen and (max-width: 428px)' }, (t) =>
            t
              ? o.createElement(l.Drawer, { onClose: e.onClose, position: 'Bottom' }, n)
              : o.createElement(
                  a.PopupMenu,
      ...
      function E(e, t, n, a, i, l) {
        const s = { rendererButton: n, position: l, statusWidgetInfos: a, onClose: i };
        e ? r.render(o.createElement(y, { ...s }), t) : r.unmountComponentAtNode(t);
      }
    },
    94004: (e, t, n) => {
      'use strict';
