  ...
  [7271],
  {
    ...
    66664: (e, t, s) => {
      ...
      const S = (0, m.getAvailableExchanges)(),
        y = {};
      for (const e of S) y[e.value] = { country: e.country, providerId: e.providerId };
      function b(e) {
      ...
      class w {
        ...
        getSymbolSnapshot(e, t, s = guid()) {
          ...
          if (o && 'ok' === o.status) {
            ...
            if (D(o, t) || s) return this._resolvedSymbolsSet.add(e), Promise.resolve(o);
          }
          ...
          const t = new Promise((t) => {
            const s = this._clientId + '_SymbolFullName',
              o = (i) => {
                ...
                i && 'ok' === i.status ? i.values && n(i.values.pro_name || e) : n(e);
              };
      ...
      class C {
        constructor(e) {
          (this._contentItemList = new (l())([])),
            ...
            (this._recentSymbolsEnabled = i.enabled('compare_recent_symbols_enabled')),
            ...
            (this._getResolveSymbolPromise = (e, t = (0, n.makeNextSymbolId)()) => {
              const s = (0, r.encodeExtendedSymbolOrGetSimpleSymbolString)({ symbol: e });
              return new Promise((e) => {
                (0, o.ensureNotNull)(this._chartSession).resolveSymbol(t, s, (t) => {
                  e(t);
                });
              });
            }),
          ...
          Promise.all(d).then((e) => {
            ...
            e.filter(A).forEach((e, i) => {
              const n = o[i],
                r = n.id();
              this._addStudyIdToCheckedSymbols(e, r), this._idToStudyMap.set(r, n), t.has(e) ? s.add(e) : a.add(e);
            });
        ...
        _handleApplyProcess(e, t, s) {
          ...
          const n = i.id(),
            r = t(o),
            a = s(o, r, i);
          this._saveRecent(r), this._addStudyIdToCheckedSymbols(r, n), this._showNewItem(a, r, n);
        }
        _handleInitProcess(e, t, s, o) {
          ...
          for (const n of e) {
            ...
            if (void 0 === a || l) this._recentSymbolsEnabled && i.push(o(e, r, !1));
            else for (const t of a) i.push(o(e, r, !0, this._idToStudyMap.get(t)));
          }
