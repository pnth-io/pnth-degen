      ...
      function r(e, t, n) {
        ...
        for (const e of p)
          for (const t of e.units)
            t.id !== c && l.has(t.id) && h.actions.push(s(t.id, t.name, t.description, !1, () => a(t.id)));
        h.actions.length > 0 && r.push(h);
        ...
        if (null !== f)
          for (const e of p) {
            ...
            for (const n of e.units)
              n.id === c || l.has(n.id) || t.actions.push(s(n.id, n.name, n.description, !1, () => a(n.id)));
      ...
      function B(e) {
        ...
        return o.createElement(r.MatchMedia, { rule: c.DialogBreakpoints.TabletSmall }, (e) =>
          e
            ...
            : o.createElement(L, { ...n, ...E, position: (0, l.getPopupPositioner)(t, T), doNotCloseOn: t }),
        );
        function C() {
