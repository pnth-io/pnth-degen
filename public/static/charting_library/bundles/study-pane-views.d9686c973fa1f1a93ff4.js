        ...
        hitTest(t) {
          ...
          for (let s = 1; s < i; s++) {
            const i = this._points[s - 1],
              r = this._points[s];
            if ((0, n.distanceToSegment)(i, r, t).distance <= e) return this._hittest;
          }
          if (this._data.filled && this._data.fillBackground && i > 0) {
            const s = this._points[0],
              r = this._points[i - 1];
            if ((0, n.distanceToSegment)(s, r, t).distance <= e) return this._hittest;
          }
        ...
        _drawImpl(t, e) {
          ...
          if (
            (this._data.filled &&
              ...
              ((t.fillStyle = (0, h.generateColor)(this._data.backcolor, this._data.transparency)), t.fill()),
    ...
    67046: (t, e, i) => {
        ...
        hitTest(t, e) {
          ...
          for (const s of i.histograms) {
            ...
            for (const l of s.bars) {
              ...
              if (h.location === d.HHistLocation.Absolute && (s.xRange.min >= t.x || t.x >= s.xRange.max)) continue;
              null === a &&
                ((a = 0),
                s.bars.forEach((t) => {
              ...
              const c = v(s.xRange, h, e.cssWidth),
                ...
                _ = p(r, r + l.height);
              r += l.height;
              const g = Math.max((h.percentWidth * o) / 100 - l.subBarValues.length, 0);
          ...
          t.save(),
            i.histograms.forEach((s) => {
              ...
              const h = o / s.bars.length,
                d = ((c = h), (u = e.pixelRatio), Math.floor(c * u) >= 1 * u ? Math.floor(u) : 0);
              var c, u;
              const _ = f(s.xRange),
                x = [];
              if (
                (s.bars.forEach((o) => {
                  ...
                  for (let i = 0; i < o.subBarValues.length; i++) {
                    const s = f.min,
                      n = f.max,
                      r = 0 === i ? c : c + u * ((R * o.subBarValues[i - 1]) / a),
      ...
      function m(t, e, i, s, n) {
        const r = Math.min(Math.round((1.7 * t) / n.length), Math.round(0.6 * f(e))),
          ...
          c = l + 3 * h,
          u = e.min + 0.7 * f(e);
        return { text: n, color: s.valuesColor, fontSize: r, align: a, point: new o.Point(c, u) };
      }
      function R(t, e, i) {
      ...
      class w {
        ...
        _prepareStyles() {
          ...
          for (const n of e) {
            const e = (0, s.ensureDefined)(i.child(n)),
              ...
              a = (0, x.generateColor)(e.colors[0].value(), e.transparencies[0].value()),
              o = e.colors[1] ? (0, x.generateColor)(e.colors[1].value(), e.transparencies[1].value()) : a;
        ...
        _updateDataForRenderers(t, e, i) {
          ...
          this._rendererData.histograms.push({ xRange: a, yRange: p(o[0].yRange.min, h), bars: l });
        }
      }
    },
    95630: (t, e, i) => {
