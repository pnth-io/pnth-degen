(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3463],
  {
                ...
                if (r) {
                  ...
                  if (
                    ...
                    (l = [].concat(t(l), [v])),
                      ...
                      i || (document.addEventListener('touchmove', d, o ? { passive: !1 } : void 0), (i = !0));
                  }
                } else {
                  (m = n),
                    setTimeout(function () {
                ...
                (e.clearAllBodyScrollLocks = function () {
                  r
                    ? (l.forEach(function (e) {
                      ...
                      i && (document.removeEventListener('touchmove', d, o ? { passive: !1 } : void 0), (i = !1)),
                      (l = []),
                      (c = -1))
                    : (v(), (l = []));
                }),
                (e.enableBodyScroll = function (e) {
                  if (r) {
                    ...
                    (e.ontouchstart = null),
                      ...
                      i &&
                        0 === l.length &&
                        (document.removeEventListener('touchmove', d, o ? { passive: !1 } : void 0), (i = !1));
                  } else
    ...
    53178: (e, t, o) => {
      'use strict';
      o.d(t, { validateRegistry: () => c, RegistryProvider: () => a, registryContextType: () => s });
      var n = o(67294),
        r = o(45697),
        l = o.n(r);
    ...
    11086: (e, t, o) => {
      'use strict';
      o.d(t, { hoverMouseEventFilter: () => l, useAccurateHover: () => i, useHover: () => r });
      var n = o(67294);
      function r() {
      ...
      function v(e) {
        ...
        return n.createElement(
          u,
          {
            ...
            role: o,
            'aria-selected': s,
            className: r(v, R.item, b && R.withIcon, { [R.isActive]: w, [R.isDisabled]: E || y, [R.hovered]: T }),
            title: f,
            href: k,
            target: x,
            rel: M,
          ...
          void 0 !== b && n.createElement('div', { className: R.icon, dangerouslySetInnerHTML: { __html: b } }),
          n.createElement(
            'div',
            { className: r(R.labelRow, m) },
            n.createElement('div', { className: r(R.label, h) }, C),
          ),
          (void 0 !== g || p) && n.createElement('div', { className: R.shortcut }, (H = g) && H.split('+').join(' + ')),
          void 0 !== I &&
            n.createElement('div', { onClick: A ? d : void 0, className: r(R.toolbox, { [R.showOnHover]: O }) }, I),
        );
        var H;
      }
    },
