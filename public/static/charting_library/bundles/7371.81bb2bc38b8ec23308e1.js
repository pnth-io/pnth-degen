  ...
  [7371],
  {
    ...
    63725: (e, t, n) => {
      ...
      var i = n(79881),
        ...
        m = n(674),
        w = n.n(m);
      const p = new o.TranslatedString('change {propertyName} property', (0, i.t)('change {propertyName} property'));
      class y extends w() {
        constructor(e, t, n) {
          super(),
            (this._isProcess = !1),
        ...
        setValue(e, t) {
          this._propertyApplier.beginUndoMacro(p.format({ propertyName: this._propertyName })),
            (this._isProcess = !0),
        ...
        subscribe(e, t) {
          ...
          this._listenersMappers.push({ obj: e, method: t, callback: n }), this._baseProperty.subscribe(e, n);
        }
        unsubscribe(e, t) {
          var n;
          const i = (0, h.ensureDefined)(
            null === (n = this._listenersMappers.find((n) => n.obj === e && n.method === t)) || void 0 === n
              ? void 0
              : n.callback,
          );
      ...
      const g = new o.TranslatedString(
        ...
        T = new o.TranslatedString('change {title} seconds from', (0, i.t)('change {title} seconds from')),
        u = new o.TranslatedString('change {title} seconds to', (0, i.t)('change {title} seconds to')),
        P = new o.TranslatedString(
          'change {title} visibility on minutes',
          (0, i.t)('change {title} visibility on minutes'),
        ),
        b = new o.TranslatedString('change {title} minutes from', (0, i.t)('change {title} minutes from')),
        v = new o.TranslatedString('change {title} minutes to', (0, i.t)('change {title} minutes to')),
        k = new o.TranslatedString(
          'change {title} visibility on hours',
          (0, i.t)('change {title} visibility on hours'),
        ),
        S = new o.TranslatedString('change {title} hours from', (0, i.t)('change {title} hours from')),
        D = new o.TranslatedString('change {title} hours to', (0, i.t)('change {title} hours to')),
        _ = new o.TranslatedString('change {title} visibility on days', (0, i.t)('change {title} visibility on days')),
        C = new o.TranslatedString('change {title} days from', (0, i.t)('change {title} days from')),
        L = new o.TranslatedString('change {title} days to', (0, i.t)('change {title} days to')),
        V = new o.TranslatedString(
          'change {title} visibility on weeks',
          (0, i.t)('change {title} visibility on weeks'),
        ),
        I = new o.TranslatedString('change {title} weeks from', (0, i.t)('change {title} weeks from')),
        x = new o.TranslatedString('change {title} weeks to', (0, i.t)('change {title} weeks to')),
        R = new o.TranslatedString(
          'change {title} visibility on months',
          (0, i.t)('change {title} visibility on months'),
        ),
        F = new o.TranslatedString('change {title} months from', (0, i.t)('change {title} months from')),
        M = new o.TranslatedString('change {title} months to', (0, i.t)('change {title} months to')),
        A =
        ...
        W = (0, i.t)('Weeks'),
        U = (0, i.t)('Months'),
        q = ((0, i.t)('Ranges'), new o.TranslatedString('ticks', (0, i.t)('ticks'))),
      ...
      function we(e, t, n) {
        ...
        if (r.enabled('tick_resolution')) {
          const o = (0, s.createCheckablePropertyDefinition)(
            { checked: (0, s.convertToDefinitionProperty)(e, t.ticks, g.format({ title: n })) },
        ...
        if ((0, c.isSecondsEnabled)()) {
          const o = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.seconds, f.format({ title: n })),
              from: (0, s.convertToDefinitionProperty)(e, t.secondsFrom, T.format({ title: n })),
              to: (0, s.convertToDefinitionProperty)(e, t.secondsTo, u.format({ title: n })),
            },
            { id: 'IntervalsVisibilitiesSecond', title: N, min: new (l())(ae[0]), max: new (l())(ae[1]) },
          );
          i.push(o);
        }
        const o = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.minutes, P.format({ title: n })),
              from: (0, s.convertToDefinitionProperty)(e, t.minutesFrom, b.format({ title: n })),
              to: (0, s.convertToDefinitionProperty)(e, t.minutesTo, v.format({ title: n })),
            },
            { id: 'IntervalsVisibilitiesMinutes', title: j, min: new (l())(le[0]), max: new (l())(le[1]) },
          ),
          a = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.hours, k.format({ title: n })),
              from: (0, s.convertToDefinitionProperty)(e, t.hoursFrom, S.format({ title: n })),
              to: (0, s.convertToDefinitionProperty)(e, t.hoursTo, D.format({ title: n })),
            },
            { id: 'IntervalsVisibilitiesHours', title: E, min: new (l())(ce[0]), max: new (l())(ce[1]) },
          ),
          d = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.days, _.format({ title: n })),
              from: (0, s.convertToDefinitionProperty)(e, t.daysFrom, C.format({ title: n })),
              to: (0, s.convertToDefinitionProperty)(e, t.daysTo, L.format({ title: n })),
            },
            { id: 'IntervalsVisibilitiesDays', title: H, min: new (l())(de[0]), max: new (l())(de[1]) },
          );
        i.push(o, a, d);
        const h = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.weeks, V.format({ title: n })),
              from: (0, s.convertToDefinitionProperty)(e, t.weeksFrom, I.format({ title: n })),
              to: (0, s.convertToDefinitionProperty)(e, t.weeksTo, x.format({ title: n })),
            },
            { id: 'IntervalsVisibilitiesWeeks', title: W, min: new (l())(he[0]), max: new (l())(he[1]) },
          ),
          m = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.months, R.format({ title: n })),
              from: (0, s.convertToDefinitionProperty)(e, t.monthsFrom, F.format({ title: n })),
              to: (0, s.convertToDefinitionProperty)(e, t.monthsTo, M.format({ title: n })),
            },
            { id: 'IntervalsVisibilitiesMonths', title: U, min: new (l())(me[0]), max: new (l())(me[1]) },
          );
        return i.push(h, m), i;
      }
      function pe(e, t) {
