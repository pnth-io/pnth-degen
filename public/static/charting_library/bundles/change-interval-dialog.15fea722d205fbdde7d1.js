  ...
  [2077],
  {
    ...
    12028: (e, t, n) => {
      ...
      function v(e) {
        ...
        return r.createElement(p.Icon, { icon: g, className: o()('apply-common-tooltip', t), title: n ? f : m });
      }
      var h = n(72454),
        w = n(1467);
      var E = n(35001),
          ...
          f = (function (e, t) {
            return (0, r.useMemo)(() => {
              ...
              if ('R' === r && t.qty > (0, w.getMaxResolutionValue)('R')) n = !1;
                ...
                t.qty * ('H' === r ? 60 : 1) > (0, w.getMaxResolutionValue)('1') && (n = !1);
              } else
                'S' === r
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement('div', { className: y.title }, (0, s.t)('Change interval')),
                r.createElement(v, { className: y.infoHint, isSecondsEnabled: (0, w.isSecondsEnabled)() }),
              ),
              r.createElement(
                'form',
                {
                  ...
                  onSubmit: function (e) {
                    ...
                    n && t !== n && f && ((r = n), (0, w.setLastUsedResolution)(r), c.linking.interval.setValue(r));
                    var r;
                    null == i || i();
                  },
                },
              ...
              f
                ...
                : r.createElement('div', { className: o()(y.hint, y.error) }, (0, s.t)('Not applicable')),
            ),
          )
        );
      }
      var O = n(39518);
      function M(e) {
        if (O.dialogsOpenerManager.isOpened('ChangeIntervalDialog') || O.dialogsOpenerManager.isOpened('SymbolSearch'))
          return;
        const t = document.createElement('div'),
          ...
          s = r.createElement(C, {
            ...
            selectOnInit: a,
            onClose: function () {
              i.unmountComponentAtNode(t), O.dialogsOpenerManager.setAsClosed('ChangeIntervalDialog'), null == o || o();
            },
          });
        i.render(s, t), O.dialogsOpenerManager.setAsOpened('ChangeIntervalDialog');
      }
    },
    59726: (e, t, n) => {
      'use strict';
