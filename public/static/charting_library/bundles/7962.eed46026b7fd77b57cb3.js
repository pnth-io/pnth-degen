          ...
          const {
            ...
            _ =
              ...
              ('string' == typeof o
                ...
                : r.cloneElement(o, { className: i(g.icon, o.props.className) }));
      ...
      class m extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            this.state.isOpened &&
              (v ? r.createElement(d.MatchMedia, { rule: v }, (e) => this._renderContent(e)) : this._renderContent(c)),
          );
        }
        close() {
        ...
        _renderContent(e) {
          ...
          return m
            ? r.createElement(
                c.DrawerManager,
                null,
                r.createElement(l.Drawer, { onClose: this._handleClose, position: s, 'data-name': t }, w),
              )
            : r.createElement(
                n.PopupMenu,
                {
