  ...
  [139],
  {
    ...
    49775: (e, r, t) => {
      ...
      const n = o.forwardRef((e, r) => {
        const { icon: t = '', ...n } = e;
        return o.createElement('span', { ...n, ref: r, dangerouslySetInnerHTML: { __html: t } });
      });
    },
    39450: (e, r, t) => {
      'use strict';
      t.r(r), t.d(r, { ErrorCard: () => v, ResizableErrorCard: () => C, ErrorCardRenderer: () => g });
      var o = t(67294),
        n = t(73935),
        s = t(58848),
        a = t(94184),
        ...
        l = t(44186),
        h = t(58211);
      const u = { ghost: { 1: d, 2: l }, 'stop-hand': { 1: void 0, 2: void 0 } },
        v = o.forwardRef((e, r) => {
          const { icon: t, message: n, size: s = 1 } = e;
          return o.createElement(
            'div',
            { ref: r, className: i()(h.errorCard, 2 === s && h.errorCard_size_big) },
            o.createElement(c.Icon, { icon: t && u[t][s], className: h.errorCard__icon }),
      ...
      class g {
        constructor() {
          this._state = { message: null, icon: void 0, backgroundColor: null, textColor: null };
        ...
        _render() {
          ...
          n.render(e ? o.createElement(C, { message: e, icon: r }) : o.createElement(o.Fragment, null), this.container);
        }
      }
    },
    44186: (e) => {
