  ...
  [9374],
  {
    ...
    35771: (e, t, n) => {
      ...
      class h extends r.PureComponent {
        ...
        render() {
          return r.createElement(
            i.PopupDialog,
            { className: D.popupDialog, isOpened: this.props.isOpened, onClickOutside: this.props.onClose },
    ...
    3344: (e, t, n) => {
      ...
      var o = n(59104),
        ...
        s = n(76553);
      function a(e) {
        while (e > i().minutesPerDay) e -= i().minutesPerDay;
        const t = e % 60,
          n = (e - t) / 60,
          ...
          return `${s}${n
            .map((e) => {
              const t = e.sessionStartDayOfWeek(),
                ...
                r = ((e, t) => {
                  let n = e + t;
                  while (n > i().SATURDAY) n -= i().SATURDAY;
                  return n;
    ...
    69303: (e, t, n) => {
      ...
      var E,
        ...
        S = [p.MONDAY, p.TUESDAY, p.WEDNESDAY, p.THURSDAY, p.FRIDAY, p.SATURDAY, p.SUNDAY],
        N = S.reduce((e, t) => ((e[t] = A[t]), e), {});
      function g(e) {
        return (
          !((e) => e && e.type && 'economic' === e.type)(e) &&
          !((e, t) => e && e.listed_exchange && t.indexOf(e.listed_exchange) >= 0)(e, [
            'QUANDL',
            'BSE_EOD',
            'NSE_EOD',
            'LSE_EOD',
      ...
      function _(e) {
        return void 0 === e.minmov || void 0 === e.pricescale ? null : f(e).format(e.minmov / e.pricescale);
      }
      function M(e) {
      ...
      function O(e) {
        E || ((E = document.createElement('div')), document.body.appendChild(E)), c.render(l.createElement(u, e), E);
      }
      function U(e) {
      ...
      t.showSymbolInfoDialog = (e, t) => {
        if ((O({ isOpened: !1 }), null == e && (e = r.symbol.value()), null != e)) {
          e += '';
          var n = t && t.symbolInfo,
            i = [
              { title: o('Symbol Name'), propName: v.enabled('charting_library_base') ? 'name' : 'pro_name' },
              ...
              },
              {
                ...
                visibility: () => t.showUnit,
                formatter: (e) => e || '',
                defValue: '',
              },
              { title: o('Pip Size'), propName: 'pip_size', getter: b, visibility: k },
              { title: o('Tick Size'), propName: 'tick_size', getter: _ },
              { title: o('Sector'), propName: 'sector' },
              { title: o('Industry'), propName: 'industry' },
              { title: o('Timezone'), propName: 'timezone', formatter: U, visibility: g },
              {
                title: o('Session'),
