  ...
  [847],
  {
    ...
    37850: (e, t, n) => {
      ...
      class c extends o.PureComponent {
        render() {
          ...
          return (
            this.props.label &&
              (c = o.createElement('span', { className: l, title: this.props.title }, this.props.label)),
            o.createElement('label', { className: a }, o.createElement(s.CheckboxInput, { ...n, className: e }), c)
          );
        }
      }
      ...
      const b = r.forwardRef((e, t) => {
        ...
        return r.createElement(p.ControlSkeleton, {
          ...
          middleSlot: r.createElement(
            h.MiddleSlot,
            null,
            r.createElement('textarea', { ...B, className: a(g().textarea, c), ref: t }),
          ),
        });
      });
      ...
      const f = (e, t, n) => (t ? void 0 : e ? -1 : n),
        ...
        v = r.forwardRef((e, t) => {
          ...
          const {
            ...
            x = (0, r.useRef)(null),
            M = (0, r.useRef)(null),
            { isMouseDown: I, handleMouseDown: T, handleMouseUp: L } = (0, c.useIsMouseDown)(),
            [P, V] = (0, l.useFocus)(),
          ...
          return r.createElement(b, {
            ...
            onMouseUp: L,
            ref: function (e) {
              (x.current = e), 'function' == typeof t ? t(e) : t && (t.current = e);
            },
    ...
    66094: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        u = n(35347),
        d = n(50105);
      const p = { large: s.InputClasses.FontSizeLarge, medium: s.InputClasses.FontSizeMedium },
        h = {
      ...
      function m(e) {
        const {
          ...
          w = C ? o.createElement(l.StartSlot, { className: d.innerLabel, interactive: !1 }, C) : void 0,
      ...
      function x(e) {
        ...
        return o.createElement(m, {
          ...
          button: (function () {
            const { button: n, forceShowControls: s, disabled: l, title: i } = e,
            ...
            return l
              ...
              : o.createElement(
                  ...
                  null != n
                    ? n
                    : o.createElement(v, { increaseValue: u, decreaseValue: d, defaultButtonsVisible: c, title: i }),
                );
          })(),
          disabled: e.disabled,
    ...
    41497: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        a = n(79881),
        s = n(90963);
      const l = (0, n(65447).getLogger)('Platform.GUI.StudyInputPropertyContainer'),
        i = new s.TranslatedString('change {propertyName} property', (0, a.t)('change {propertyName} property')),
        ...
        constructor(e) {
          super(e),
            (this._setValue = (e, t, n) => {
              ...
              l.logNormal(`Changing property "${e}" value from "${o.value()}" to "${t}"`);
        ...
        componentDidMount() {
          ...
          e.childNames().forEach((n) => {
            (0, r.ensureDefined)(e.child(n)).subscribe(this, (e) => {
              const o = e.value();
              l.logNormal(`Property "${n}" updated to value "${o}"`), this.setState({ [n]: o }), null == t || t(o, n);
            });
          });
        }
        componentWillUnmount() {
    ...
    49923: (e, t, n) => {
      ...
      const u = (0, s.bind)(function (e) {
        ...
        return o.createElement(i.SymbolInputsButton, { ...e, value: c(l || s || '', n), study: n });
      });
    },
    35665: (e, t, n) => {
      'use strict';
      ...
      class i extends o.PureComponent {
        render() {
          return o.createElement('div', { ref: this.props.reference, className: s.content }, this.props.children);
        }
      }
      (i.InlineRowContext = l),
        ...
        (i.Cell = function (e) {
          ...
          return o.createElement(
            'div',
            { ...i, className: n },
            o.createElement('div', { className: r(s.inner, e.className) }, e.children),
          );
        }),
        (i.Separator = function (e) {
          return o.createElement(i.Row, null, o.createElement('div', { className: r(s.cell, s.separator, s.fill) }));
        }),
        (i.GroupSeparator = function (e) {
          ...
          return o.createElement(
            i.Row,
            null,
            o.createElement('div', { className: r(s.cell, s.groupSeparator, s.fill, 1 === t && s.big) }),
          );
        });
    },
    32895: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        d = n(97873);
      function p(e) {
        const { button: t, children: n, className: r, onPopupClose: a, ...p } = e,
          [h, m] = (0, o.useState)(!1),
          [g, b] = (0, o.useState)(!1),
          [f, C] = (0, c.useFocus)(),
          v = (0, o.useRef)(null);
        return o.createElement(
          ...
          o.createElement(
            i.PopupMenu,
            {
              ...
              onClose: E,
              position: function () {
                const e = (0, s.ensureNotNull)(v.current).getBoundingClientRect();
            ...
            o.createElement(d.MenuContext.Consumer, null, (e) =>
              o.createElement(u.ColorPicker, { ...p, onToggleCustom: m, menu: e }),
            ),
            !h && n,
          ),
        );
      ...
      function y(e) {
        const { name: t, values: n, selectedValues: r, onChange: a } = e,
          s = n.map((e, t) => o.createElement(v, { key: t, value: e.toString() })),
    ...
    8786: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        b = n(44766);
      function f(e) {
        const { value: t, onClick: n, className: a, startSlot: s, disabled: l = !1 } = e;
        return o.createElement(
          'div',
          { className: r(b.wrap, l && b.disabled, a), onClick: n, 'data-name': 'edit-button' },
          o.createElement(
            'div',
      ...
      function k(e) {
        ...
        return o.createElement(f, {
          ...
          disabled: r,
          className: a()(l, u.enabled('uppercase_instrument_names') && N.uppercase),
        });
      }
      function w(e) {
        if ('definition' in e) {
          const { propType: t, properties: n, id: r, title: a = '' } = e.definition,
            s = n[t],
            i = s.value() || '',
            c = (e) => {
              s.setValue(e);
          ...
          return o.createElement(
            ...
            o.createElement(
              v.CellWrap,
              null,
              o.createElement(k, { symbol: (0, l.ensureDefined)(i), onSymbolChanged: c }),
            ),
          );
        }
        {
    ...
    65244: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        s = n(75671);
      function l(e) {
        return o.createElement('div', { className: a()(s.wrap, e.className) }, e.children);
      }
    },
    96021: (e, t, n) => {
      'use strict';
    ...
    15973: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        a = n(96021);
      function s(e) {
        const { id: t, offset: n, disabled: s, checked: l, title: i, children: c } = e;
        return o.createElement(
          r.PropertyTable.Row,
          null,
          o.createElement(
            ...
            o.createElement(a.CheckableTitle, { name: 'is-enabled-' + t, title: i, disabled: s, property: l }),
          ),
          Boolean(c) && o.createElement(r.PropertyTable.Cell, { placement: 'last', 'data-section-name': t }, c),
        );
      }
    },
    46358: (e, t, n) => {
      ...
      function l(e) {
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(a.CheckableTitle, { title: e.title, name: 'is-enabled-' + e.name, className: s.title }),
          ),
        );
      }
    },
