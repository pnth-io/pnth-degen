(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5516, 3718],
  {
    ...
    14552: (e) => {
      e.exports = { button: 'button-1iP43u_z', text: 'text-1iP43u_z', logo: 'logo-1iP43u_z' };
    },
    44649: (e) => {
    ...
    73226: (e, t, a) => {
      ...
      class h extends i.PureComponent {
        ...
        render() {
          const { className: e, color: t = 'black', staticPosition: a } = this.props,
    ...
    84264: (e, t, a) => {
      'use strict';
      a.d(t, { DEFAULT_MENU_ITEM_SWITCHER_THEME: () => u, MenuItemSwitcher: () => m });
      var n = a(67294),
        i = a(94184),
        s = a.n(i),
        o = a(6920),
      ...
      class h extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            ...
            n.createElement('input', { ...s, type: 'checkbox', className: o, ref: e }),
            n.createElement(
              'div',
    ...
    40916: (e, t, a) => {
      ...
      class F extends i.PureComponent {
        ...
        render() {
          const { isShownQuicks: e, displayMode: t = 'full', id: a } = this.props,
            { activeStyle: n, favorites: s, styles: o, japaneseStyles: l, lastSelectedNotFavorite: c } = this.state,
            u = 'small' !== t && e && 0 !== s.length,
            p = [...s];
          p.includes(n) ? void 0 !== c && p.push(c) : p.push(n);
          const v = u && p.length > 1;
          return i.createElement(y.MatchMedia, { rule: k.DialogBreakpoints.TabletSmall }, (e) => {
            ...
            return i.createElement(
              ...
              i.createElement(
                ...
                {
                  arrow: Boolean(v),
                  content: v ? void 0 : i.createElement(b, null, i.createElement(d.Icon, { icon: h.SERIES_ICONS[n] })),
      ...
      function L(e) {
        const { text: t, className: a, displayMode: n, collapseWhen: s = H, ...o } = e,
          l = !s.includes(n);
        return i.createElement(S.ToolWidgetButton, {
          ...o,
          text: l ? t : void 0,
      ...
      function ee(e, t) {
        ...
        return (
          ...
          Promise.all(a).then(
            (e) => (Y.logNormal('Requesting favorites info finished'), e.reduce((e, t) => e.concat(t), [])),
          )
        );
      }
      var te = a(67945),
      ...
      function se(e) {
        const { className: t } = e;
        return i.createElement('div', { className: v()(ie.spinnerWrap, t) }, i.createElement(ne.Loader, null));
      }
      var oe = a(8809);
      function le(e) {
        return i.createElement('div', { className: p(e.className, oe.title) }, e.children);
      }
      a(67869);
      var re = a(18437),
        he = a(60226),
      ...
      class pe extends i.PureComponent {
        ...
        render() {
          const { isActive: e, favorites: t, favoriteFundamentals: a, isLoading: n } = this.state,
            { className: s, displayMode: l, id: r, isFake: h, isAuthenticated: c } = this.props,
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              Boolean(t.length > 0 || (null == a ? void 0 : a.size)) &&
                i.createElement(y.MatchMedia, { rule: 'screen and (max-width: 428px)' }, (e) =>
                  i.createElement(
                    m.ToolWidgetMenu,
                    {
                    ...
                    i.createElement(
                      ...
                      i.createElement(le, { className: e && ce.smallWidthTitle }, (0, o.t)('Favorite Indicators')),
      ...
      var ge = a(1467),
        ...
        Se = a(72017);
      function Ce(e) {
        return i.createElement('div', { className: p(Se.value, { [Se.selected]: e.isSelected }) }, e.value, e.metric);
      }
      var _e = a(76420),
        we = a(88262),
        fe = a(24084),
      ...
      class ke extends i.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this.state = { inputValue: '1', isOpenedMenu: !1, selectedIntervalSuffix: fe.INTERVALS[0].name });
        }
        render() {
            ...
            i.createElement(u.PopupMenuItem, {
              ...
              toolbox: (function () {
                const { isRemovable: t, isFavoritingAllowed: a } = e,
                  ...
                  r = i.createElement(c.FavoriteButton, { key: 'favorite', isActive: n, isFilled: o, onClick: _ });
                return [t && l, !s && a && r];
              })(),
      ...
      const Ae = {
        [be.ResolutionKind.Ticks]: (0, o.t)('Ticks', { context: 'interval_group_name' }),
        [be.ResolutionKind.Seconds]: (0, o.t)('Seconds', { context: 'interval_group_name' }),
        [be.ResolutionKind.Minutes]: (0, o.t)('Minutes', { context: 'interval_group_name' }),
        [be.SpecialResolutionKind.Hours]: (0, o.t)('Hours', { context: 'interval_group_name' }),
        [be.ResolutionKind.Days]: (0, o.t)('Days', { context: 'interval_group_name' }),
        [be.ResolutionKind.Weeks]: (0, o.t)('Weeks', { context: 'interval_group_name' }),
        [be.ResolutionKind.Months]: (0, o.t)('Months', { context: 'interval_group_name' }),
        [be.ResolutionKind.Range]: (0, o.t)('Ranges', { context: 'interval_group_name' }),
      ...
      var Re = a(99055),
        ...
        Le = a(79424),
        De = a(76864);
      const Pe = { openDialog: (0, o.t)('Open Interval Dialog'), timeInterval: (0, o.t)('Time Interval') },
      ...
      class Ke extends i.PureComponent {
        constructor(e, t) {
          ...
          const c = l.linking.interval.value(),
            ...
            p = h.get();
          (this._defaultIntervals = a.defaultResolutions().filter(Ve).map(ge.normalizeIntervalString)),
            (this.state = {
              isOpenedFormMenu: !1,
              activeInterval: d,
              favorites: u,
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(y.MatchMedia, { rule: k.DialogBreakpoints.TabletSmall }, (e) =>
              i.createElement(
                i.Fragment,
                null,
                i.createElement(
                  ...
                  i.createElement(
                    ...
                    i.createElement('div', { className: De.dropdown }, this._renderChildren(d, e)),
                  ),
                ),
                e &&
                  o &&
        ...
        _createMenuItems(e, t) {
          ...
          return (function (e) {
            ...
            return e.filter((e, a, n) => {
              let i = !0;
              return (
                e.type === f.PopupMenuSeparator && ((0 !== a && a !== n.length - 1) || (i = !1), t && (i = !1)),
        ...
        _createIntervalForm(e) {
          if (this._customIntervals) {
            const t = e
              ? i.createElement(
                  'div',
                  { key: 'add-dialog', className: De.addCustomInterval, onClick: this._handleOpenAddIntervalDialog },
            ...
            return [i.createElement(f.PopupMenuSeparator, { key: 'custom-interval-separator' }), t];
          }
          return [];
        }
        _renderResolutionsGroup(e, t = !1, a) {
          ...
          if (t) n.push(...s);
            ...
            const t = i.createElement(
              'div',
              { key: e.id },
              i.createElement('div', { className: De.smallTabletSectionTitle }, e.name),
              s,
            );
            n.push(t);
          } else {
          ...
          return (
            (!e.mayOmitSeparator || e.items.length > 1) &&
              (n.unshift(i.createElement(f.PopupMenuSeparator, { key: 'begin-' + e.name })),
              n.push(i.createElement(f.PopupMenuSeparator, { key: 'end-' + e.name }))),
            n
          );
        }
      ...
      class rt extends i.PureComponent {
        ...
        render() {
          const { strokeDashOffset: e, strokeDash: t, strokeGap: a, strokeDashCheck: n } = this.state,
            { className: s, size: o, onClick: l, state: r, isHovered: h = !1 } = this.props,
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('path', { className: nt.arrowGap, d: 'M11 20h6v5h-6z' }),
              i.createElement(
                'g',
      ...
      const gt = n.enabled('widget'),
        ...
        St = (0, ht.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { shortcut: pt.shortcut }),
        Ct = {
          copy: (0, o.t)('Copy'),
      ...
      class ft extends i.PureComponent {
              ...
              t
                ...
                : i.createElement(
                    ...
                    i.createElement(L, {
                      ...
                      displayMode: a,
                      icon: i.createElement(rt, { size: 28, state: v, isHovered: c }),
                      isDisabled: (o && !l) || n,
        ...
        _renderMenuItems(e) {
          ...
          return (
            ...
            void 0 !== n &&
              (e || y.push(i.createElement(f.PopupMenuSeparator, { key: 'existing-chart-section-begin' })),
              y.push(
                i.createElement(u.PopupMenuItem, {
                  key: 'rename',
                  label: Ct.rename,
            ...
            y.push(i.createElement(f.PopupMenuSeparator, { key: 'platform-section-begin' })),
            y.push(
              i.createElement(u.PopupMenuItem, {
                key: 'load-chart',
      ...
      class kt extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(y.MatchMedia, { rule: k.DialogBreakpoints.TabletSmall }, (e) =>
            i.createElement(ft, { ...u, isTabletSmall: e }),
          );
        }
        _onLoginStateChange() {
      ...
      var Mt = a(84629),
        Et = a(74796),
        Tt = a(61125);
      const xt = new Et.DateTimeFormatter({ dateTimeSeparator: '_', timeFormat: '%h-%m-%s' }),
      ...
      function Gt(e) {
        ...
        return i.createElement(
          ...
          i.createElement(u.PopupMenuItem, {
            ...
            icon: Wt,
            onClick: v,
            shortcut: (0, G.humanReadableHash)(G.Modifiers.Mod + G.Modifiers.Shift + 83),
            theme: Kt,
          }),
          i.createElement(u.PopupMenuItem, {
            'data-name': 'copy-link-to-the-chart-image',
            label: i.createElement(Lt, { isLoading: s }, (0, o.t)('Copy link to the chart image')),
            icon: Ut,
            onClick: () => {
              l(!0), S(!1);
            },
          ...
          i.createElement(u.PopupMenuItem, {
            ...
            label: i.createElement(Lt, { isLoading: r }, (0, o.t)('Open image in new tab')),
            icon: Bt,
            onClick: () => {
              h(!0), S(!0);
            },
          ...
          i.createElement(u.PopupMenuItem, {
            ...
            label: i.createElement(Lt, { isLoading: c }, (0, o.t)('Tweet chart image')),
            icon: Pt,
            onClick: C,
            dontClosePopup: !0,
            isDisabled: c,
      ...
      class sa extends i.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleLogo = (e) => {}),
            (this.state = { symbol: l.linking.symbol.value(), shortName: oa(), logoUrls: [] });
        }
        componentDidMount() {
      ...
      class ra extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { className: p(e, la.item, 'apply-common-tooltip'), onClick: this._handleClick, title: t.name },
            i.createElement('div', { className: la.round }, t.name.length > 0 ? t.name[0].toUpperCase() : ' '),
          );
        }
      }
      var ha = a(33756),
        ca = a(53257);
      function da(e) {
        return i.createElement('div', { className: p(ca.description, e.className) }, e.children);
      }
      var ua = a(11597);
      const ma = (0, ht.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, {
        ...
        va = (0, ht.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { item: ua.item }),
        ga = (0, ht.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { item: ua.itemTabletSmall });
      function ba(e) {
        const {
            item: t,
            onApply: a,
        ...
        return i.createElement(
          'div',
          { ...d, className: ua.wrap, 'data-name': t.name, 'data-id': t.id, 'data-is-default': Boolean(t.is_default) },
          i.createElement(u.PopupMenuItem, {
            theme: g,
            label: t.name,
            ...
            toolbox: i.createElement(
              i.Fragment,
              null,
              !t.is_default && i.createElement(Me.RemoveButton, { key: 'remove', hidden: !Te.touch && !h, onClick: C }),
              Boolean(s) &&
                l &&
                i.createElement(c.FavoriteButton, { key: 'favorite', isFilled: Boolean(o), onClick: _ }),
            ),
          }),
          p &&
            i.createElement(u.PopupMenuItem, {
              theme: b,
              label: i.createElement(da, { className: v()(ua.description, r && ua.descriptionTabletSmall) }, p),
              onClick: S,
              isHovered: h,
            }),
        );
      ...
      const _a = (0, ht.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, Ca),
        wa = { text: (0, ut.appendEllipsis)((0, o.t)('Save Indicator template')) };
      function fa(e) {
      ...
      function Ta(e) {
        ...
        return i.createElement(
          ...
          h &&
            i.createElement(i.Fragment, null, i.createElement(f.PopupMenuSeparator, null), i.createElement(se, null)),
          !h &&
            (r
              ? i.createElement(xa, { defaults: c, customs: d, render: b })
              : i.createElement(Ia, { defaults: c, customs: d, render: b, state: m })),
        );
      }
      function xa(e) {
        ...
        return i.createElement(
          ...
          a.length > 0 &&
            i.createElement(
              ...
              i.createElement(le, { className: Ea.menuItemHeaderTabletSmall }, (0, o.t)('My templates')),
              a.map(n),
            ),
          t.length > 0 &&
            i.createElement(
              ...
              null,
              i.createElement(f.PopupMenuSeparator, null),
              i.createElement(le, { className: Ea.menuItemHeaderTabletSmall }, (0, o.t)('Default templates')),
              t.map(n),
            ),
        );
      }
        ...
        return i.createElement(
          ...
          a.length > 0 &&
            i.createElement(
              ...
              null,
              i.createElement(f.PopupMenuSeparator, null),
              i.createElement(le, { className: Ea.menuItemHeader }, (0, o.t)('My templates')),
              a.map(n),
            ),
          a.length > 0 &&
            t.length > 0 &&
          ...
          0 === a.length &&
            ...
            i.createElement(
              ...
              null,
              i.createElement(f.PopupMenuSeparator, null),
              i.createElement(le, { className: Ea.menuItemHeader }, (0, o.t)('Default templates')),
              t.map(n),
            ),
        );
      }
      ...
      class Ra {
        constructor(e, t) {
          ...
          (this._state = new (Na())({ isLoading: !1, studyTemplatesList: o, favorites: s })),
      ...
      function Pa(e) {
        const {
          ...
          u = v()(a, za.wrap, { [za.full]: 'full' === n, [za.medium]: 'medium' === n }),
          p = o.filter((e) => s.includes(e.name)),
          g = 'small' !== n && c && p.length > 0;
        return i.createElement(
          b,
          { id: t, className: u },
          i.createElement(y.MatchMedia, { rule: k.DialogBreakpoints.TabletSmall }, (t) =>
            i.createElement(
              m.ToolWidgetMenu,
              {
                onOpen: e.onMenuOpen,
        ...
        return i.createElement(
          ...
          e.favorites.map((t, a, n) =>
            i.createElement(ra, {
              ...
              className: v()({ [za.first]: 0 === a, [za.last]: a === n.length - 1 }),
            }),
          ),
        );
      }
      ...
      const Ga = { undoHint: (0, o.t)('Undo {hint}'), redoHint: (0, o.t)('Redo {hint}') },
        ...
        Xa = (0, ht.weakComposeClasses)(Ba, Oa, { buttonUndo: 'button', buttonRedo: 'button' }),
    ...
    65043: (e, t, a) => {
      ...
      var n = a(79881),
        ...
        r = a(23204),
        h = a(69560);
      const c = { add: (0, n.t)('Add to favorites'), remove: (0, n.t)('Remove from favorites') };
      function d(e) {
