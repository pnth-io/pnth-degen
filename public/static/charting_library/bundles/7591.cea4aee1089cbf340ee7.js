(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7591],
  {
    ...
    80511: (e, t, n) => {
      ...
      function u(e) {
        const { size: t, startIcon: n, icon: r, iconOnly: s, children: i, endIcon: l } = e,
          u = null != n ? n : r;
        return o.createElement(
          o.Fragment,
          null,
          u && 'xsmall' !== t && o.createElement(a.Icon, { icon: u, className: c()['start-icon-wrap'] }),
          i && o.createElement('span', { className: c().content }, i),
          l && !s && 'xsmall' !== t && o.createElement(a.Icon, { icon: l, className: c()['end-icon-wrap'] }),
        );
      }
      var m = n(94618),
        d = n(74818);
      function b(e) {
        ...
        return { ...m, ...(0, d.filterDataProps)(e), ...(0, d.filterAriaProps)(e) };
      }
      function E(e) {
        const { reference: t, ...n } = e,
          { isGrouped: r, cellState: s, disablePositionAdjustment: a } = (0, o.useContext)(m.ControlGroupContext),
          i = l({ ...n, isGrouped: r, cellState: s, disablePositionAdjustment: a });
        return o.createElement('button', { ...b(n), className: i, ref: t }, o.createElement(u, { ...n }));
      }
      ...
      function x(e) {
        const { intent: t, size: n, appearance: o, useFullWidth: r, icon: s, ...a } = e;
        return { ...a, color: h(t), size: f(n), variant: p(o), stretch: r, startIcon: s };
      }
      function R(e) {
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handleKeyDown = (e) => {
              ...
              13 === (0, l.hashFromEvent)(e) && o && (e.preventDefault(), n || t());
            });
        }
        render() {
          const {
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  b &&
                    o.createElement(
                      a.Button,
                      { className: p, name: 'cancel', appearance: 'stroke', onClick: this._handleCancel },
                  ...
                  o.createElement(
                    ...
                    o.createElement(
                      a.Button,
                      { className: E, disabled: l, name: 'submit', onClick: u, 'data-name': 'submit-button' },
                      null != i ? i : (0, c.t)('Ok'),
                    ),
                  ),
                ),
