(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6265],
  {
    ...
    84264: (e, t, l) => {
      'use strict';
      l.d(t, { DEFAULT_MENU_ITEM_SWITCHER_THEME: () => h, MenuItemSwitcher: () => u });
      var r = l(67294),
        n = l(94184),
        o = l.n(n),
        s = l(6920),
        a = l.n(s);
      function i(e) {
        const { className: t = '', intent: l = 'default', size: r = 'small', disabled: o } = e;
        return n(t, a().switcherWrapper, a()['size-' + r], !o && a()['intent-' + l]);
      }
      class c extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            ...
            r.createElement('input', { ...o, type: 'checkbox', className: s, ref: e }),
            r.createElement(
              'div',
    ...
    19442: (e, t, l) => {
        ...
        constructor(e) {
          super(e),
            (this._renderFooterLeft = (e) => {
              ...
              if ((0, w.isLineTool)(t)) return n.createElement(S.FooterMenu, { source: t, model: l });
              if ((0, b.isStudy)(t))
                return n.createElement(m.StudyDefaultsManager, { model: l, source: t, mode: e ? 'compact' : 'normal' });
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            return n.createElement(
              n.Fragment,
              null,
              n.createElement(u.DialogTabs, { activeTabId: e, onSelect: this._handleSelect, tabs: l }),
              n.createElement(
                v.TouchScrollContainer,
                { className: E.scrollable, onScroll: this._handleScroll },
                'Component' in s
                  ? n.createElement(s.Component, { source: r, model: o })
                  : n.createElement(C.PropertiesEditorTab, { page: a, tableKey: e }),
              ),
            );
          };
        }
      ...
      class x extends n.PureComponent {
        render() {
          const { input: e, value: t, onChange: l, onBlur: r, onKeyDown: o } = this.props,
            a = e.options.reduce((e, t) => ((e[t] = 'NONE' === t ? (0, s.t)('Default') : t), e), {}),
            i = { ...e, optionsTitles: a };
          return n.createElement(T.SelectInputComponent, { input: i, value: t, onChange: l, onBlur: r, onKeyDown: o });
        }
      }
      const k = (0, _.bind)(x);
      var I = l(13656),
      ...
      class H extends n.PureComponent {
        render() {
          const { input: e } = this.props,
            t = (0, o.ensureNotNull)(this.context),
            l = { ...e, optionsTitles: { fixed: A, cash_per_order: t, percent_of_equity: O } };
          return n.createElement(T.SelectInput, { input: l });
        }
      }
      H.contextType = V;
      ...
      class F extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              L.InputRow,
              { label: (0, s.t)('Order size'), labelAlign: 'adaptive', tooltip: U(e.default_qty_type.tooltip) },
              n.createElement(
                R.InputGroup,
                { className: G.group },
            ...
            n.createElement(
              L.InputRow,
              { label: (0, s.t)('Pyramiding'), tooltip: U(e.pyramiding.tooltip) },
              n.createElement('span', null, n.createElement(f.StudyInput, { input: e.pyramiding })),
              n.createElement(
                'span',
            ...
            n.createElement(
              L.InputRow,
              { label: (0, s.t)('Commission'), labelAlign: 'adaptive', tooltip: U(e.commission_type.tooltip) },
              n.createElement(
                R.InputGroup,
                { className: G.group },
            ...
            n.createElement(
              ...
              n.createElement(
                'span',
                null,
                n.createElement(f.StudyInput, { input: e.backtest_fill_limits_assumption }),
              ),
              n.createElement(
                'span',
                { className: G.descriptionCell },
            ...
            n.createElement(
              ...
              n.createElement('span', null, n.createElement(f.StudyInput, { input: e.slippage })),
              n.createElement(
                'span',
                { className: G.descriptionCell },
                (0, s.t)('ticks', { context: 'slippage ... ticks' }),
            ...
            e.margin_long &&
              ...
              n.createElement(
                ...
                n.createElement(
                  L.InputRow,
                  { label: (0, s.t)('Margin for long positions'), tooltip: U(e.margin_long.tooltip) },
                  n.createElement('span', null, n.createElement(f.StudyInput, { input: e.margin_long })),
                  n.createElement('span', { className: G.descriptionCell }, '%'),
                ),
                n.createElement(
                  L.InputRow,
                  { label: (0, s.t)('Margin for short positions'), tooltip: U(e.margin_short.tooltip) },
                  n.createElement('span', null, n.createElement(f.StudyInput, { input: e.margin_short })),
                  n.createElement('span', { className: G.descriptionCell }, '%'),
                ),
                n.createElement(M.PropertyTable.Separator, null),
              ),
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  'div',
                  { className: G.recalculateCheckbox },
                  n.createElement(I.BoolInput, { label: (0, s.t)('On every tick'), input: e.calc_on_every_tick }),
                  e.calc_on_every_tick.tooltip &&
                    n.createElement(D.InputTooltip, {
                      className: G.checkboxTooltip,
                      title: (0, o.ensureDefined)(U(e.calc_on_every_tick.tooltip)),
                    }),
                ),
              ),
            ),
      ...
      var q = l(98824),
        K = l(65447);
      const j = (0, K.getLogger)('Platform.GUI.PropertyDialog.Indicators.StrategyPage');
      class J extends n.PureComponent {
        constructor(e) {
          ...
          (this._inputs = r.getStrategyProperties()), (this.state = { currency: this._getCurrency() });
        }
        componentDidMount() {
        ...
        _getCurrency() {
          ...
          if (null === t || void 0 === t.currency) {
            ...
            return (null == r ? void 0 : r.original_currency_code) || (null == r ? void 0 : r.currency_code) || null;
          }
          return t.currency;
        }
      }
      ...
      class X extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._inputs = new q.MetaInfoHelper(this.props.source.metaInfo()).getUserEditableInputs());
        }
        render() {
      ...
      var Y = l(41615),
        ...
        le = l(91967),
        re = l(37763);
      const ne = new a.TranslatedString('change visibility', (0, s.t)('change visibility'));
      ...
      var se = l(10869),
        ...
        be = l(89447);
      const Ce = {
          [$.LineStudyPlotStyle.Line]: { type: $.LineStudyPlotStyle.Line, order: 0, icon: ce, label: (0, s.t)('Line') },
          ...
          [$.LineStudyPlotStyle.Area]: { type: $.LineStudyPlotStyle.Area, order: 6, icon: ye, label: (0, s.t)('Area') },
        ...
        we = Object.values(Ce)
          ...
          .map((e) => ({
            ...
            content: n.createElement(ie.DropItem, { icon: e.icon, label: e.label }),
          })),
        Se = (0, s.t)('Price line');
      ...
      var Pe = l(78736),
        fe = l(28687);
      const _e = new a.TranslatedString('change plot type', (0, s.t)('change plot type')),
        Te = new a.TranslatedString('change price line visibility', (0, s.t)('change price line visibility'));
            ...
            !s &&
              n.createElement(
                ...
                n.createElement(
                  ...
                  i
                    ? n.createElement('div', null, t ? t.title : a.title.value())
                    : n.createElement(oe, { id: d, title: t ? t.title : a.title.value(), visible: a.visible }),
                ),
              ),
      ...
      var Ie = l(98687);
      const Le = new a.TranslatedString('change plot type', (0, s.t)('change plot type')),
        Re = new a.TranslatedString('change price line visibility', (0, s.t)('change price line visibility'));
      class Ne extends n.PureComponent {
        ...
        render() {
          const {
            ...
            isRGB: t,
            isFundamental: l,
            property: { title: r, color: o, plottype: s, linewidth: a, transparency: i, trackPrice: c, visible: p },
          } = this.props;
          return n.createElement(
            L.InputRow,
            { label: n.createElement(oe, { id: e, title: r.value(), visible: p }) },
            t && !l
      ...
      class De extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            L.InputRow,
            { label: c ? n.createElement(oe, { id: e, title: l, visible: r }) : l, offset: p, grouped: d },
            t
              ? null
              : n.createElement(Pe.ColorWithThicknessSelect, {
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(oe, { id: e, title: pt((0, o.ensureNotNull)(i), e), visible: a }),
                ),
              ),
              !t &&
                n.createElement(
      ...
      var Be = l(68277),
        ...
        He = l(64417);
      const Ge = {
          [He.MarkLocation.AboveBar]: { value: He.MarkLocation.AboveBar, content: (0, s.t)('Above bar'), order: 0 },
          [He.MarkLocation.BelowBar]: { value: He.MarkLocation.BelowBar, content: (0, s.t)('Below bar'), order: 1 },
          [He.MarkLocation.Top]: { value: He.MarkLocation.Top, content: (0, s.t)('Top'), order: 2 },
          [He.MarkLocation.Bottom]: { value: He.MarkLocation.Bottom, content: (0, s.t)('Bottom'), order: 3 },
          [He.MarkLocation.Absolute]: { value: He.MarkLocation.Absolute, content: (0, s.t)('Absolute'), order: 4 },
        },
      ...
      const Ze = new a.TranslatedString('change char', (0, s.t)('change char')),
        qe = new a.TranslatedString('change location', (0, s.t)('change location'));
      class Ke extends n.PureComponent {
        constructor() {
          super(...arguments),
        ...
        render() {
          const {
            id: e,
            isRGB: t,
            property: { title: l, color: r, transparency: o, char: s, location: a, visible: i },
            hasPalette: c,
          } = this.props;
          return n.createElement(
            L.InputRow,
            { grouped: c, label: n.createElement(oe, { id: e, title: l.value(), visible: i }) },
            !c &&
              !t &&
              n.createElement(Pe.ColorWithThicknessSelect, { disabled: !i.value(), color: r, transparency: o }),
      ...
      Object.keys(je.plotShapesData).forEach((e) => {
        ...
        Xe.push({
          id: t.id,
          value: t.id,
          selectedContent: n.createElement(ie.DisplayItem, { icon: Qe(t.icon) }),
          content: n.createElement(ie.DropItem, { icon: Qe(t.icon), label: t.guiName }),
        });
      });
      ...
      const $e = new a.TranslatedString('change shape', (0, s.t)('change shape')),
        et = new a.TranslatedString('change location', (0, s.t)('change location'));
      class tt extends n.PureComponent {
        ...
        render() {
          const {
            ...
            isRGB: t,
            hasPalette: l,
            property: { title: r, color: o, transparency: s, plottype: a, location: i, visible: c },
          } = this.props;
          return n.createElement(
            L.InputRow,
            { grouped: l, label: n.createElement(oe, { id: e, title: r.value(), visible: c }) },
            !l &&
              !t &&
              n.createElement(Pe.ColorWithThicknessSelect, { disabled: !c.value(), color: o, transparency: s }),
            n.createElement(Ye, {
              id: (0, Y.createDomId)(e, 'shape-style-select'),
              disabled: !c.value(),
              className: fe.smallStyleControl,
        ...
        render() {
          ...
          if ('line' === s || 'bar_colorer' === s || 'bg_colorer' === s)
            return a && a.palette && a.paletteProps
              ? n.createElement(ke, { plot: e, palette: a.palette, paletteProps: a.paletteProps, styleProp: o })
              : n.createElement(Ne, { id: r, property: o, isRGB: i, isFundamental: !1, showLineWidth: 'line' === s });
          if ('arrows' === s) {
            ...
            return a || c
              ? n.createElement(
                  ...
                  a && a.palette && a.paletteProps
                    ? n.createElement(ke, {
                        ...
                        styleProp: { ...o, title: (0, lt.createPrimitiveProperty)(nt) },
                        showSeparator: !1,
                        showOnlyTitle: !0,
                        offset: !0,
                      })
                  ...
                  c && c.palette && c.paletteProps
                    ? n.createElement(ke, {
                        ...
                        styleProp: { ...o, title: (0, lt.createPrimitiveProperty)(ot) },
                        showSeparator: !1,
                        showOnlyTitle: !0,
                        offset: !0,
                      })
              ...
              : n.createElement(Ve, { id: r, property: o, isRGB: i, plot: e, palettes: t, styleProp: o });
          }
          if ('chars' === s || 'shapes' === s)
            return n.createElement(
              n.Fragment,
              null,
              'chars' === s
                ? n.createElement(Ke, { id: r, property: o, hasPalette: Boolean(a && a.palette), isRGB: i })
                : n.createElement(tt, { id: r, property: o, hasPalette: Boolean(a && a.palette), isRGB: i }),
              a &&
                a.palette &&
                a.paletteProps &&
                n.createElement(ke, {
            ...
            return n.createElement(
              ...
              a && a.palette && a.paletteProps
                ? n.createElement(ke, {
                    ...
                    palette: a.palette,
                    paletteProps: a.paletteProps,
                    styleProp: { ...s, title: (0, lt.createPrimitiveProperty)(st) },
                    showSeparator: !1,
                    showOnlyTitle: !0,
                    offset: !0,
                  })
              ...
              t.wick &&
                ...
                n.createElement(ke, {
                  ...
                  styleProp: { ...s, title: (0, lt.createPrimitiveProperty)(at) },
                  showSeparator: !1,
                  showOnlyTitle: !0,
                  offset: !0,
                }),
              ...
              t.border &&
                ...
                n.createElement(ke, {
                  ...
                  styleProp: { ...s, title: (0, lt.createPrimitiveProperty)(it) },
                  showSeparator: !1,
                  showOnlyTitle: !0,
                  offset: !0,
                }),
      ...
      var dt = l(93425),
        ht = l(13278);
      const ut = new a.TranslatedString('change line style', (0, s.t)('change line style'));
      ...
      const yt = new a.TranslatedString('change value', (0, s.t)('change value'));
      class gt extends n.PureComponent {
        ...
        render() {
          const {
            id: e,
            property: { name: t, color: l, linestyle: r, linewidth: o, transparency: s, value: a, visible: i },
          } = this.props;
          return n.createElement(
            L.InputRow,
            { labelAlign: 'adaptive', label: n.createElement(oe, { id: e, title: t.value(), visible: i }) },
            n.createElement(
              'div',
              { className: fe.block },
              n.createElement(
              ...
              n.createElement(
                'div',
                { className: We(fe.wrapGroup, fe.defaultSelect, fe.additionalSelect) },
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                M.PropertyTable.Cell,
                { placement: 'first', colSpan: 2 },
                n.createElement(oe, { id: 'chart-orders-switch', title: (0, s.t)('Trades on chart'), visible: e }),
              ),
            ),
            n.createElement(
              M.PropertyTable.Row,
              ...
              n.createElement(
                M.PropertyTable.Cell,
                { placement: 'first', colSpan: 2 },
                n.createElement(oe, { id: 'chart-orders-labels-switch', title: (0, s.t)('Signal labels'), visible: t }),
              ),
            ),
            n.createElement(
              M.PropertyTable.Row,
              ...
              n.createElement(
                M.PropertyTable.Cell,
                { placement: 'first', colSpan: 2 },
                n.createElement(oe, { id: 'chart-orders-qty-switch', title: (0, s.t)('Quantity'), visible: l }),
              ),
            ),
          );
        }
      ...
      var bt = l(31505),
        Ct = l(82823);
      const wt = new a.TranslatedString('change percent width', (0, s.t)('change percent width')),
        St = new a.TranslatedString('change placement', (0, s.t)('change placement')),
        Et = new a.TranslatedString('change values visibility', (0, s.t)('change values visibility')),
        Pt = [
      ...
      class kt extends n.PureComponent {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                M.PropertyTable.Cell,
                { placement: 'first', colSpan: 2, grouped: !0 },
                n.createElement(oe, { id: e.value(), title: e.value(), visible: s }),
              ),
            ),
            n.createElement(
              L.InputRow,
              { label: n.createElement('div', { className: fe.childRowContainer }, ft), grouped: !0 },
            ...
            n.createElement(
              L.InputRow,
              { label: n.createElement('div', { className: fe.childRowContainer }, _t), grouped: !0 },
            ...
            n.createElement(
              ...
              n.createElement(
                M.PropertyTable.Cell,
                { className: fe.childRowContainer, placement: 'first', colSpan: 2, grouped: !0 },
            ...
            n.createElement(
              L.InputRow,
              { label: n.createElement('div', { className: fe.childRowContainer }, xt), grouped: !0 },
              n.createElement(Pe.ColorWithThicknessSelect, { disabled: s && !s.value(), color: o }),
            ),
            this._renderColors(),
            n.createElement(M.PropertyTable.GroupSeparator, null),
          );
        ...
        _renderColors() {
          const { colors: e, titles: t, transparencies: l, visible: r } = this.props.property.childs();
          return e
            .childNames()
            .map((o) =>
              n.createElement(
                L.InputRow,
                {
                  key: o,
                  grouped: !0,
                  label: n.createElement('div', { className: fe.childRowContainer }, t.childs()[o].value()),
                },
                n.createElement(Pe.ColorWithThicknessSelect, {
                  disabled: !r.value(),
                  color: e.childs()[o],
      ...
      class It extends n.PureComponent {
        render() {
          const { title: e } = this.props,
            { color: t, transparency: l, width: r, style: o, visible: s } = this.props.property.childs();
          return n.createElement(
            L.InputRow,
            { label: n.createElement(oe, { id: e.value(), title: e.value(), visible: s }) },
            n.createElement(Pe.ColorWithThicknessSelect, {
              disabled: !s.value(),
              color: t,
              transparency: l,
        ...
        render() {
          ...
          return Object.keys(s).map((t, l) => {
            ...
            return 'horizlines' === e || 'vertlines' === e || 'lines' === e
              ? n.createElement(It, { key: t, title: 'lines' === e ? o.title : o.name, property: o })
              : 'hhists' === e
      ...
      var Rt = l(3220);
      const Nt = new a.TranslatedString('change font size', (0, s.t)('change font size')),
        Mt = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map((e) => ({ value: e, title: e.toString() }));
      ...
      const Vt = new a.TranslatedString('change visibility', (0, s.t)('change visibility')),
      ...
      class At extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              L.InputRow,
              { labelAlign: 'adaptive', label: n.createElement('span', null, Bt) },
              n.createElement(
                'div',
                { className: fe.block },
                n.createElement(
      ...
      const Ot = new a.TranslatedString('change visibility', (0, s.t)('change visibility')),
      ...
      class Jt extends n.PureComponent {
        ...
        render() {
          ...
          const { metaInfo: l } = this.props,
            { graphics: r, styles: a, showLabelsOnPriceScale: i, showLegendValues: c } = this.props.property.childs(),
            ...
            S = d.childs().pocLines,
            E = (0, o.ensureDefined)(null === (e = l.graphics.horizlines) || void 0 === e ? void 0 : e.pocLines),
            P = a.childs().developingPoc,
            f = (0, o.ensureDefined)(null === (t = l.styles) || void 0 === t ? void 0 : t.developingPoc),
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                M.PropertyTable.Cell,
                { placement: 'last' },
                n.createElement(Pe.ColorWithThicknessSelect, { disabled: !g.value() || !v[0].value(), color: w }),
              ),
            ),
            n.createElement(
              M.PropertyTable.Row,
                  ...
                  .map((t, l) => {
                    ...
                    return n.createElement(
                      ...
                      n.createElement(Pe.ColorWithThicknessSelect, {
                        ...
                        transparency: p.childs()[e].childs().transparencies.childs()[l],
                      }),
                    );
                  }),
              ),
            ...
            _ &&
              ...
              n.createElement(
                ...
                n.createElement(mt, {
                  ...
                  disabled: !_.childs().visible.value() && !T.childs().visible.value(),
                  className: fe.smallStyleControl,
            ...
            h &&
              n.createElement(
                L.InputRow,
                { label: n.createElement('div', null, (x && (0, s.t)(x.name)) || '') },
                n.createElement(Pe.ColorWithThicknessSelect, {
            ...
            'VbPFixed' !== l.shortId &&
              n.createElement(
                ...
                n.createElement(
                  M.PropertyTable.Cell,
                  { placement: 'first', colSpan: 2 },
                  n.createElement(oe, { id: 'showLabelsOnPriceScale', title: Kt, visible: i }),
                ),
                n.createElement(
                  M.PropertyTable.Cell,
                  { placement: 'first', colSpan: 2 },
                  n.createElement(oe, { id: 'showLegendValues', title: qt, visible: c }),
                ),
              ),
          );
        }
      ...
      var el = l(12642);
      const tl = new a.TranslatedString('change precision', (0, s.t)('change precision')),
        ll = (0, s.t)('Default'),
        rl = (0, s.t)('Precision'),
      ...
      const sl = new a.TranslatedString('change min tick', (0, s.t)('change min tick')),
        al = (0, s.t)('Default'),
      ...
      class yl extends n.PureComponent {
          ...
          super(...arguments),
            (this._findPlotPalettes = (e) => {
              ...
              return (0, $.isBarColorerPlot)(e) || (0, $.isBgColorerPlot)(e)
                ? { main: { palette: r[e.palette], paletteProps: t.properties().palettes[e.palette] } }
        ...
        render() {
          const { study: e } = this.props,
            t = e.metaInfo();
          if ((0, el.isCustomStudy)(t.shortId)) return n.createElement($t, null);
          const l = e.properties(),
            { precision: r, strategy: o, minTick: s, showLabelsOnPriceScale: a, showLegendValues: i } = l,
            c = t.plots.length > 0,
          ...
          return n.createElement(
            ...
            h && n.createElement(dl, { id: (0, Y.createDomId)(t.id, 'min-tick-select'), minTick: s }),
            te().isScriptStrategy(t) && n.createElement(vt, { orders: o.orders }),
            (d || p) &&
              n.createElement(
                M.PropertyTable.Row,
                null,
                ...
                d && n.createElement(ol, { id: (0, Y.createDomId)(t.id, 'precision-select'), precision: r }),
                p &&
                  n.createElement(
                    n.Fragment,
                    null,
                    n.createElement(
                      M.PropertyTable.Cell,
                      { placement: 'first', colSpan: 2 },
                      n.createElement(oe, { id: 'showLabelsOnPriceScale', title: 'Labels on price scale', visible: a }),
                    ),
                    n.createElement(
                      M.PropertyTable.Cell,
                      { placement: 'first', colSpan: 2 },
                      n.createElement(oe, { id: 'showLegendValues', title: 'Values in status line', visible: i }),
                    ),
                  ),
              ),
          );
        ...
        _plotsElement() {
          ...
          return new q.MetaInfoHelper(t)
            ...
            .map((t) => {
              ...
              return n.createElement(ct, { key: t.id, plot: t, palettes: r, study: e });
            });
        }
        _bandsElement() {
          const { study: e } = this.props,
          ...
          return (
            ...
            l.childNames().map((e, t) => {
              ...
              if (!r.isHidden || !r.isHidden.value())
                return n.createElement(gt, { key: t, id: r.name.value(), property: r });
            })
          );
        }
        ...
        _findPalettesByTargetId(e) {
          ...
          for (const l of r)
            ((0, $.isColorerPlot)(l) || (0, $.isOhlcColorerPlot)(l)) &&
              l.target === e &&
              (s.main = { palette: n[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, $.isUpColorerPlot)(l) &&
                l.target === e &&
                (s.up = { palette: n[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, $.isDownColorerPlot)(l) &&
                l.target === e &&
                (s.down = { palette: n[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, $.isCandleWickColorerPlot)(l) &&
                l.target === e &&
                (s.wick = { palette: n[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, $.isCandleBorderColorerPlot)(l) &&
                l.target === e &&
                (s.border = { palette: n[l.palette], paletteProps: t.properties().palettes[l.palette] });
          return s;
        }
      }
      function gl(e) {
        return (0, le.bindPropertyContext)(yl, { ...e, property: e.study.properties() });
      }
      ...
      class Sl extends Cl.DialogRenderer {
        ...
        show(e = {}) {
          ...
          o.hasUserEditableInputs() && l.allIds.push('inputs'),
            ...
            this._propertyPages ||
              ((l.byId.visibilities = { title: (0, s.t)('Visibility'), page: this._createVisibilitiesPropertyPage() }),
              l.allIds.push('visibilities')),
            (l = this._getPagesForStudyLineTool(l));
          const a = e.initialTab || c.getValue(this._activeTabSettingsName()) || 'inputs';
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, bl.createPropertyPage)(
            (0, wl.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._model,
              e,
              new a.TranslatedString(this._source.name(!0), this._source.title(!0)),
            ),
            'visibility',
            (0, s.t)('Visibility'),
          );
        ...
        _getPagesForStudyLineTool(e) {
          if (this._propertyPages) {
            ...
            return { allIds: [...e.allIds, ...l.allIds], byId: { ...e.byId, ...l.byId } };
          }
          return e;
        }
