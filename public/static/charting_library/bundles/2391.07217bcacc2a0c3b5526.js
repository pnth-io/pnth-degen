(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2391],
  {
    ...
    5862: (e, t, n) => {
      'use strict';
      n.d(t, { useKeyboardToggle: () => r, useKeyboardClose: () => i, useKeyboardOpen: () => s });
      var l = n(67294),
        o = n(42998);
      function r(e) {
    ...
    98981: (e, t, n) => {
      ...
      function f(e) {
        const { isDropped: t } = e;
        return l.createElement(u.Icon, { className: r()(h.icon, t && h.dropped), icon: d });
      }
      function p(e) {
      ...
      const v = l.forwardRef((e, t) => {
        const {
          ...
          I = !h && l.createElement(c.EndSlot, null, l.createElement(p, { isDropped: g, disabled: v, className: R }));
        return l.createElement(
          l.Fragment,
          null,
          l.createElement(a.ControlSkeleton, {
            ...
            middleSlot: l.createElement(
              c.MiddleSlot,
              null,
              l.createElement('span', { className: r()(m['button-children'], h && m.hiddenArrow) }, N),
            ),
            endSlot: I,
          }),
          l.createElement(
    ...
    22904: (e, t, n) => {
      ...
      var l = n(67294),
        ...
        s = n(15738);
      function a(e) {
        const { disabled: t, intent: n, highlight: a, onFocus: c, onBlur: u, onClick: d } = e,
          [h, f] = (0, l.useState)(!1),
          [p, b] = (0, r.useFocus)(),
          m = p || h,
          v = null != a ? a : m,
          ...
          C = (0, l.useRef)(null),
          S = (0, l.useCallback)(() => (0, o.ensureNotNull)(C.current).focus(), [C]),
          w = (0, l.useRef)(null),
          y = (0, l.useCallback)(() => (0, o.ensureNotNull)(w.current).focus(), [w]),
    ...
    45221: (e, t, n) => {
      ...
      function u(e, t, n, l, o, r) {
        ...
        if (
          (function (e, t, n) {
            const l = a[e];
            return t[l.start] < n[l.start] - n[l.size] / 2 || t[l.end] > n[l.end] + n[l.size] / 2;
          })(e, l, o)
        )
          c = s.middle;
        else {
          const t = (function (e) {
            ...
            (function (e, t, n) {
              ...
              return { start: t[l.start] - n[l.start], middle: o - r, end: t[l.end] - n[l.end] };
            })(e, l, o),
          );
        ...
        return (function (e) {
          ...
          (c = null != c ? c : r.getBoundingClientRect()), (u = null != u ? u : s.getBoundingClientRect());
          ...
          return (
            (b = window.requestAnimationFrame(function e(t) {
              let r;
              if ((p ? (r = t - p) : ((r = 0), (p = t)), r >= n)) return (s[h] = f + d), void (o && o());
              const i = f + d * l(r / n);
        ...
        })({ ...r, target: t, targetRect: l, wrap: n, wrapRect: o, additionalScroll: c, direction: e });
      }
      class d {
        constructor(e = null) {
        ...
        scrollTo(e, t = s) {
          if (
            ...
            !(function (e, t) {
              ...
              return n.top >= l.top && n.bottom <= l.bottom && n.left >= l.left && n.right <= l.right;
            })(e, this._container)
          ) {
            const n = e.getBoundingClientRect(),
      ...
      const _ = l.forwardRef((e, t) => {
        ...
        let { items: I } = e;
        if (E && x) {
          I = [{ value: void 0, content: E, id: (0, r.createDomId)(n, 'placeholder') }, ...I];
        }
        const {
            isOpened: W,
            isFocused: K,
          ...
          Y = (function (e) {
            ...
            return (
              (0, l.useEffect)(() => ((t.current = new d(e)), () => (0, o.ensureNotNull)(t.current).destroy()), []), t
            );
          })(),
          G = (0, l.useRef)(null),
        ...
        const Z = (0, r.joinDomIds)(M, n),
          ...
          te = (0, l.useMemo)(
            () => ({ role: 'listbox', 'aria-labelledby': M, 'aria-activedescendant': y(n, X) }),
            [M, X],
          ),
          ne = (function (e, t, n) {
        ...
        return l.createElement(
          m.DisclosureMenuView,
          {
            ...
            buttonChildren: l.createElement(k, { selectedItem: X, placeholder: E }),
          },
          I.map((e, t) => {
            var o;
    ...
    73991: (e, t, n) => {
            ...
            (e) => {
              t && (t.current = e),
                i.CheckMobile.iOS() &&
                  ...
                  (s.current = e),
                  null !== s.current && (0, o.disableBodyScroll)(s.current, { allowTouchMove: a(s) }));
            },
            [t],
          );
      ...
      function a(e) {
        return (t) => {
          ...
          return !n.contains(t) || (null !== l && n.contains(l) && l.contains(t));
        };
      }
    },
    20914: (e) => {
