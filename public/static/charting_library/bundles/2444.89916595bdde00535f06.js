    ...
    52444: (t, e, s) => {
      ...
      function v(t) {
        return i.createElement(
          ...
          i.createElement('div', { className: d.iconWrap }, i.createElement(l.Icon, { icon: u, className: d.icon })),
        );
      }
      const R = (function (t = b, e = m, s = f, l = w) {
        ...
        return (
          ((u = class extends i.PureComponent {
            ...
            isAtLeft() {
              return (
                !this._isOverflowed() || this.currentPosition() <= (0, n.ensureDefined)(this.props.hideButtonsFrom)
              );
            }
            isAtRight() {
              return (
