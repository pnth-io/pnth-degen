(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7078],
  {
    ...
    45745: (e, t, i) => {
      'use strict';
      i.d(t, { DialogSidebarContainer: () => m, DialogSidebarWrapper: () => h, DialogSidebarItem: () => d });
      var n = i(67294),
        l = i(94184),
        a = i.n(l),
        o = i(49775),
      ...
      function m(e) {
        ...
        return n.createElement('div', { ...l, className: m, 'data-role': 'dialog-sidebar' });
      }
      function h(e) {
      ...
      function d(e) {
        ...
        return n.createElement(
          'div',
          { ...d, className: a()(r.tab, u && r.isTablet, p && r.isMobile, m && r.active), onClick: h },
    ...
    76270: (e, t, i) => {
      ...
      function M(e) {
        const { themeName: t, chartWidgetCollection: i, onRemove: n, manager: a } = e,
          ...
          c = l.useCallback(() => {
            (0, _.loadTheme)(t, !1, !1, i).then(() => {
              i.readOnly() || window.saver.saveChartSilently(), (0, f.trackEvent)('GUI', 'Switch to custom theme');
            });
          }, [t, i]);
        return l.createElement(
          ...
          l.createElement(T.PopupMenuItem, {
            ...
            label: t,
            onClick: c,
            toolbox: l.createElement(A.RemoveButton, { hidden: !w.mobiletouch && !o, onClick: r }),
          }),
        );
      }
      var B = i(22775);
      const D = (0, n.t)('Template'),
        ...
        I = ((0, k.appendEllipsis)((0, n.t)('Save as')), (0, n.t)('Apply to all'));
      class N extends l.PureComponent {
        ...
        render() {
          return l.createElement(
            ...
            (e) => (
              (this._manager = e),
              l.createElement(u.MatchMedia, { rule: 'screen and (max-width: 768px)' }, (e) =>
                l.createElement(
                  g.DisclosureMenu,
                  {
        ...
        _getPlaceHolderItem(e) {
          return e ? l.createElement(b.Icon, { className: E.themesButtonIcon, icon: B }) : D;
        }
        _getThemeItems(e) {
          ...
          return l.createElement(
            ...
            e &&
              t &&
              l.createElement(T.PopupMenuItem, { className: E.defaultsButtonItem, isActive: !1, label: I, onClick: n }),
            l.createElement(T.PopupMenuItem, {
              className: E.defaultsButtonItem,
              isActive: !1,
              label: x,
      ...
      var q = i(97326),
        Z = i(38002);
      function U(e) {
        return l.createElement(b.Icon, { className: q.backButton, icon: Z, onClick: e.onClick });
      }
      var G = i(91263);
      class H extends l.PureComponent {
        constructor(e) {
          super(e),
            (this._renderChildren = ({ requestResize: e, isSmallWidth: t }) => (
              ...
              l.createElement('div', { className: G.content }, this._renderTabs(t), this._renderTabContent(t))
            )),
            (this._renderApplyToAllButton = () =>
              l.createElement(u.MatchMedia, { rule: L.DialogBreakpoints.TabletNormal }, (e) =>
        ...
        render() {
          ...
          return l.createElement(u.MatchMedia, { rule: L.DialogBreakpoints.TabletSmall }, (a) =>
            l.createElement(r.AdaptiveConfirmDialog, {
              ...
              additionalHeaderElement:
                null !== i && a ? l.createElement(U, { onClick: this._handleBackClick }) : void 0,
            ...
            return l.createElement(
              ...
              l.createElement(
                ...
                l.createElement(
                  ...
                  n.map((e) => l.createElement(s.Section, { key: e.id, definition: e })),
                ),
              ),
            );
          }
        ...
        _renderTabs(e) {
          ...
          return l.createElement(u.MatchMedia, { rule: L.DialogBreakpoints.TabletNormal }, (e) =>
            l.createElement(u.MatchMedia, { rule: L.DialogBreakpoints.TabletSmall }, (i) => {
      ...
      class J extends K.DialogRenderer {
        constructor(e) {
          super(),
            (this._handleClose = () => {
              a.unmountComponentAtNode(this._container), this._setVisibility(!1), this._onClose && this._onClose();
            }),
            (this._handleSubmit = () => {}),
            (this._handleCancel = () => {
        ...
        show() {
          a.render(
            ...
            F.emit('edit_object_dialog', { objectType: 'mainSeries', scriptTitle: this._model.mainSeries().title() });
        }
        _ensureCheckpoint(e) {
