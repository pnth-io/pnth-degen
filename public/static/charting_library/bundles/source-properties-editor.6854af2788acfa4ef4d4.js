  ...
  [6780],
  {
            ...
            (this._renderFooterLeft = () => {
              ...
              return (0, g.isLineTool)(e)
                ...
                : s.createElement(
                    ...
                    (i) =>
                      (0, b.isStudy)(e) &&
                      s.createElement(m.StudyDefaultsManager, { model: t, source: e, mode: i ? 'compact' : 'normal' }),
                  );
            }),
            (this._subscribe = (e) => {
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            return s.createElement(
              s.Fragment,
              null,
              s.createElement(u.DialogTabs, { activeTabId: e, onSelect: this._handleSelectPage, tabs: o }),
              s.createElement(
    ...
    88114: (e, t, i) => {
      ...
      const g = (0, n.t)('Apply Defaults'),
        ...
        b = { allIds: ['visibility'], byId: { visibility: { title: (0, n.t)('Visibility') } } };
      function C(e) {
        return s.createElement(
          s.Fragment,
          null,
          s.createElement(c.DialogTabs, { activeTabId: 'visibility', tabs: b, onSelect: l }),
          s.createElement(
            h.TouchScrollContainer,
            null,
            s.createElement(p.PropertiesEditorTab, { page: e.page, tableKey: 'visibility' }),
          ),
        );
      }
      function P(e) {
        const { propertyPage: t, onSubmit: i, onCancel: o, onClose: n, onApplyDefaults: r } = e;
        return s.createElement(d.AdaptiveConfirmDialog, {
          ...
          footerLeftRenderer: function () {
            return s.createElement(u.FooterMenu, null, s.createElement(_.TemplateMenuItem, { onClick: r, name: g }));
          },
          render: function () {
