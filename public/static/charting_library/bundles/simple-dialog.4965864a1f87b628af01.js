(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8890],
  {
    ...
    80511: (e, t, n) => {
      ...
      function u(e) {
        const { size: t, startIcon: n, icon: r, iconOnly: a, children: i, endIcon: c } = e,
          u = null != n ? n : r;
        return o.createElement(
          o.Fragment,
          null,
          u && 'xsmall' !== t && o.createElement(l.Icon, { icon: u, className: s()['start-icon-wrap'] }),
          i && o.createElement('span', { className: s().content }, i),
          c && !a && 'xsmall' !== t && o.createElement(l.Icon, { icon: c, className: s()['end-icon-wrap'] }),
        );
      }
      var d = n(94618),
        m = n(74818);
      ...
      function p(e) {
        const { reference: t, ...n } = e,
          { isGrouped: r, cellState: a, disablePositionAdjustment: l } = (0, o.useContext)(d.ControlGroupContext),
          i = c({ ...n, isGrouped: r, cellState: a, disablePositionAdjustment: l });
      ...
      function E(e) {
        const { intent: t, size: n, appearance: o, useFullWidth: r, icon: a, ...l } = e;
        return { ...l, color: g(t), size: v(n), variant: f(o), stretch: r, startIcon: a };
      }
      function b(e) {
      ...
      class c extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            'span',
            { className: a(s().loader, n && s().static, e, this._getStateClass()) },
    ...
    68442: (e, t, n) => {
      'use strict';
      n.r(t),
        n.d(t, { confirmModule: () => F, renameModule: () => M, showSimpleDialog: () => P, warningModule: () => A });
      var o = n(67294),
        r = n(79881),
        a = n(94184),
        l = n(49775),
        ...
        v = n(37861),
        E = n(78106);
      const b = o.createContext({ isSmallTablet: !1, dialogCloseHandler: () => {} });
      var w = n(39451);
      function x(e) {
        const { disabled: t, name: n, title: r, appearance: l, intent: i, handler: s, reference: c } = e,
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement('div', { className: a(C.title, i && C.small) }, t),
                  (function (t) {
                    if ('html' in e)
                  ...
                  r &&
                    ...
                    o.createElement(
                      ...
                      r.map((e, t) => o.createElement(x, { ...e, key: e.name, reference: 0 === t ? S : void 0 })),
                    ),
                ),
      ...
      var _ = n(81829),
        k = n(59028);
      function R(e) {
        const { maxLength: t, value: n, placeholder: r, onValueChange: a, nameInputRef: l } = e,
        ...
        return (
          ...
          o.createElement(
            ...
            null,
            (function () {
              if ('content' in e) return o.createElement('div', { className: k.label }, e.content);
              if ('html' in e)
                return o.createElement('div', { className: k.label, dangerouslySetInnerHTML: { __html: e.html } });
              return null;
            })(),
      ...
      const F = function (e) {
          ...
          return o.createElement(S, {
            ...
            onClose: n,
            actions: [
              { name: 'yes', title: a || (0, r.t)('Yes'), intent: l || 'success', handler: c },
              {
                name: 'no',
                title: i || (0, r.t)('No'),
                appearance: 'stroke',
            ...
            actions: [
              {
                ...
                handler: ({ dialogClose: e, innerManager: t }) =>
                  m({ newValue: p, focusInput: b, dialogClose: e, innerManager: t }),
              },
              {
                name: 'cancel',
        ...
        P = function (e, t, n) {
          ...
          if (D.isOpened(a)) return (0, g.ensureDefined)(D.getDialogPayload(a)).closeHandler;
          const l = document.createElement('div'),
            i = () => {
              var t;
              null === (t = e.onClose) || void 0 === t || t.call(e), L.unmountComponentAtNode(l), D.setAsClosed(a);
            };
          return (
            L.render(
              o.createElement(E.SlotContext.Provider, { value: n || null }, o.createElement(t, { ...e, onClose: i })),
              l,
            ),
