  ...
  [2878],
  {
    ...
    23788: (e, t, o) => {
      ...
      const k = [
        ...
        },
        {
          ...
          items: [
            ...
            (0, C.isFeatureEnabled)('remove-line-tool-ghost-feed') ? null : { name: 'LineToolGhostFeed' },
      ...
      class A extends i.PureComponent {
        ...
        render() {
          const {
            ...
            { heightContent: l, heightWrap: c, isVisibleBotButton: h, isVisibleTopButton: d } = this.state;
          return i.createElement(
            ...
            i.createElement(
              ...
              o && i.createElement('div', { className: r()(D.fadeTop, { [D.isVisible]: d && l > c }) }),
              o && i.createElement('div', { className: r()(D.fadeBot, { [D.isVisible]: h && l > c }) }),
              n &&
                i.createElement(
                  'div',
                  { className: r()(D.scrollTop, { [D.isVisible]: d && l > c }), onClick: this._handleScrollTop },
                  i.createElement(
                    'div',
              ...
              n &&
                i.createElement(
                  'div',
                  { className: r()(D.scrollBot, { [D.isVisible]: h && l > c }), onClick: this._handleScrollBot },
                  i.createElement(
                    'div',
                    { className: D.iconWrap },
                    i.createElement(y.Icon, { icon: E, className: D.icon }),
      ...
      class z extends i.PureComponent {
          ...
          super(e),
            ...
            (this._handlePressEnd = () => {
              this._longPressDelay &&
                ...
                this.state.isOpened
                  ? this._toggleDropdown(!1)
                  : this.props.checkable || this.state.isOpened || !this.props.isActive || c.mobiletouch
        ...
        render() {
          ...
          return i.createElement(
            'div',
            {
              className: l(R.dropdown, { [R.isGrayed]: d, [R.isActive]: h, [R.isOpened]: g }),
              onClick: d ? u : void 0,
            },
            i.createElement(
              'div',
              ...
              i.createElement(
                'div',
                {
                  ...
                  className: l(R.buttonWrap, { 'apply-common-tooltip common-tooltip-vertical': Boolean(n || s) }),
              ...
              !d &&
                ...
                i.createElement(
                  'div',
                  {
                    className: l(R.arrow, a && 'apply-common-tooltip common-tooltip-vertical'),
                    title: a,
            ...
            !d &&
              (p
                ? g && i.createElement(x.Drawer, { onClose: this._handleClose, position: 'Bottom' }, r)
                : i.createElement(
                    V.PopupMenu,
                    {
                      doNotCloseOn: this,
      ...
      class q extends i.Component {
        constructor(e) {
          super(e),
            ...
            (this._handleSelect = (e) => {
              (0, W.saveDefaults)('linetoolicon', { ...(0, W.defaults)('linetoolicon'), icon: e }),
        ...
        componentDidMount() {
          u.tool.subscribe(this._onChangeDrawingState), h.onSync.subscribe(this, this._onSyncSettings);
        }
        componentWillUnmount() {
          u.tool.unsubscribe(this._onChangeDrawingState), h.onSync.unsubscribe(this, this._onSyncSettings);
        }
        render() {
          ...
          return i.createElement(
            z,
            {
              ...
              buttonIcon: i.createElement('div', { className: H.buttonIcon }, String.fromCharCode(n || F[0])),
              buttonTitle: j.icon,
              ...
              onClickWhenGrayed: () =>
                (0, p.emit)('onGrayedObjectClicked', { type: 'drawing', name: _.lineToolsInfo[t].localizedName }),
            ...
            l &&
              i.createElement(
                i.Fragment,
                null,
                o && i.createElement('div', { className: H.title }, (0, a.t)('Recently used')),
                i.createElement(
                  'div',
                  { className: h },
                  l.map((e) => this._renderItem(e, !0)),
                ),
                i.createElement(G.PopupMenuSeparator, { className: r()(o && H.separator) }),
              ),
            i.createElement(
              'div',
              { key: 'all', className: h },
      ...
      class $ extends i.PureComponent {
        ...
        render() {
          return this.state.isVisible
            ? i.createElement(P, { action: this._handleClick, isTransparent: !0, toolName: 'zoom-out' })
      ...
      class te extends i.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleGrayedClick = (e) => {
              (0, p.emit)('onGrayedObjectClicked', { type: 'drawing', name: _.lineToolsInfo[e].localizedName });
            }),
        ...
        componentDidMount() {
          u.tool.subscribe(this._onChangeDrawingState),
            Z.LinetoolsFavoritesStore.favoriteAdded.subscribe(null, this._onAddFavorite),
            Z.LinetoolsFavoritesStore.favoriteRemoved.subscribe(null, this._onRemoveFavorite),
            Z.LinetoolsFavoritesStore.favoritesSynced.subscribe(null, this._onSyncFavorites);
        }
        componentWillUnmount() {
          u.tool.unsubscribe(this._onChangeDrawingState),
            Z.LinetoolsFavoritesStore.favoriteAdded.unsubscribe(null, this._onAddFavorite),
            Z.LinetoolsFavoritesStore.favoriteRemoved.unsubscribe(null, this._onRemoveFavorite),
            Z.LinetoolsFavoritesStore.favoritesSynced.unsubscribe(null, this._onSyncFavorites);
        }
        componentDidUpdate(e, t) {
            ...
            i.createElement(
              ...
              o.map((o, n) => {
                ...
                return i.createElement(X.PopupMenuItem, {
                  ...
                  shortcut: !s && o.hotkeyHash ? (0, w.humanReadableHash)(o.hotkeyHash) : void 0,
                  icon: h.icon,
                  isActive: r && a === n,
                  appearAsDisabled: u,
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handleRemoveDrawings = () => {
              re('remove drawing'), this.props.chartWidgetCollection.activeChartWidget.value().removeAllDrawingTools();
            }),
            (this._handleRemoveStudies = () => {
              re('remove indicator'), this.props.chartWidgetCollection.activeChartWidget.value().removeAllStudies();
            }),
      ...
      function be(e) {
        ...
        const l = _.lineToolsInfo.hideAllDrawings,
          { trackLabel: r, tooltip: c, dataName: h } = (0, s.ensureDefined)((0, de.getHideOptions)().get(n)),
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            Array.from((0, de.getHideOptions)()).map(([e, o]) =>
              i.createElement(pe, { key: e, hideMode: e, option: o, isSmallTablet: t, onClick: m }),
            ),
          ),
        );
        function m(e, t) {
          ve((0, s.ensureDefined)((0, de.getHideOptions)().get(e)).trackLabel, t);
        }
      }
      function ve(e, t) {
      ...
      class ke extends i.PureComponent {
        ...
        componentDidMount() {
          const e = (this._promise = (0, s.ensureNotNull)((0, Te.getFavoriteDrawingToolbarPromise)()));
          e.then((t) => {
            this._promise === e &&
              ((this._instance = t),
      ...
      const Pe = (0, ie.mergeThemes)(Ae, Ie),
        We = { hide: (0, a.t)('Hide Drawings Toolbar'), show: (0, a.t)('Show Drawings Toolbar') };
      class Fe extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            {
              className: l(Pe.toggleButton, 'apply-common-tooltip common-tooltip-vertical', !e && Pe.collapsed),
              onClick: this._toggleVisibility,
              title: e ? We.hide : We.show,
              'data-name': t,
              'data-value': e ? 'visible' : 'collapsed',
            },
            i.createElement(Be, { direction: e ? 'left' : 'right', theme: e ? void 0 : Pe }),
          );
        }
      }
      var Ve = o(94004),
      ...
      var Re = o(53178),
        ze = o(24565);
      const Ge = { weakMagnet: (0, a.t)('Weak Magnet'), strongMagnet: (0, a.t)('Strong Magnet') },
        He = (0, v.onWidget)(),
        je = new (b())(),
      ...
      function Ye() {
        ...
        Ke('magnet mode', e), Xe('magnet mode', e ? 'on' : 'off'), (0, m.setIsMagnetEnabled)(e);
      }
      function Je() {
        (0, oe.trackEvent)('GUI', 'Magnet mode', 'Weak'), (0, m.setMagnetMode)(fe.MagnetMode.WeakMagnet);
      }
      function $e() {
        (0, oe.trackEvent)('GUI', 'Magnet mode', 'Strong'), (0, m.setMagnetMode)(fe.MagnetMode.StrongMagnet);
      }
      function Ze() {
        Xe('magnet mode', 'menu');
      }
      class Qe extends i.PureComponent {
        ...
        render() {
          ...
          let m;
          m = i.createElement(Fe, { toolbarVisible: s, 'data-name': 'toolbar-drawing-toggle-button' });
          const p = () => !!this._features.tools && !!d.enabled('show_object_tree');
          return i.createElement(
            Re.RegistryProvider,
            ...
            i.createElement(
              ...
              i.createElement(
                Ve.DrawerManager,
                null,
                i.createElement(xe.MatchMedia, { rule: Oe.DialogBreakpoints.TabletSmall }, (e) =>
                  i.createElement(
                    'div',
                    {
                      id: 'drawing-toolbar',
                      ...
                      i.createElement(
                        ...
                        !o &&
                          i.createElement(
                            'div',
                            { className: ze.group, style: h },
                            i.createElement(J, { toolName: 'measure', onClick: this._handleMeasureClick }),
                            i.createElement(J, { toolName: 'zoom', onClick: this._handleZoomInClick }),
                          ...
                          i.createElement(
                            ...
                            i.createElement(
                              ...
                              i.createElement(X.PopupMenuItem, {
                                ...
                                isActive: a && r !== fe.MagnetMode.StrongMagnet,
                                label: Ge.weakMagnet,
                                onClick: Je,
                              }),
                              i.createElement(X.PopupMenuItem, {
                            ...
                            this._features.tools && i.createElement(be, { isSmallTablet: e }),
                            !1,
                          ),
                        !o &&
                          this._features.tools &&
                        ...
                        i.createElement('div', { className: ze.fill, style: h }),
                        !o &&
                          (this._features.tools || !1) &&
                          i.createElement(
                            'div',
                            { className: l(ze.group, ze.lastGroup), style: h },
                            !1,
                            this._features.tools &&
                              this._features.favoriting &&
                              i.createElement(ke, { id: Se.FavoriteDrawings }),
                            p() &&
                              i.createElement(P, {
                                id: Se.ObjectTree,
        ...
        _negotiateResizer() {
          ...
          this.props.resizerBridge.negotiateWidth(this.state.isVisible ? Me.TOOLBAR_WIDTH_EXPANDED : e);
        }
        _handleGlobalClose() {
          je.fire();
        }
      ...
      class et {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            n.render(i.createElement(Qe, { ...t, ref: this._handleRef }), this._container);
        }
        destroy() {
          ...
          (0, i.useEffect)(() => {
            ...
            return (
              ...
              () => {
                ...
                h.CheckMobile.iOS() && (0, a.enableBodyScroll)(e), 0 === t && (0, l.setFixedBodyState)(!1);
              }
            );
          }, []),
          i.createElement(
