(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9039],
  {
    ...
    14391: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { LollipopCardType: () => M, showLollipopTooltip: () => T });
      var o = n(67294),
        r = n(73935),
        a = n(16282),
        l = n(94184),
      ...
      const g = (0, o.forwardRef)((e, t) => {
        const { onClose: n, onForceClose: r, onClickOutside: a, customCloseSubscriptions: l = [], ...s } = e,
          i = (0, o.useRef)(null),
          c = (0, o.useCallback)(
            (e) => {
        ...
        return (
          (0, o.useEffect)(() => {
            const e = ((t = u), window.addEventListener('scroll', t), () => window.removeEventListener('scroll', t));
            var t;
            const n =
              l &&
              (function (e, t) {
          ...
          o.createElement(
            m.PopupMenu,
            {
              ...
              tabIndex: -1,
              reference: (e) => {
                'function' == typeof t ? t(e) : (0, f.isObject)(t) && (t.current = e), (i.current = e);
              },
              onClose: n,
              onClickOutside: a,
              onKeyDown: c,
      ...
      function b(e) {
        ...
        return o.createElement(
          ...
          o.createElement('div', { className: y.groupCell }, o.createElement('span', { className: y.text }, t)),
          o.createElement(
            'div',
            ...
            a &&
              o.createElement(C.Icon, {
                icon: a.iconContent,
                className: s()(y.groupIcon, a.iconClass, 'apply-common-tooltip'),
                title: a.tooltipText,
              }),
          ),
        );
      ...
      function S(e) {
        ...
        const { content: n = [], subTitle: r, cardType: a, anchor: l } = e,
          ...
          u = 'string' == typeof r ? r : r.map((e) => o.createElement(b, { key: e.name, ...e }));
        return o.createElement(
          o.Fragment,
          null,
          o.createElement(
            ...
            l && o.createElement('div', { className: y.group }, o.createElement(k, { ...l })),
          ),
        );
      }
      !(function (e) {
      ...
      var N = n(99838);
      const x = (0, w.mergeThemes)(E.DEFAULT_MENU_THEME, { menuWrap: N.menuWrap, menuBox: N.menuBox });
      function D(e) {
        const {
            tooltips: t,
            onClose: n,
              ...
              : o.createElement(
                  ...
                  p &&
                    o.createElement(
                      o.Fragment,
                      null,
                      o.createElement('div', { ref: f, className: N.fadeTop, style: R }),
                  ...
                  p &&
                    o.createElement(
                      ...
                      o.createElement('div', { ref: h, className: N.fadeBottom, style: B }),
                    ),
                ),
          ),
        );
      ...
      function T(e) {
        ...
        null === R && ((R = document.createElement('div')), document.body.appendChild(R)),
      ...
      function B(e, t, n) {
        ...
        return (
          w < n ? ((f = e.marginTop + c.top), (v = Math.max(w, 0))) : (f = c.height + c.top - h - n),
    ...
    57374: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        m = n(64526);
      function p(e) {
        const { position: t = 'Bottom', onClose: n, children: p, className: v, theme: f = m } = e,
          ...
          (0, o.useEffect)(() => {
            ...
            return (
              ...
              () => {
                ...
                u.CheckMobile.iOS() && (0, l.enableBodyScroll)(e), 0 === t && (0, s.setFixedBodyState)(!1);
              }
            );
          }, []),
          o.createElement(
            ...
            o.createElement(
              ...
              h === g.currentDrawer && o.createElement('div', { className: m.backdrop, onClick: n }),
              o.createElement(
                'div',
                {
