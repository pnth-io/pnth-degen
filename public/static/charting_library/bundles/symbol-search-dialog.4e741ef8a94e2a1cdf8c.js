  ...
  [1754],
  {
    99319: (e, t, s) => {
      ...
      var a = s(24287),
        ...
        o = s(22900);
      s(27490), s(43367);
      !(0, o.isOnMobileAppPage)('any') && window.matchMedia('(min-width: 602px) and (min-height: 445px)').matches;
      function h(e) {
        const t = (0, n.getSymbolSearchCompleteOverrideFunction)(),
          { defaultValue: s, showSpreadActions: o, source: h, onSearchComplete: l, ...u } = e,
          c = {
            ...u,
