  ...
  [5254],
  {
    ...
    21259: (o, e, l) => {
      ...
      const T = (0, r.humanReadableModifiers)(r.Modifiers.Shift, !1),
        ...
        h = { keys: [T], text: (0, i.t)('{hotKey_0} — drawing a straight line at angles of 45') },
        ...
        v = {
          ...
          LineToolABCD: { icon: s.lineToolsIcons.LineToolABCD, localizedName: c.lineToolsLocalizedNames.LineToolABCD },
          LineToolArc: { icon: s.lineToolsIcons.LineToolArc, localizedName: c.lineToolsLocalizedNames.LineToolArc },
          LineToolArrow: {
          ...
          LineToolFibSpeedResistanceArcs: {
            ...
            localizedName: c.lineToolsLocalizedNames.LineToolFibSpeedResistanceArcs,
          },
          LineToolFibSpeedResistanceFan: {
            icon: s.lineToolsIcons.LineToolFibSpeedResistanceFan,
            localizedName: c.lineToolsLocalizedNames.LineToolFibSpeedResistanceFan,
          ...
          LineToolGannSquare: {
            ...
            hotKey: (0, a.hotKeySerialize)({ keys: [T], text: (0, i.t)('{hotKey_0} — fixed increments') }),
          },
          ...
          LineToolHorzLine: {
            ...
            hotKey: (0, a.hotKeySerialize)({ keys: [d, 'H'], text: '{0} + {1}' }),
          },
          LineToolHorzRay: {
            icon: s.lineToolsIcons.LineToolHorzRay,
            localizedName: c.lineToolsLocalizedNames.LineToolHorzRay,
          },
          LineToolIcon: { icon: s.lineToolsIcons.LineToolIcon, localizedName: c.lineToolsLocalizedNames.LineToolIcon },
          ...
          LineToolPath: { icon: s.lineToolsIcons.LineToolPath, localizedName: c.lineToolsLocalizedNames.LineToolPath },
          LineToolPrediction: {
          ...
          LineToolRay: { icon: s.lineToolsIcons.LineToolRay, localizedName: c.lineToolsLocalizedNames.LineToolRay },
          LineToolRectangle: {
            icon: s.lineToolsIcons.LineToolRectangle,
            localizedName: c.lineToolsLocalizedNames.LineToolRectangle,
            hotKey: (0, a.hotKeySerialize)({ keys: [T], text: (0, i.t)('{hotKey_0} — square') }),
          },
          LineToolCircle: {
          ...
          LineToolFixedRangeVolumeProfile: {
            ...
            localizedName: c.lineToolsLocalizedNames.LineToolFixedRangeVolumeProfile,
          },
          ...
          LineToolText: { icon: s.lineToolsIcons.LineToolText, localizedName: c.lineToolsLocalizedNames.LineToolText },
          ...
          LineToolTrendBasedFibExtension: {
            ...
            localizedName: c.lineToolsLocalizedNames.LineToolTrendBasedFibExtension,
          },
          ...
          LineToolVertLine: {
            ...
            hotKey: (0, a.hotKeySerialize)({ keys: [d, 'V'], text: '{0} + {1}' }),
          },
          LineToolCrossLine: {
          ...
          arrow: { icon: t.drawingToolsIcons.arrow, localizedName: (0, i.t)('Arrow') },
          cursor: { icon: t.drawingToolsIcons.cursor, localizedName: (0, i.t)('Cross') },
          dot: { icon: t.drawingToolsIcons.dot, localizedName: (0, i.t)('Dot') },
          drawginmode: {
          ...
          eraser: { icon: t.drawingToolsIcons.eraser, localizedName: (0, i.t)('Eraser') },
          group: { icon: t.drawingToolsIcons.group, localizedName: (0, i.t)('Show Hidden Tools') },
          hideAllDrawings: {
            ...
            hotKey: (0, a.hotKeySerialize)({ keys: [L, d, 'H'], text: '{0} + {1} + {2}' }),
          },
          lockAllDrawings: {
          ...
          measure: {
            ...
            hotKey: (0, a.hotKeySerialize)({ keys: [T], text: (0, i.t)('{hotKey_0} + Click on the chart') }),
          },
          removeAllDrawingTools: {
            icon: t.drawingToolsIcons.removeAllDrawingTools,
            localizedName: (0, i.t)('Remove Drawings'),
          },
          showObjectsTree: { icon: t.drawingToolsIcons.showObjectTree, localizedName: (0, i.t)('Show Object Tree') },
          zoom: { icon: t.drawingToolsIcons.zoom, localizedName: (0, i.t)('Zoom In') },
          'zoom-out': { icon: t.drawingToolsIcons['zoom-out'], localizedName: (0, i.t)('Zoom Out') },
        };
    ...
    59726: (o, e, l) => {
      ...
      function i(o, e, l, i, n) {
        function a(n) {
          ...
          const a = n.target;
          void 0 !== l && null !== e && null !== a && a.ownerDocument === i && (e.contains(a) || l(n));
        }
        return (
    ...
    65043: (o, e, l) => {
      ...
      var i = l(79881),
        ...
        c = l(23204),
        r = l(69560);
      const T = { add: (0, i.t)('Add to favorites'), remove: (0, i.t)('Remove from favorites') };
      function d(o) {
