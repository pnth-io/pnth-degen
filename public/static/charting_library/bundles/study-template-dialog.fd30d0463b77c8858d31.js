  ...
  [6631],
  {
    ...
    53400: (e, t, s) => {
      ...
      function c(e) {
        ...
        return n.createElement(
          ...
          n.createElement('span', { className: t }, n.createElement(o.Icon, { icon: a, className: l().icon })),
        );
      }
    },
    37850: (e, t, s) => {
      ...
      class c extends n.PureComponent {
        render() {
          ...
          return (
            this.props.label &&
              (c = n.createElement('span', { className: r, title: this.props.title }, this.props.label)),
            n.createElement('label', { className: o }, n.createElement(a.CheckboxInput, { ...s, className: e }), c)
          );
        }
      }
    ...
    73226: (e, t, s) => {
      ...
      class c extends i.PureComponent {
        ...
        render() {
          const { className: e, color: t = 'black', staticPosition: s } = this.props,
            n = o(l().item, { [l()[t]]: Boolean(t) });
          return i.createElement(
            'span',
            { className: o(l().loader, s && l().static, e, this._getStateClass()) },
    ...
    10342: (e, t, s) => {
      ...
      class _ extends a.PureComponent {
          ...
          if (
            ...
            (this._handleChange = (e) => {
              ...
              if (t && '' === a) this.setState({ queryValue: a, isOpened: !1, active: void 0 }), o && o();
                ...
                this.setState({ queryValue: a, isOpened: t, active: s ? void 0 : this._getActiveKeyByValue(a) }),
                  t && i && i();
              }
              s && n && n(a);
            }),
            ...
            (this._handleKeyDown = (e) => {
              if (-1 === [n.DownArrow, n.UpArrow, n.Enter, n.Escape].indexOf(e.which)) return;
              const { allowUserDefinedValues: t, value: s, onChange: i, onSuggestionsOpen: o } = this.props,
              ...
              switch (e.which) {
                ...
                case n.Enter:
                  ...
                  t && (r && m ? this.setState(this._valueToQuery(m)) : (m = l)),
                    void 0 !== m &&
                      (this._close(), r || this._blur(), m !== s ? i && i(m) : this.setState(this._valueToQuery(m)));
              }
            }),
        ...
        UNSAFE_componentWillReceiveProps(e) {
          ...
          const n = t ? s : '' === s ? '' : this._source()[s] || this.state.queryValue;
        ...
        render() {
          return a.createElement(d.OutsideEvent, { handler: this._handleOutsideClick, click: !0 }, (e) =>
            a.createElement(
              'div',
                ...
                endSlot: Object.keys(this._suggestions(this.state.queryValue)).length
                  ? a.createElement(
                      ...
                      a.createElement(
                        ...
                        a.createElement(u.ToolWidgetCaret, { className: m.icon, dropped: this.state.isOpened }),
                      ),
                    )
                  : void 0,
        ...
        _renderSuggestions() {
          const e = this._suggestions(this.state.queryValue),
            t = Object.keys(e).map((t) => {
              const s = l(m.suggestion, { [m.selected]: this.state.active === t });
              return a.createElement('li', { id: t, key: t, className: s, onClick: this._handleItemClick }, e[t]);
            }),
            s = a.createElement('li', { className: m.noResults }, (0, o.t)('No results found'));
          return !t.length && this.props.noEmptyText
            ? null
            : a.createElement('ul', { className: m.suggestions, ref: this._setSuggestionsRef }, t.length ? t : s);
        }
        _handleKeyUpEnter(e) {
      ...
      class C extends a.PureComponent {
        ...
        render() {
          const { isOpened: e, saveDisabled: t, title: s, onClose: n } = this.props;
        ...
        _renderDialogBody() {
          return () => a.createElement(f.SlotContext.Consumer, null, (e) => ((this._manager = e), this.props.children));
        }
      }
      var x = s(33237),
        E = s(37457);
        ...
        return (
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(c.Checkbox, {
                  label: a.createElement(
                    ...
                    T,
                    a.createElement(v.Icon, { icon: x, className: l(E.hintMark, 'apply-common-tooltip'), title: s }),
                  ),
                  onChange: function () {
              ...
              a.createElement(
                ...
                a.createElement(c.Checkbox, {
                  label: a.createElement(
                    ...
                    { className: E.hintLabel },
                    L,
                    a.createElement(v.Icon, { icon: x, className: l(E.hintMark, 'apply-common-tooltip'), title: n }),
                  ),
                  onChange: function () {
              ...
              a.createElement('div', { className: l(E.indicators, w && E.withSuggestions) }, o),
            ),
          )
        );
      }
      ...
      class D {
        constructor(e) {
          (this._container = document.createElement('div')),
            ...
            (this.unmount = () => {
              I.unsubscribe(A.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null),
      ...
      const B = (0, o.t)('Save Indicator Template'),
        P = (0, o.t)('Selecting this option will set the {symbol} symbol on the chart when this template is applied'),
        R = (0, o.t)(
          'Selecting this option will set the {interval} interval on the chart when this template is applied',
        ),
        F = (0, o.t)("Study Template '{templateName}' already exists. Do you really want to replace it?");
      function H(e, t, s) {
        const n = () => {
          V.backend.invalidateStudyTemplatesList(), V.backend.getStudyTemplatesList().then(t);
        };
      ...
      class K {
        ...
        _prepareData(e, t, s) {
          ...
          return {
            ...
            meta_info: (0, M.createStudyTemplateMetaInfo)(this._controller, n.interval),
          };
        }
        _doSave(e, t, s) {
        ...
        _getActualTemplateList() {
          return V.backend.invalidateStudyTemplatesList(), V.backend.getStudyTemplatesList();
        }
        _showTemplateSaveRenameDialog(e, t, s) {
          ...
          (this._dialog = new D({
            ...
            saveIntervalHintText: R.format({ interval: (0, q.translatedIntervalString)(s) }),
    ...
    33756: (e, t, s) => {
      'use strict';
      s.d(t, { createStudyTemplateMetaInfo: () => i, descriptionString: () => o });
      var n = s(17e3);
      function i(e, t) {
        return {
          indicators: e
    ...
    88262: (e, t, s) => {
      ...
      function l(e) {
        ...
        return n.createElement(o.Icon, { className: i(s, a.icon, { [a.dropped]: t }), icon: r });
      }
    },
    44805: (e) => {
      e.exports =
