  ...
  [4862],
  {
    ...
    45650: (e, t, n) => {
      ...
      const a = r.forwardRef((e, t) => {
        ...
        return r.createElement(i.ToolWidgetButton, { 'data-name': a, ...c, ref: t, className: o(n, s.button) });
      });
    },
    69117: (e, t, n) => {
      'use strict';
      ...
      const m = new l.TranslatedString(
        ...
        b = (e) =>
          (0, c.t)('{drawingsCount} drawing', { plural: '{drawingsCount} drawings', count: e }).format({
      ...
      class T extends r.PureComponent {
        constructor(e) {
          super(e),
              ...
              if (this._model && this._symbolDrawingsMap) {
                ...
                if (t) {
                  const n = Array.from(t)
                    .map((e) => (0, o.ensureNotNull)(this._model).model().dataSourceForId(e))
                    .filter(f.notNull);
                  n.length > 0 && this._model.removeSources(n, !1, m.format({ symbol: e })), this._updateItems();
                }
              }
            }),
            ...
            (this.state = { currentSymbol: null, items: null, theme: a.watchedTheme.value() });
        }
        componentDidMount() {
    ...
    72651: (e, t, n) => {
      ...
      var r = {};
      n.r(r), n.d(r, { FILE: () => ee, HTML: () => re, TEXT: () => ne, URL: () => te });
      var o = n(67294),
        i = n(73935);
      ...
      function H(e) {
        ...
        return o.createElement(
          o.Fragment,
          null,
          o.createElement('div', { className: I(B.title, B.withoutIcon) }, (0, m.t)('Object tree'), !1),
          o.createElement(
            'div',
            { className: B.buttons },
      ...
      var X = (function () {
        function e(t, n) {
          ...
          for (var s, a, c = [], l = [], u = [], d = 0; d < r - 1; d++)
            (s = t[d + 1] - t[d]), (a = n[d + 1] - n[d]), l.push(s), c.push(a), u.push(a / s);
          ...
          (this.xs = t), (this.ys = n), (this.c1s = h), (this.c2s = b), (this.c3s = S);
        }
        var t, n, r;
        return (
          (t = e),
      ...
      function J(e, t, n, r, o) {
        var i,
          ...
          c =
            'IMG' === (i = t).nodeName &&
            (K() || !(null !== (s = document.documentElement) && void 0 !== s && s.contains(i))),
          l = Z(c ? e : t),
          ...
          g = (function (e, t, n, r) {
            var o = e ? t.width : n,
              i = e ? t.height : r;
            return (
              Y() && e && ((i /= window.devicePixelRatio), (o /= window.devicePixelRatio)),
          ...
          S = 0 === b || b;
        return {
          x: 0 === m || m ? m : new X([0, 0.5, 1], [u.x, (u.x / d) * v, u.x + v - d]).interpolate(f),
          y: S
            ? b
            : ((a = new X([0, 0.5, 1], [u.y, (u.y / h) * y, u.y + y - h]).interpolate(p)),
              ...
              value: function () {
                ...
                Object.keys(this.config.exposeProperties).forEach(function (t) {
                  Object.defineProperty(e.item, t, {
                    ...
                    get: function () {
                      return (
                        console.warn('Browser doesn\'t allow reading "'.concat(t, '" until the drop event.')), null
                      );
                    },
                  });
                });
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return fe({ dropEffect: this.altKeyPressed ? 'copy' : 'move' }, t || {});
                },
              },
              {
      ...
      var xe =
          ...
          Me(Ie, ve.touch, { start: 'touchstart', move: 'touchmove', end: 'touchend' }),
          ...
          function e(t, n, r) {
            ...
            !(function (e, t) {
              ...
              (this.handleTopMoveStart = function (e) {
                if (Te(e)) {
                  var t = Ce(e);
                  t && (_e(e) && (o.lastTargetTouchFallback = e.targetTouches[0]), (o._mouseClientOffset = t)),
                    (o.waitingForDelay = !1);
                }
              }),
              (this.handleTopMoveStartDelay = function (e) {
                if (Te(e)) {
                  var t = e.type === xe.touch.start ? o.options.delayTouchStart : o.options.delayMouseStart;
                  ...
                  if (l)
                    if (
                      ...
                      (!o.monitor.isDragging() &&
                        (function (e, t, n, r, o) {
                          if (!o) return !1;
                          for (var i = (180 * Math.atan2(r - t, n - e)) / Math.PI + 180, s = 0; s < o.length; ++s)
                            if ((null == o[s].start || i >= o[s].start) && (null == o[s].end || i <= o[s].end))
                              return !0;
                          return !1;
                        })(
                      ...
                      for (var p in h)
                        if (h.hasOwnProperty(p)) {
                          var g = h[p];
                          for (f.push(g); g; ) (g = g.parentElement) && -1 === f.indexOf(g) && f.push(g);
                        }
                      var v = f
                        .filter(function (e) {
              ...
              (this._getDropTargetId = function (e) {
                for (var t = o.targetNodes.keys(), n = t.next(); !1 === n.done; ) {
                  var r = n.value;
              ...
              (this._isScrolling = !1),
              this.options.enableMouseEvents && this.listenerTypes.push(ve.mouse),
              this.options.enableTouchEvents && this.listenerTypes.push(ve.touch),
              this.options.enableKeyboardEvents && this.listenerTypes.push(ve.keyboard);
          }
          var t, n, r;
          return (
            (t = e),
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  this.document &&
                    (be(!e.isSetUp, 'Cannot have two Touch backends at the same time.'),
                    (e.isSetUp = !0),
      ...
      function ze(e, t) {
        return { type: Le, payload: { sourceClientOffset: t || null, clientOffset: e || null } };
      }
      function Ue(e) {
        return (Ue =
      ...
      var Ye = { type: Le, payload: { clientOffset: null, sourceClientOffset: null } };
      function qe(e) {
        return function () {
      ...
      function Ze(e) {
        be('function' == typeof e, 'When clientOffset is provided, getSourceClientOffset must be a function.');
      }
      function $e(e) {
      ...
      function tt(e) {
        return function (t) {
          ...
          rt(o, i, s);
          var a = i.getItemType();
          return ot(o, s, a), it(o, i, s), { type: Be, payload: { targetIds: o, clientOffset: r || null } };
        };
      }
      function nt(e) {
      ...
      function rt(e, t, n) {
        ...
        for (var r = 0; r < e.length; r++) {
          var o = e[r];
          be(e.lastIndexOf(o) === r, 'Expected targetIds to be unique in the passed array.'),
      ...
      function dt(e, t, n, r) {
        ...
        return (
          (function (e) {
            be(void 0 === e || We(e), 'Drop result must either be an object or undefined.');
          })(i),
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    n = (function (e) {
                      return { beginDrag: qe(e), publishDragSource: Qe(e), hover: tt(e), drop: lt(e), endDrag: ft(e) };
                    })(this);
      ...
      var _t = { initialSourceClientOffset: null, initialClientOffset: null, clientOffset: null };
      function Ct() {
        ...
        switch (t.type) {
          ...
          case Be:
            return mt(e.clientOffset, n.clientOffset) ? e : wt(wt({}, e), {}, { clientOffset: n.clientOffset });
          case He:
          case Fe:
            return _t;
          default:
      ...
      function Pt() {
        ...
        switch (t.type) {
          ...
          case Fe:
            return Mt(Mt({}, e), {}, { dropResult: n.dropResult, didDrop: !0, targetIds: [] });
          case He:
            return Mt(
              Mt({}, e),
              {},
      ...
      function Gt() {
        ...
        return {
          dirtyHandlerIds: Bt(e.dirtyHandlerIds, {
            type: t.type,
            payload: zt(zt({}, t.payload), {}, { prevTargetIds: Ge(e, 'dragOperation.targetIds', []) }),
          }),
            ...
            (n = [
              {
                ...
                value: function (e) {
                  ...
                  be('function' == typeof e, 'listener must be a function.'),
                    be(void 0 === r || Array.isArray(r), 'handlerIds, when specified, must be an array of strings.');
                  var o = this.store.getState().stateId,
                    i = function () {
                      var n = t.store.getState(),
                        i = n.stateId;
                      try {
                        i === o || (i === o + 1 && !jt(n.dirtyHandlerIds, r)) || e();
                      } finally {
                        o = i;
                      }
                    };
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    be(t, 'Expected to find a valid source. sourceId='.concat(e)),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    be(t, 'Expected to find a valid target. targetId='.concat(e)),
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ...
                    r && o && i ? Vt(((n = i), { x: (t = r).x + n.x, y: t.y + n.y }), o) : null
                  );
                  var e, t, n, r, o, i;
                },
              },
        ...
        rn = new (class {
          create(e) {
            const t = this.freeTasks,
              n = t.length ? t.pop() : new tn(this.onError, (e) => (t[t.length] = e));
            return (n.task = e), n;
          }
          constructor(e) {
          ...
          (n = [
            {
              ...
              value: function (e, t) {
                Zt(e),
                  (function (e) {
                    be('function' == typeof e.canDrag, 'Expected canDrag to be a function.'),
                      be('function' == typeof e.beginDrag, 'Expected beginDrag to be a function.'),
                      be('function' == typeof e.endDrag, 'Expected endDrag to be a function.');
                  })(t);
            ...
            },
            {
              ...
              value: function (e, t) {
                Zt(e, !0),
                  (function (e) {
                    be('function' == typeof e.canDrop, 'Expected canDrop to be a function.'),
                      be('function' == typeof e.hover, 'Expected hover to be a function.'),
                      be('function' == typeof e.drop, 'Expected beginDrag to be a function.');
                  })(t);
            ...
            },
            {
              key: 'getTarget',
              value: function (e) {
                return be(this.isTargetId(e), 'Expected a valid target ID.'), this.dropTargets.get(e);
              },
            },
            {
              key: 'getSourceType',
              value: function (e) {
                return be(this.isSourceId(e), 'Expected a valid source ID.'), this.types.get(e);
              },
            },
            {
              key: 'getTargetType',
              value: function (e) {
                return be(this.isTargetId(e), 'Expected a valid target ID.'), this.types.get(e);
              },
            },
            {
              key: 'isSourceId',
            ...
            },
            {
              ...
              value: function (e) {
                ...
                be(t, 'Expected an existing source.'), (this.pinnedSourceId = e), (this.pinnedSource = t);
              },
            },
            {
              key: 'unpinSource',
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                return (
                  this.types.set(r, t),
                  e === Kt.SOURCE ? this.dragSources.set(r, n) : e === Kt.TARGET && this.dropTargets.set(r, n),
                  r
                );
              },
            },
      ...
      function fn(e) {
        ...
        return (0, vt.createStore)(Gt, e && t && t({ name: 'dnd-core', instanceId: 'dnd-core' }));
      }
      ...
      var mn = 0,
        ...
        Sn = (0, o.memo)(function (e) {
          ...
          return (
            ...
            (0, Ae.jsx)(pn.Provider, Object.assign({ value: r }, { children: t }), void 0)
          );
        });
      function wn() {
      ...
      const ur = (e) => e.nodes,
        ...
        br = (0, lr.createSelector)([(e) => e.disabled, dr, gr], (e, t, n) => !t.ids.includes(n) && e.includes(n)),
        ...
        Or = (0, lr.createSelector)(ur, (e) => Object.values(e).filter((e) => 0 === e.level)),
      ...
      const Dr = (0, lr.createSelector)([ur, Or, fr], (e, t, n) => {
          const r = new Set(n);
          return t.reduce((t, n) => [...t, ...Mr(e, (0, E.ensureDefined)(n), r)], []);
        }),
      ...
      function* xr(e) {
        ...
        yield (0, C.put)(((e) => ({ type: Cn, nodes: e }))(r)), yield (0, C.put)(Qn(t));
        !Tr(yield (0, C.select)()) && t.length > 0 && (yield (0, C.put)(rr(t[0])), yield (0, C.put)(or(t[0])));
      }
      function* Nr(e) {
        for (;;) {
      ...
      function* Ar(e, t) {
        for (;;) {
          ...
          const a = o.findIndex((e) => e.id === s),
            ...
            l = Hr(r, c, o, a),
            { id: u } = l;
          e ? e([u], c) : yield (0, C.put)(Qn([u])), t && t(u), yield (0, C.put)(rr(u));
        }
      }
      function* Lr(e, t = () => !0) {
        for (;;) {
      ...
      function* Rr(e = () => !0, t) {
        const { dropTarget: n, dropType: r, isHoveredLeft: o, boundBox: i, isLastChild: s } = t,
        ...
        u.map((e) => e.id).includes(d.id)
          ...
          : h &&
            e(u, d, r) &&
            (yield (0, C.put)(((e, t, n) => ({ type: Rn, node: e, dropType: t, boundBox: n }))(d, r, i)));
      }
      function* jr(e) {
      ...
      function Hr(e, t, n, r) {
        ...
        let i,
          s = 0;
        for (; !i || (Math.abs(s) < o && (a = i).level > 1 && !mr(e, (0, E.ensureDefined)(a.parentId))); )
      ...
      function* zr(e = {}) {
        const {
          ...
          l = [(0, C.fork)(jr, r), (0, C.fork)(Br, n), (0, C.fork)(Lr, i, c), (0, C.fork)(Ar, i, s), (0, C.fork)(Pr)];
        for (t && l.push((0, C.fork)(t)), o && l.push((0, C.fork)(Fr, o)), c && l.push((0, C.fork)(Nr, c)); ; ) {
            ...
            case On: {
              ...
              for (const t of Object.keys(e))
                if (!r.includes(t)) {
                  ...
                  e && (o[e] = { ...o[e], children: o[e].children.filter((e) => e !== t) }), delete o[t];
                }
              for (const e of n) {
                const t = e.id;
                if (o.hasOwnProperty(t)) {
                  !(0, Ur.deepEquals)(o[t].children, e.children)[0] && (o[t] = { ...o[t], children: [...e.children] });
                } else {
                  o[t] = e;
                  const { parentId: n } = e;
            ...
            case Wn: {
              ...
              for (const t of n) {
                ...
                if (n.parentId) {
                  ...
                  a[n.parentId] = { ...r, children: r.children.filter((e) => e !== t) };
                }
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    return (Zr = !0), this.internalMonitor.canDropOnTarget(this.targetId);
                  } finally {
                    Zr = !1;
                  }
                },
      ...
      function oo(e) {
        return null !== e && 'object' === ro(e) && Object.prototype.hasOwnProperty.call(e, 'current');
      }
      function io(e, t) {
        for (var n = 0; n < t.length; n++) {
          var r = t[n];
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                return !Jr(this.lastConnectedDropTargetOptions, this.dropTargetOptions);
              },
            },
            {
        ...
        return (
          ...
          (function (e) {
            ...
            return (
              ...
              (null == n || null === (t = n.$$typeof) || void 0 === t ? void 0 : t.toString())
            );
          })(e)
        );
      }
      ...
      function xo(e) {
            ...
            return (
              ...
              (a = [
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (this.handlerMonitor && this.manager && this.handlerConnector && e !== this.currentType) {
                      ...
                      var o = this.manager.getMonitor().subscribeToStateChange(this.handleChange, { handlerIds: [n] });
                      this.disposable.setDisposable(new bo(new mo(o), new mo(r)));
                    }
                  },
                },
                {
                ...
                },
                {
                  key: 'getCurrentState',
                  value: function () {
                    return this.handlerConnector ? l(this.handlerConnector.hooks, this.handlerMonitor, this.props) : {};
                  },
                },
                {
                  key: 'render',
                      ...
                      pn.Consumer,
                      {
                        children: function (t) {
                          ...
                          return (
                            ...
                            (0, Ae.jsx)(
                              h,
                              Object.assign({}, e.props, e.getCurrentState(), { ref: lo(h) ? e.decoratedRef : null }),
                              void 0,
                            )
                          );
                        },
        ...
        return (p.DecoratedComponent = t), (p.displayName = ''.concat(a, '(').concat(f, ')')), To()(p, t);
      }
      function No(e, t) {
        for (var n = 0; n < t.length; n++) {
          var r = t[n];
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: 'hover',
                value: function () {
                  this.spec.hover && this.props && this.spec.hover(this.props, this.monitor, co(this.ref));
                },
              },
              {
                key: 'drop',
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                return !Jr(this.lastConnectedDragSourceOptions, this.dragSourceOptions);
              },
            },
            {
              key: 'didDragPreviewOptionsChange',
              value: function () {
                return !Jr(this.lastConnectedDragPreviewOptions, this.dragPreviewOptions);
              },
            },
            {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    return (Uo = !0), this.internalMonitor.canDragSource(this.sourceId);
                  } finally {
                    Uo = !1;
                  }
                },
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    return (Go = !0), this.internalMonitor.isDraggingSource(this.sourceId);
                  } finally {
                    Go = !1;
                  }
                },
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: 'endDrag',
                value: function () {
                  this.props && this.spec.endDrag && this.spec.endDrag(this.props, this.monitor, co(this.ref));
                },
              },
            ]) && Wo(t.prototype, n),
            r && Wo(t, r),
      ...
      class ii extends o.PureComponent {
        ...
        render() {
          return o.createElement(si, { ...this.props, reference: this._handleRef });
        }
        getNode() {
      ...
      const si = (e) => {
          const {
            ...
            b = (0, o.useRef)(null),
            S = (0, Jo.createSafeMulticastEventHandler)((e) => (b.current = e), h);
          let [w, T] = (0, Qo.useHover)();
          return (
            Bo.CheckMobile.any() && ((w = n), (T = { onMouseOut: oi, onMouseOver: oi })),
            o.createElement(
              'div',
              {
                className: I(ri.wrap, n && ri.selected, v && ri.childOfSelected, a && ri.disabled, i && ri.expandable),
                onClick:
                  1 === y && 0 === m
                    ? _
                    : function (e) {
      ...
      function Ci(e) {
        ...
        return (
          ...
          function (n) {
                              ...
                              return void 0 === n
                                ...
                                : (e.receiveDragDropManager(n),
                                  e.isCurrentlyMounted
                                    ? (0, Ae.jsx)(
                                        r,
                                        Object.assign({}, e.props, e.state, { ref: lo(r) ? e.ref : null }),
                                        void 0,
                                      )
                                    : null);
                            },
            ...
            return (c.displayName = 'DragLayer('.concat(a, ')')), (c.DecoratedComponent = n), To()(c, n);
          }
        );
      }
      var Oi = n(4735);
      ...
      const Ni = o.forwardRef((e, t) => {
          ...
          return (
            ...
            (0, o.useImperativeHandle)(t, () => ({ getNode: () => (0, E.ensureNotNull)(n.current) }), []),
            ...
            hover: (e, t, n) => {
              ...
              if ('last' === e.type) {
                const t = r.x - i.left < 48,
                  n = o[o.length - 1],
                  a = t && 2 === n.level ? (0, E.ensureDefined)(o.find((e) => e.id === n.parentId)) : n,
                  c = {
                    top: i.top - s.top,
                    left: i.left - s.left,
                    bottom: i.top - s.top,
      ...
      const ji = Ci(function (e) {
          ...
          (0, U.connect)(
            ...
            const { dropType: t, boundBox: n, isDragging: r, level: i, transform: s = Ri } = e;
            return Ei(function () {
              if (!r || !t || !n) return null;
              const a = { [Li.dropTarget]: 'inside' !== t, [Li.dropTargetInside]: 'inside' === t },
                { width: c, height: l } = n,
                [u, d] = s(e),
      ...
      const Gi = o.forwardRef(function (e, t) {
          ...
          (0, o.useEffect)(() => {
            const e = (e) => {
                [$o.Modifiers.Mod, $o.Modifiers.Shift].includes((0, $o.modifiersFromEvent)(e)) && s();
              },
              t = (e) => {
                a && ![$o.Modifiers.Mod, $o.Modifiers.Shift].includes((0, $o.modifiersFromEvent)(e)) && i();
              };
            return (
                  ...
                  const n = (0, E.ensureNotNull)(e.current),
                    r = (e) => {
                      if (e.target instanceof Element) {
                        const n = (0, E.ensureNotNull)(e.target.closest('[draggable]'));
          ...
          const x = (0, o.useCallback)(() => (0, E.ensureNotNull)(W.current), []),
              ...
              for (let i = 0; i < r.length; i++) {
                ...
                1 === s.level &&
                  (void 0 !== n &&
                    ...
                    t.push({
                      type: 'separator',
                      node: o.createElement('div', { key: n + '_separator', className: Hi.separator }),
                    }),
                  (n = s.parentId)),
                  t.push({
                    type: 'node',
          ...
          const R = (0, o.useCallback)((e) => {
              ...
              const { index: n } = e;
              return (
                n === L.current.length - 1 && ((t = { ...t, bottom: 0, minHeight: t.height }), delete t.height),
            ...
            B = (0, o.useCallback)((e) => (0, E.ensure)(L.current[e].node.key), []),
            F = (0, o.useMemo)(
              () => (null === v ? { index: -1 } : { index: L.current.findIndex((e) => e.node.key === v.id) }),
              [v],
            );
          d(M);
          const [H, z, U, G] = (0, xi.useOverlayScroll)(),
            V = (0, o.useRef)(null);
          (0, o.useEffect)(() => (0, E.ensureNotNull)(V.current).resetAfterIndex(0, !0), [A]),
            (0, o.useEffect)(() => (0, E.ensureNotNull)(V.current).scrollToItem(F.index), [F]);
          const W = (0, o.useRef)(null),
            ...
            q = (0, o.useRef)({
              startScroll(e) {
                const t = () => {
                  null !== U.current && ((Y.current = requestAnimationFrame(t)), U.current.scrollBy({ top: e }));
                };
                this.stopScroll(), t();
              },
              stopScroll() {
              ...
              o.createElement(
                'div',
                {
                  ...
                  onKeyDown: function (e) {
                    ...
                    if (e.defaultPrevented || (0, pi.isNativeUIInteraction)(t, e.target)) return;
                ...
                o.createElement(Mi.OverlayScrollContainer, { ...H, className: Hi.overlayScrollWrap }),
        ...
        Vi = Ro(
          ...
          {
            drop: (e, t, n) => {
              ('touch' === e.drag || Bo.isFF) && n.stopScroll(), t.getItem().dropSelection();
            },
            hover: (e, t, n) => {
              ...
              ((t, r, o) => {
                const i = Math.abs(t - o),
                  s = Math.abs(t - r);
                if ((s > 40 && i > 40) || (i <= 40 && s <= 40)) return void n.stopScroll();
                var a, c, l, u;
                (a = s > 20 && s <= 40),
                  (l = i <= 20),
                  (u = s <= 20),
                  (c = i > 20 && i <= 40) || a
                    ? 'touch' === e.drag
                      ? n.startScroll(c ? -5 : 5)
                      : n.startScroll(c ? -2 : 2)
                    : (l || u) && ('touch' === e.drag ? n.startScroll(l ? -10 : 10) : n.startScroll(l ? -5 : 5));
              })(r.y, i.bottom, i.top);
            },
          },
        ...
        return (
          ...
          (0, o.useEffect)(
            () => (
              null !== v &&
                c &&
                (f && (f.current = performance.now()), v.dispatch(((e) => ({ type: On, nodes: e }))(c))),
              () => {}
            ),
            [v, c],
          ),
          ...
          null === v ? null : o.createElement(qi, { store: v, scrollToId: p, ...g })
        );
      }
      const qi = o.memo(function (e) {
        ...
        return (
          (0, o.useEffect)(() => {
            var e;
            t.dispatch(or(null !== (e = null == n ? void 0 : n.id) && void 0 !== e ? e : null));
          }, [n]),
          o.createElement(
            Sn,
            { backend: i, options: Ki },
            o.createElement(U.Provider, { store: t, context: ai }, o.createElement(Wi, { ...r })),
          )
        );
      });
      function Xi(e, t) {
      ...
      function* Qi() {
        for (;;) {
          ...
          1 === e && Xi('Multi select', 'Ctrl'), 2 === e && Xi('Multi select', 'Shift');
        }
      }
      function* es(e) {
        for (;;) {
      ...
      function cs(e) {
        const { viewModel: t, showHeader: n = !0, nodeRenderer: r, isDialog: i = !1 } = e,
          s = (0, o.useRef)(null),
          a = (function (e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              'div',
              { className: ss.wrap, onContextMenu: os.preventDefaultForContextMenu },
      ...
      function fs(e) {
        ...
        return o.createElement(k.Icon, { className: D()(hs.button, n && hs.disabled, t), ...r });
      }
      var ps = n(27278),
        gs = n(36535),
        vs = n(23707),
      ...
      function Ts(e) {
        const {
          ...
          [N, A] = (0, o.useState)(!1),
          [L, R] = ((0, ps.useWatchedValueReadonly)({ watchedValue: h.getChartLayout() }), (0, o.useState)(!1)),
          j = (0, o.useRef)(null);
        (0, o.useEffect)(() => {
          const e = {};
          ...
          return (
            ...
            l.onIsActualIntervalChange().subscribe(e, () => D(l.isActualInterval())),
            l.onSyncStateChanged().subscribe(e, () => x(l.getDrawingSyncState())),
            () => {
          ...
          (0, o.useEffect)(() => {
            g && y.current && (y.current.focus(), y.current.setSelectionRange(0, b.length));
          }, [g]),
          (0, o.useEffect)(() => {
            const e = {};
            return (
          ...
          (0, o.useEffect)(() => {
            !i && j.current && (clearTimeout(j.current), (j.current = null)), v(!1);
          }, [i]);
        const B = l.getIcon(),
          F = {};
        if (c) {
          const e = h.entity(c);
          e && (F['data-parent-name'] = e.title()), (F['data-type'] = l.hasChildren() ? 'group' : 'data-source');
        }
        const H = l.title(),
          z = a || N,
          U = g && i,
        ...
        return o.createElement(
            ...
            onClick:
              1 === p
                ...
                : function (e) {
                    ...
                    if (j.current)
                      e.preventDefault(), clearTimeout(j.current), (j.current = null), h.openProperties(l), R(!1);
                    else {
                      const e = h.selection().selected();
                      j.current = setTimeout(() => {
                        (j.current = null), i && !L && 1 === e.length && h.rename(l, () => v(!0)), R(!1);
                      }, 500);
                    }
                  },
          ...
          !U &&
            o.createElement(
              o.Fragment,
              null,
              B && B.type === us.Svg && o.createElement(k.Icon, { icon: B.content || '', className: Ss.icon }),
              B && B.type === us.Text && o.createElement('span', { className: I(Ss.icon, Ss.textIcon) }, B.content),
              !1,
              o.createElement(
                'span',
                { className: I(Ss.title, h.isMain(l) && Ss.main, (!l.isVisible() || !O) && Ss.disabled), ...F },
                H,
              ),
              o.createElement(
                'span',
                ...
                o.createElement(fs, {
                  icon: W,
                  className: I(Ss.button, !O && [Ss.warn, 'apply-common-tooltip'], (z || !_ || !O) && Ss.visible),
                  onClick: O
                    ? function (e) {
                        if (e.defaultPrevented) return;
            ...
            o.createElement(ds.InputControl, {
              ...
              onKeyDown: function (e) {
                27 === (0, $o.hashFromEvent)(e)
                  ...
                  : 13 === (0, $o.hashFromEvent)(e) && (e.preventDefault(), q());
              },
        ...
        function Y(e) {
          e.defaultPrevented ||
            g ||
            !l.fullyConstructed() ||
            (e.preventDefault(), e.persist(), h.openContextMenu(l, () => v(!0), e));
        }
        function q() {
      ...
      class Cs extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._renderChildren = (e) => o.createElement(Os, { isSmallTablet: e, viewModel: this.props.viewModel })),
            ...
            (this._matchMedia = window.matchMedia(S.DialogBreakpoints.TabletSmall)),
        ...
        render() {
          return o.createElement(
            o.Fragment,
            null,
            o.createElement(y.MatchMedia, { rule: S.DialogBreakpoints.TabletSmall }, (e) =>
      ...
      function Os(e) {
        ...
        return o.createElement(
          ei.Provider,
          { value: r },
          o.createElement(cs, { nodeRenderer: ws, showHeader: !1, viewModel: n, isDialog: !0 }),
        );
      }
      var Es = n(86573),
        Is = n(468),
      ...
      class Ps {
        constructor(e) {
          (this._onChange = new (ks())()),
            (this._recalculate = () => {
              const e = this._groupModel.groups().map((e) => xs(e.id, e.instanceId())),
        ...
        buildTree() {
          ...
          for (const t of this._controller.model().panes()) {
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (o.pane() === t) {
                const r = [...n.lineTools()]
                  ...
                  .map((e) => xs(e.id(), e.instanceId()));
                (e[o.id()] = Ls(o.id(), 1, t.id(), r)), e[t.id()].children.push(o.id());
            ...
            e[t.id()].children.sort((e, t) => {
              ...
              return (0, E.ensureNotNull)(r.zOrder()) - (0, E.ensureNotNull)(n.zOrder());
            });
          }
      ...
      class ra {
        constructor(e, t) {
          (this._syncStateChanged = new (ks())()),
            ...
            (this._updateSyncState = () => {
              this._syncStateChanged.fire((0, E.ensureNotNull)(this.getDrawingSyncState()));
            }),
            (this._undoModel = e),
            (this._dataSource = t),
            (0, js.isLineTool)(this._dataSource) && this._dataSource.linkKey().subscribe(this._updateSyncState);
          const n = this._undoModel.lineBeingCreated();
          null !== n && n === t && n.isSynchronizable() && Us.isToolCreatingNow.subscribe(this._updateSyncState);
        }
        destroy() {
          (0, js.isLineTool)(this._dataSource) && this._dataSource.linkKey().unsubscribe(this._updateSyncState),
        ...
        title() {
          ...
          return (0, js.isLineTool)(e)
            ...
            : (0, Hs.isSeries)(e) && this._undoModel.mainSeries() === e
              ? e.symbolTitle(void 0, void 0, (0, Bo.onWidget)() ? 'exchange' : 'listed_exchange')
              : e.title();
        }
        gaLabel() {
        ...
        canBeLocked() {
          return (0, js.isLineTool)(this._dataSource) && this._dataSource.userEditEnabled();
        }
        canBeRemoved() {
        ...
        isActualInterval() {
          return (
            (!(0, js.isLineTool)(this._dataSource) && !(0, Bs.isStudy)(this._dataSource)) ||
            this._dataSource.isActualInterval()
          );
        }
        onIsActualIntervalChange() {
          return (0, js.isLineTool)(this._dataSource) || (0, Bs.isStudy)(this._dataSource)
            ? this._dataSource.onIsActualIntervalChange()
            : na;
        }
        isLocked() {
          return !!(0, js.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value();
        }
        onVisibilityChanged() {
          return this._dataSource.properties().visible.listeners();
        }
        onLockChanged() {
          return (0, js.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : na;
        }
        getIcon() {
          const e = u,
          ...
          if (e && t)
            ...
            } else 'text' === t.type && (r = { type: us.Text, content: t.text });
          return r;
        }
        setVisible(e) {
        ...
        setName(e) {
          if ((0, js.isLineTool)(this._dataSource)) {
            const t = $s.format({
              sourceTitle: this._dataSource.properties().title.value() || ta(this._dataSource),
              newSourceTitle: e,
            });
        ...
        pane() {
          return (0, E.ensureNotNull)(this._undoModel.model().paneForSource(this._dataSource));
        }
        ...
        canBeSyncedInLayout() {
          return (0, js.isLineTool)(this._dataSource) && this._dataSource.isSynchronizable();
        }
        onSyncStateChanged() {
        ...
        doNotAffectChartInvalidation() {
          return (0, js.isLineTool)(this._dataSource) && this._lineToolsAffectChartInvalidation.value();
        }
          ...
          if ((0, js.isLineTool)(this._dataSource)) {
            ...
            null !== t
              ? ((0, E.assert)(!e.some((e) => e.hasChildren())),
                i.forEach((e) => {
                  (0, js.isLineTool)(e) && (t.containsLineTool(e) || r.addLineToolToGroup(t, e));
                }))
              : o();
          } else o();
      ...
      class oa {
        constructor(e, t) {
          (this._onTitleChanged = new (ks())()),
            ...
            (this._paneId = (0, E.ensureNotNull)(e.model().paneForSource(this._lineTools[0])).id());
          const n = () => {
        ...
        childrenIds() {
          ...
          return e.sort((e, t) => t.zorder() - e.zorder()), new Set(e.map((e) => xs(e.id(), e.instanceId())));
        }
        hasChildren() {
          return !0;
        }
      ...
      class ia {
        ...
        getObjectById(e) {
          if (this._entitiesCache.has(e)) return (0, E.ensureDefined)(this._entitiesCache.get(e));
        ...
        canBeGroupped(e) {
          ...
          const t = [];
          if ((e.forEach((e) => e.addSourcesToArray(t)), t.some((e) => !(0, js.isLineTool)(e)))) return !1;
          const n = this._undoModel.model(),
      ...
      const ma = new Rs.TranslatedString('move objects', (0, m.t)('move objects')),
        ba = new Rs.TranslatedString('lock objects', (0, m.t)('lock objects')),
        Sa = new Rs.TranslatedString('unlock objects', (0, m.t)('unlock objects')),
        wa = new Rs.TranslatedString('show objects', (0, m.t)('show objects')),
        Ta = new Rs.TranslatedString('hide objects', (0, m.t)('hide objects')),
        _a = new Rs.TranslatedString('remove objects', (0, m.t)('remove objects')),
      ...
      class xa {
        constructor(e) {
          (this._nodes = {}),
            ...
            (this._ensuredEntity = (e) => (0, E.ensureNotNull)(this._getEntityById(e))),
            (this._chart = e),
            this._init();
        }
        destroy() {
          ...
          this.selection().set([e]),
            null !== t &&
              (this._controller.mainSeries() === t
                ...
                : ((0, js.isLineTool)(t) || (0, Bs.isStudy)(t)) && this._chart.value().showChartPropertiesForSource(t));
        }
        canSelectionBeUnmerged() {
          const e = this._getSelectedEntities();
          return 1 === e.length && this.canNodeWithIdBeUnmerged(Ns(e[0].id()).persistentId);
        }
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e);
          return null !== t && (0, sa.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t);
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) => (0, E.ensureNotNull)(this._model.dataSourceForId(Ns(e.id()).persistentId)));
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), Xi('Copy', Zi(e));
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) => (0, E.ensureNotNull)(this._model.dataSourceForId(Ns(e.id()).persistentId)));
          t.every(js.isLineTool) && (this._controller.cloneLineTools([...t], !1), Xi('Clone', Zi(e)));
        }
        rename(e, t) {
          const n = this._getObjectsToModify(e.id());
          1 === n.length && n.some((e) => e.canBeRenamed()) && (t(), Xi('Rename', Zi(n)));
        }
        async openContextMenu(e, t, n) {
          ...
          let i;
          if (this._objects.some((e) => e.hasChildren())) i = this._getActionsForGroupItem(e, t, o);
          else {
            ...
            (c = s
              ...
              : (0, js.isLineTool)(o)
                ? {
                    ...
                    detail: {
                      type: 'shape',
                      id: null !== (r = null == o ? void 0 : o.id()) && void 0 !== r ? r : null,
                    },
                  }
                : a
                  ...
                  : {
                      menuName: 'ObjectTreeContextMenu',
                      detail: { type: 'study', id: (null == o ? void 0 : o.id()) || null },
                    }),
              aa.ContextMenuManager.showMenu(i, n, { takeFocus: !0, returnFocus: !0 }, c, () => {
        ...
        getNextNodeIdAfterRemove(e) {
          ...
          if (
            (null === (t = i.pane().mainDataSource()) || void 0 === t ? void 0 : t.id()) === r &&
          ...
          const s = (0, E.ensureDefined)(n.find((e) => e.id === o.parentId)).children;
          return 1 === s.length ? this.getNextNodeIdAfterRemove(o.parentId) : this._takeNextOrPrevElement(s, e);
        }
        isContextMenuOpened() {
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          const o = [];
          1 === this._objects.length && o.unshift(this._getRenameAction(t), new ca.Separator()),
            n && o.unshift(this._getGroupAction(), new ca.Separator());
          const i = (0, zs.createSyncDrawingActions)(this._chart.value(), r.filter(js.isLineTool));
          return (
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            r = (0, E.ensureNotNull)(this._model.dataSourceForId(Ns(n.id()).persistentId));
          if (!(0, sa.isPriceDataSource)(r)) throw new Error('Entity is not IPriceDataSource');
          (0 === e ? this._controller.unmergeSourceUp : this._controller.unmergeSourceDown).call(this._controller, r);
        ...
        _getSelectedEntities() {
          ...
          return (
            t.length &&
              ya.logWarn('Detected dangling sources in selection. They will be ignored: ' + JSON.stringify(t)),
            e
          );
        }
        _getEntityById(e) {
      ...
      class Pa extends Na.DialogRenderer {
        constructor() {
          ...
          (this._activeChartWidget = e.activeChartWidget.value()), (this._viewModel = new xa(e.activeChartWidget));
        }
        hide() {
          this._handleClose();
        }
