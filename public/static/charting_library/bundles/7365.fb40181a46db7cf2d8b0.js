(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7365],
  {
    ...
    11086: (t, e, r) => {
      'use strict';
      r.d(e, { hoverMouseEventFilter: () => n, useAccurateHover: () => a, useHover: () => o });
      var s = r(67294);
      function o() {
      ...
      function c(t) {
        ...
        return s.createElement(
          ...
          s.createElement(o.InputControl, {
            ...
            endSlot: s.createElement(s.Fragment, null, y.icon && s.createElement(a.EndSlot, { icon: !0 }, y.icon), p),
          }),
          y.renderedErrors,
        );
      }
    ...
    16305: (t, e, r) => {
      ...
      class g extends s.PureComponent {
        render() {
          const { children: t = [], show: e = !1, customErrorClass: r, disableRtlStyles: n } = this.props,
            a = o(m.errors, { [m.show]: e }, r),
            i = t.map((t, e) => s.createElement('div', { className: m.error, key: e }, t));
          let h = {
            position: 'absolute',
            top: this.props.top,
      ...
      function b(t) {
        ...
        return s.createElement(w.Icon, { icon: v, className: o(E['error-icon'], E['intent-' + e]) });
      }
      var A,
        M,
        S = r(67276);
      ...
      function _(t) {
        const {
          ...
          { attachment: l, targetAttachment: m, attachmentOffsetY: d } = null != n ? n : R[o];
        return s.createElement(
          p,
          {
            isOpened: e,
      ...
      function C(t) {
        ...
        const {
          ...
          F = C || O ? s.createElement(b, { intent: C ? 'danger' : 'warning' }) : void 0,
          P = A
            ? s.createElement(_, {
                errorAttachment: l,
                customErrorsAttachment: m,
          ...
          k = x
            ? s.createElement(
                ...
                null == h ? void 0 : h.map((t, e) => s.createElement('p', { key: e, className: S.message }, t)),
              )
            : void 0,
          N = y
            ? s.createElement(
                ...
                null == c ? void 0 : c.map((t, e) => s.createElement('p', { key: e, className: S.message }, t)),
              )
            : void 0;
        return {
          icon: F,
          renderedErrors:
            null !== (r = null !== (e = null != P ? P : B) && void 0 !== e ? e : k) && void 0 !== r ? r : N,
