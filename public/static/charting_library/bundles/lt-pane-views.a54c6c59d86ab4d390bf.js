  ...
  [1583],
  {
    ...
    57583: (e, t, i) => {
      ...
      (l.prototype.destroy = function () {
        ...
        (l.prototype.startPoint = function (e, t) {
          ...
          return { price: i, coordinate: e.priceScale().priceToCoordinate(i, n) };
        }),
        ...
        (l.prototype._calculateWidth = function (e) {
          ...
          var i = !!e.properties().showPrices && e.properties().showPrices.value(),
            n = !!e.properties().coeffsAsPercents && e.properties().coeffsAsPercents.value(),
        ...
        (l.prototype._effectiveState = function (e) {
          ...
          var n = e.priceScale();
          n &&
            (n.formatter().state && (t.formatter = e.priceScale().formatter().state()),
          ...
          o(
            ...
            function () {
              ...
              for (var i = 0; i < e.cells.length; i++) {
                var r = e.cells[i];
                (this._cache.fillStyle = t.items[i].color), this._cache.fillText(r.text, r.left, n);
              }
            }.bind(this),
          );
        }),
        ...
        (l.prototype._effectiveStatesEquals = function (e, t) {
          ...
          for (var o = 0; o < e.items.length; o++)
            if (((r = e.items[o]), (s = t.items[o]), r.coeff !== s.coeff || r.color !== s.color)) return !1;
          return !0;
        }),
    ...
    35049: (e, t, i) => {
      ...
      class p extends l.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          (S.data = 2), d.push(S);
          const P = [a.PaneCursorType.Default, a.PaneCursorType.Default, (0, l.thirdPointCursorType)(h, u)];
          i.append(this.createLineAnchor({ points: d, pointsCursorType: P }, 0));
        }
      }
    },
    92713: (e, t, i) => {
    ...
    18004: (e, t, i) => {
      ...
      class d extends r.LineSourcePaneView {
        constructor() {
          super(...arguments), (this._circleRenderer = new l()), (this._renderer = new n.CompositeRenderer());
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }
        _updateImpl() {
          ...
          this._circleRenderer.setData({
            ...
            this.addAnchors(this._renderer, {
              hittestResult: [a.HitTestResult.MOVEPOINT, a.HitTestResult.CHANGEPOINT],
            });
        }
      }
    },
        ...
        _updateImpl(e, t) {
            ...
            s.showLabel.value();
          {
            ...
            P &&
              ...
              ((this._pipFormatter = new f.PipFormatter(P.pricescale, P.minmov, P.type, P.minmove2)),
              (this._lastSymbolInfo = P));
            const C =
              (0, n.ensureNotNull)(this._source.ownerSource()).formatter().format(c) +
              ' (' +
            ...
            const D = { x: 0, y: 10 },
              ...
              E = null === (i = s.fillLabelBackground) || void 0 === i ? void 0 : i.value();
            E && (k.backgroundColor = s.labelBackgroundColor.value()), this._textRenderer.setData(k);
            const B = this._textRenderer.measure(),
              O = (0, l.calculateLabelPosition)(B, o, d, D, e);
            this._textRenderer.setPoints([O]), this._renderer.append(this._textRenderer);
          }
          this.addAnchors(this._renderer);
        }
      }
    ...
    86656: (e, t, i) => {
      'use strict';
      i.d(t, { rangeToolsDarkThemeColors: () => r, rangeToolsLightThemeColors: () => s });
      var n = i(53312);
      const r = {
        ...
        _updateImpl(e, t) {
            ...
            r.showLabel.value();
          {
            ...
            if (l && c) {
              ...
              u = ', ' + (0, s.startWithLTR)(new _.TimeSpanFormatter().format(e));
            }
            const p = this._source.volume(),
              ...
              b = null === (i = r.fillLabelBackground) || void 0 === i ? void 0 : i.value();
            b && (T.backgroundColor = r.labelBackgroundColor.value()), this._textRenderer.setData(T);
            const L = this._textRenderer.measure(),
              S = (0, o.calculateLabelPosition)(L, d, h, R, e);
            this._textRenderer.setPoints([S]), this._renderer.append(this._textRenderer);
          }
          this.addAnchors(this._renderer);
        }
      }
          ...
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              if (this._points.length >= 3) {
                ...
                var _ = t.y - e.y;
                if ((((s = e.clone()).y = n.y + _), (s.data = 3), l.fillBackground.value())) {
    ...
    72133: (e, t, i) => {
      ...
      class _ extends c.ScaledPaneRenderer {
        ...
        hitTest(e) {
          ...
          return Math.abs(w - 0.5 * _) <= m
            ...
            : this._data.fillBackground && !this._data.noHitTestOnBackground && w <= 0.5 * _
        ...
        _drawImpl(e) {
          ...
          const o = i.subtract(t),
            h = t.add(i).scaled(0.5),
            c = new r.Point(-o.y, o.x).normalized();
          (s = h.add(c.scaled(a))), (e.strokeStyle = this._data.color), (e.lineWidth = this._data.linewidth);
          const u = o.length(),
            _ = o.x / u,
            p = o.y / u;
          let g = Math.acos(_);
      ...
      class p extends o.LineSourcePaneView {
        constructor() {
          super(...arguments), (this._ellipseRenderer = new _()), (this._renderer = null);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }
        _updateImpl() {
          ...
          const l = t.points[0],
            d = t.points[1];
          if (2 === this._points.length) return this.addAnchors(i), void (this._renderer = i);
          let h = t.points[2];
          ...
          i.append(this.createLineAnchor({ points: [f, v, x, w], pointsCursorType: R }, 0)), (this._renderer = i);
        }
      }
    },
    34810: (e, t, i) => {
    ...
    89436: (e, t, i) => {
      ...
      class g extends u.LineToolPaneViewWithLevelledTextCache {
        ...
        getCacheRects(e, t) {
          ...
          const p = {
              left: o.left,
              top: (0, n.ensureNotNull)(this._cache).topByRow(this._cacheState.row),
              width: o.width,
              height: (0, n.ensureNotNull)(this._cache).rowHeight(this._cacheState.row),
            },
            g = { left: Math.round(l.x - p.width), top: Math.round(l.y), width: o.width, height: p.height },
        ...
        _createCache(e) {
          return new _(this._source.properties().childs().fibLevelsBasedOnLogScale, this._source.levelsCount(), e);
        }
        _updateImpl() {
          super._updateImpl();
          ...
          if (this._points.length < 2) return this.addAnchors(e), void (this._renderer = e);
          const t = this._source.properties().childs(),
            i = this._points[0],
            r = this._points[1];
          if (this._points.length < 3) {
          ...
          for (let o = 1; o < a; o++) {
            const l = (0, n.ensureDefined)(this._source.properties().child('level' + o)).childs();
            ...
            const c = h.scaled(l.coeff.value()),
              ...
              v = new p();
            v.setData(f), e.append(v), (t.showCoeffs.value() || t.showPrices.value()) && s(0, 0, o);
          }
          let c = null;
          for (let e = a; e >= 1; e--) {
            if (
          ...
          if (null !== c) {
            const a = (0, n.ensureDefined)(this._source.properties().child('level' + c)).childs();
            if (a.visible.value()) {
            ...
            for (var l = this._source.properties(), c = this._source.levelsCount(), u = 1; u <= c; u++) {
              ...
              if (_.visible.value()) {
                var p = _.coeff.value(),
                  g = _.color.value(),
                  f = [];
                f.push(new n(this._center.x - 0.5 * i * p, this._center.y - 0.5 * r * p)),
                  f.push(new n(this._center.x + 0.5 * i * p, this._center.y + 0.5 * r * p));
        ...
        getCacheRects(e, t) {
          ...
          switch (c.horzLabelsAlign.value()) {
            case 'left':
              ...
              break;
            case 'center':
              ((h = a.add(o).scaled(0.5)).x += s.width / 2), (h.x = Math.round(h.x));
              break;
            case 'right':
              c.extendLines.value()
                ? (h = new r(u - 4, this._levels[t].y))
                : (((h = new r(u + 4, this._levels[t].y)).x += s.width), (h.x = Math.round(h.x)));
          }
          var p = {
              left: s.left,
            ...
            g = { left: h.x - p.width, top: h.y, width: s.width, height: p.height },
            ...
            if (e && !e.isEmpty() && !this._model.timeScale().isEmpty()) {
              ...
              if (null != t) {
                var i = this._source.points()[0],
                  ...
                  u = !1;
                (P = this._source.properties()).reverse && P.reverse.value() && (u = P.reverse.value()),
                  (this._levels = []);
                var _,
                  p,
                  g = u ? i.price : n.price,
                ...
                if (x) (_ = e.priceToCoordinate(g, t)), (p = e.priceToCoordinate(f, t) - _);
                for (
                ...
                if (!(this._points.length < 2)) {
                  var P,
                    C = new d(),
                    M = ((i = this._points[0]), (n = this._points[1]), Math.min(i.x, n.x)),
                    I = Math.max(i.x, n.x),
                    ...
                    for (y = 0; y < this._levels.length; y++)
                      if (y > 0 && N) {
                        var E = this._levels[y - 1],
                          B = ((i = new r(M, this._levels[y].y)), (n = new r(I, E.y)), {});
                        (B.points = [i, n]),
                  ...
                  for (y = 0; y < this._levels.length; y++) {
                    var z,
                      V = {
                        points: [(i = new r(O, this._levels[y].y)), (n = new r(H, this._levels[y].y))],
                        width: this._model.timeScale().width(),
                        height: this._source.priceScale().height(),
                    ...
                    if (
                      ((z = new a()).setData(V),
                      z.setHitTest(new l(l.MOVEPOINT, { snappingPrice: this._levels[y].price }, this._levels[y].index)),
                      C.append(z),
        ...
        _updateImpl() {
          ...
          for (let e = 0; e < this._levels.length; e++) {
            const i = this._levels[e],
              ...
              r = new s.HitTestResult(s.HitTestResult.MOVEPOINT, void 0, i.index);
          ...
          if (f.visible.value()) {
            ...
            this._trendLineRenderer.setData(e), u.append(this._trendLineRenderer);
          }
      ...
      t.FibWedgePaneView = class extends h {
        ...
        _updateRenderer() {
          if (!((w = this._points).length < 2)) {
            ...
            if ((this._baseTrendRenderer.setData(r), e.append(this._baseTrendRenderer), w.length < 3))
        ...
        _updateImpl() {
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              if (
                3 === this._points.length &&
                (((n = this._points[2]).x = t.x), ((r = e.clone()).y = n.y), (r.data = 3), a.fillBackground.value())
              ) {
        ...
        _updateImpl() {
          if (
            ...
            if (((this._hfans = []), (this._vfans = []), C.fans.visible.value()))
              for (_ = 1; _ <= 7; _++) {
                (R = Math.round(w + C['hlevel' + _].coeff.value() * x)), (f = d + C['vlevel' + _].coeff.value() * r);
            ...
            for (_ = 0; _ < this._hlevels.length; _++) {
              ...
              var k = {
                points: [(e = new n(b, this._hlevels[_].y)), (t = new n(S, this._hlevels[_].y))],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
              ...
              if (((z = new o()).setData(k), T.append(z), C.showLeftLabels.value())) {
                var E = {
                  points: [e],
            ...
            for (_ = 0; _ < this._vlevels.length; _++) {
              (e = new n(this._vlevels[_].x, L)), (t = new n(this._vlevels[_].x, P));
              if (_ > 0 && N) {
                A = this._vlevels[_ - 1];
                var O,
                  H = new n(A.x, L);
              ...
              if (((z = new o()).setData(k), T.append(z), C.showTopLabels.value())) {
                var V = {
                  points: [e],
      ...
      class c {
        ...
        draw(e, t) {
          ...
          (e.lineCap = 'butt'),
            ...
            (0, d.drawHorizontalLine)(e, Math.round(r * i), Math.round(s * i), Math.round(a * i));
        }
        hitTest(e) {
          if (null === this._data || 0 === this._data.points.length) return null;
        ...
        _updateImpl(e, t) {
          ...
          if (i.showLabel.value() && 1 === this._points.length) {
            ...
            if ('right' === t) {
              ...
              o.x + e + 3 >= t ? (o = o.add((0, n.point)(e + 3, 0))) : ((o = (0, n.point)(t, o.y)), (a = 3));
            } else 'center' === t && (o = (0, n.point)((o.x + this._model.timeScale().width()) / 2, o.y));
            const p = {
              points: [o],
              text: l,
              color: i.textcolor.value(),
    ...
    63245: (e, t, i) => {
      ...
      class x extends c.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          e.append(this.createLineAnchor({ points: [m, R, y, T], pointsCursorType: L }, 0)), (this._renderer = e);
        }
      }
    },
    67857: (e, t, i) => {
    ...
    44993: (e, t, i) => {
      ...
      class o extends r.LineSourcePaneView {
        ...
        getCacheCanvas(e) {
          return this._createCacheIfRequired(e), (0, n.ensureNotNull)(this._cache).canvas();
        }
        getCacheRects(e, t) {
    ...
    94562: (e, t, i) => {
      ...
      class S extends R {
        ...
        drawTargetLabel(e) {
          ...
          e.fillText(a, L + N, I);
          var D = v(e, P - c - _ - p - u);
          this._data.clockWhite && e.drawImage(this._data.clockWhite, L + c + _ + D, I + 1);
          var A = v(e, P - c - p);
            ...
            (e.fillStyle = E),
              'up' === this._data.direction
                ? (w(e, b.x - 1, b.y - H - 2, this._targetWidth + 2, H, 5),
                  ...
                  O && e.drawImage(O, b.x + V - O.width - 4, b.y - H - 2 + Math.abs(H - O.height) / 2))
                : (w(e, b.x - 1, b.y + this._targetHeight + 2, this._targetWidth + 2, H, 5),
                  e.fill(),
                  (e.fillStyle = B),
                  e.fillText(k, b.x + V + W, b.y + this._targetHeight + 5),
                  O &&
                    e.drawImage(O, b.x + V - O.width - 4, b.y + this._targetHeight + 10 - Math.abs(H - O.height) / 2)),
              e.restore();
          } else e.restore();
        }
        drawStartLabel(e) {
        ...
        _updateImpl(e, t) {
            ...
            a.showLabel.value();
          {
            ...
            _ &&
              ...
              ((this._pipFormatter = new p.PipFormatter(_.pricescale, _.minmov, _.type, _.minmove2)),
              (this._lastSymbolInfo = _));
            const v = (0, s.forceLTRStr)(
              (0, n.ensureNotNull)(this._source.ownerSource()).formatter().format(d) +
                ' (' +
                f.format(u) +
                ') ' +
            ...
            const w = { x: 0, y: 10 },
              ...
              y = null === (i = a.fillLabelBackground) || void 0 === i ? void 0 : i.value();
            y && (R.backgroundColor = a.labelBackgroundColor.value()), this._labelRenderer.setData(R);
            const T = this._labelRenderer.measure(),
              b = (0, o.calculateLabelPosition)(T, h, c, w, e);
            this._labelRenderer.setPoints([b]), this._renderer.append(this._labelRenderer);
          }
          this.addAnchors(this._renderer);
        }
      }
    ...
    18452: (e, t, i) => {
      ...
      class R extends s {
        constructor(e, t) {
          super(e, t),
            ...
            (this._fullStopBgRenderer = new l(new d(d.MOVEPOINT), new d(d.MOVEPOINT))),
            (this._stopBgRenderer = new l(new d(d.MOVEPOINT), new d(d.MOVEPOINT))),
            (this._fullTargetBgRenderer = new l(new d(d.MOVEPOINT), new d(d.MOVEPOINT))),
            (this._targetBgRenderer = new l(new d(d.MOVEPOINT), new d(d.MOVEPOINT))),
        ...
        _updateImpl(e, t) {
          super._updateImpl(e, t), (this._renderer = null), (this._stopLevel = null), (this._profitLevel = null);
          ...
          (this._entryLevel = this._points[f.Entry].y),
            ...
            (this._closeBar = this._source._model.timeScale().indexToCoordinate(l.index));
          var x = new h(),
            R = this,
            y = this._source.properties(),
            T = this._points[f.Entry].x,
            b = this._points[f.ActualEntry] ? this._points[f.ActualEntry].x : this._points[f.Close].x,
            L = this._points[f.ActualClose] ? this._points[f.ActualClose].x : this._points[f.Close].x,
          ...
          if (
            ...
            ((k = {}).points = [C, M]),
              ...
              (k.backcolor = y.stopBackground.value()),
              (k.fillBackground = !0);
            var I = 100 - 100 * (1 - (N = 0.01 * y.stopBackgroundTransparency.value()) * N * N);
            (k.transparency = I),
              (k.extendLeft = !1),
              (k.extendRight = !1),
          ...
          if (
            ...
            ((k = {}).points = [C, M]),
              ...
              (k.fillBackground = !0);
            var N,
              D = 100 - 100 * (1 - (N = 0.01 * y.profitBackgroundTransparency.value()) * N * N);
            (k.transparency = D),
              (k.extendLeft = !1),
              (k.extendRight = !1),
          ...
          if (this._points[f.ActualEntry]) {
            ...
            (C = this._points[f.ActualEntry]),
              (M = this._isClosed ? this._points[f.ActualClose] : new n(this._closeBar, this._closeLevel));
            ((k = {}).points = [C, M]),
          ...
          (C = new n(T, this._points[f.Entry].y)), (M = new n(S, this._points[f.Entry].y));
          ...
          this._points[1] && void 0 !== this._pl && (Q = this._source.ownerSource().formatter().format(this._pl));
          var G = y.qty.value() / y.lotSize.value(),
            Z = a.symbolInfo(),
            X =
              'bitcoin' === Z.type || 'crypto' === Z.type || 'futures' === Z.type
                ? Math.round(1e3 * G) / 1e3
                : Math.floor(G);
          if (y.compact.value()) (U += Q ? Q + ' ~ ' : ''), (U += X + '\n'), (U += q);
          else {
            var J = this._isClosed ? this.i18nCache.closed : this.i18nCache.open;
            (U += Q ? this.i18nCache.pnl.format({ status: J, pnl: Q }) + ', ' : ''),
              (U += this.i18nCache.qty.format({ qty: X }) + '\n'),
              (U += this.i18nCache.ratio.format({ ratio: q }) + ' ');
          }
          var K = y.linecolor.value();
          this._pl < 0 ? (K = y.stopBackground.value()) : this._pl > 0 && (K = y.profitBackground.value()),
          ...
          A(this._stopLineRenderer, C, M, y.stopBackground.value()),
            Z &&
              ...
              ((this._pipFormatter = new _(Z.pricescale, Z.minmov, Z.type, Z.minmove2)), (this._lastSymbolInfo = Z));
          ...
          (U = y.compact.value()
            ...
            : this.i18nCache.stop.format({
                ...
                stopChangePip: this._pipFormatter ? v(this._pipFormatter.format(z)) : '',
                amount: v(y.amountStop.value()),
              })),
            E(this._stopLabelRenderer, j, U, y.stopBackground.value(), B < O ? 'bottom' : 'top', 0);
          ...
          if (
            ((U = y.compact.value()
              ...
              : this.i18nCache.target.format({
                  profitChange: v(this._source.ownerSource().formatter().format(W)),
                  profitChangePercent: v(this._percentageFormatter.format(F)),
                  profitChangePip: this._pipFormatter ? v(this._pipFormatter.format(W)) : '',
                  amount: v(y.amountTarget.value()),
                })),
            E(this._profitLabelRenderer, j, U, y.profitBackground.value(), B < O ? 'top' : 'bottom', 0),
            !P)
          ) {
      ...
      (R.prototype.i18nCache = {
        ...
        stop: r('Stop: {stopChange} ({stopChangePercent}) {stopChangePip}, Amount: {amount}'),
        target: r('Target: {profitChange} ({profitChangePercent}) {profitChangePip}, Amount: {amount}'),
        qty: r('Qty: {qty}'),
      }),
    ...
    21857: (e, t, i) => {
      ...
      function v(e, t, i, n) {
        ...
        return (
          (void 0 !== r && r.width === t) ||
            ((r = (function (e, t, i, n) {
              const r = (0, c.createDisconnectedCanvas)(document, new c.Size(t, t), 1),
                s = 0 === n ? Math.min(e.width, e.height) : Math.max(e.width, e.height),
      ...
      function R(e) {
        return e.inverseAnchorPosition ? m(e) - e.poleTailHeight * e.direction : m(e) + e.poleTailHeight * e.direction;
      }
      ...
      class T {
        ...
        addItem(e) {
          ...
          if (e.inverseAnchorPosition) {
            ...
            (e[0] = new n.Point(e[0].x, m(t))), (t.labelId = this._labels.length);
          } else {
            const r = new u.TextRenderer(i);
            this._labels.push(r), (t.labelId = this._labels.length), (t.labelHeight = r.measure().height);
            const s =
              1 === e.direction
                ? Math.min(t.poleStartY - t.labelHeight, t.anchorY)
                : Math.max(t.poleStartY + t.labelHeight, t.anchorY);
            t.anchorY !== s && ((t.anchorY = s), (i.points = [new n.Point(e.x, s)]), r.setData(i));
          }
          const r = new u.TextRenderer(i);
        ...
        hitTest(e, t) {
          ...
          for (let i = this._items.length - 1; i >= 0; --i) {
            ...
            if (s || a || o) {
              const e = { hideCrosshairLinesOnHover: !0, activeItem: s || a ? r.itemIndex : r.labelIndex };
              o ? (e.areaName = _.AreaName.Text) : a && (e.areaName = _.AreaName.Style);
              const i = this._showTooltipHandler;
              if (void 0 !== i) {
                const s = { targetBox: this._itemRect(r, t.cssHeight), item: r.srcItem },
                  a = (e) => {
                    const [t, i] = this._doesPointBelongToItem(r, e);
                    return t || i;
                  };
                (e.tapHandler = (e) => {
                  e.preventDefault(), i(s, new n.Point(e.clientX - e.localX, e.clientY - e.localY), a);
                }),
                  (e.clickHandler = (e) => {
                    i(s, new n.Point(e.clientX - e.localX, e.clientY - e.localY), a);
                  });
        ...
        draw(e, t) {
          ...
          for (const t of this._items) {
            ...
            e.moveTo(i, Math.round(x(t) * r)),
              ...
              0 !== t.poleTailHeight && (e.moveTo(i, Math.round(m(t) * r)), e.lineTo(i, Math.round(R(t) * r)));
          }
          e.stroke();
          for (const i of this._items)
            (e.strokeStyle = i.circleBorderColor),
              (e.fillStyle = i.circleBackgroundColor),
              i.circleRadius > 0 && y(e, i, n, this._data.shadowColor, this._data.outsideBorderColor, t),
        ...
        _doesPointBelongToItem(e, t) {
          const i = (0, h.lastMouseOrTouchEventInfo)().isTouch ? 20 : 3,
            r = e.x,
            s = (0, o.distanceToSegment)(new n.Point(r, x(e)), new n.Point(r, w(e)), t).distance < i,
            a =
              !s &&
              e.circleRadius > 0 &&
              (0, l.pointInCircle)(
      ...
      class S {
        ...
        _updateImpl(e) {
          ...
          for (const c of this._timeLine.items()) {
            ...
            const u = c.position(),
              _ = t === h ? (0, a.getSeriesPosition)(h, c) : (0, a.getNoDataPosition)(c, n, r);
            if (null === _) continue;
            const p = i.indexToCoordinate(_.index),
              g = n.priceToCoordinate(_.price, r),
              f = c.showPlate();
            let v = (0, a.positionToCoordinate)(u, e, g, _.positionPointDirection);
            ...
            const x = _.visualDirection !== _.positionPointDirection,
              ...
              y = {
                ...
                labelBackgroundColor: m ? l.labelSelectedColor : R ? l.labelHoveredColor : l.labelBackgroundColor,
              };
            this._timeLine.isItemHovered(c) ? (d = y) : this._timeLineItemsRenderer.addItem(y);
          }
      ...
      class I extends M.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            (this._storiesEventsPaneView = new S(t, e, _.HitTestResult.MOVEPOINT, void 0, e.isPhantom()));
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
        _updateImpl(e, t) {
          ...
          (a.data = s.data),
            (a.square = !0),
            this._renderer.append(
              this.createLineAnchor({ points: [a], pointsCursorType: [C.PaneCursorType.VerticalResize] }, 0),
            );
        }
      }
    },
        ...
        _updateImpl() {
          ...
          if (((this._label = null), !(this._source.points().length < 2))) {
            ...
            if (this._source.properties().showPriceRange.value() && this._source.priceScale()) {
              ...
              o = this._source.ownerSource().formatter().format(R) + ' (' + new h().format(100 * y) + ') ';
              var T = this._model.mainSeries().symbolInfo();
              T &&
                T !== this._lastSymbolInfo &&
                ((this._pipFormatter = new u(T.pricescale, T.minmov, T.type, T.minmove2)), (this._lastSymbolInfo = T)),
            ...
            if (this._source.properties().showBarsRange.value()) {
              ...
              (l += r('{count} bars').format({ count: w(b) })), m.push('barsRange');
            }
            (this._label =
              [w(o), l]
                .filter(function (e) {
            ...
            if (this._secondPoint && this._points.length > 0) {
              ...
              if (
                ...
                var I = this._source.properties().statsPosition.value(),
                  N = this._source.getPointByPosition(I, S.points[0], this._middlePoint, S.points[1]),
              ...
              this._angleLabelRenderer.setData(z), L.append(this._angleLabelRenderer);
            }
            0,
              this._secondPoint &&
                this._points.length > 0 &&
      ...
      t.TrendBasedFibExtensionPaneView = class extends c {
        ...
        getCacheRects(e, t) {
          ...
          if (i) {
            var r = this._points[1],
              ...
              a = Math.min(r.x, s.x),
              o = Math.max(r.x, s.x);
            (r = new n(a, this._levels[t].y)), (s = new n(o, this._levels[t].y));
            var l,
            ...
            switch (d.horzLabelsAlign.value()) {
              case 'left':
                ...
                break;
              case 'center':
                ((l = r.add(s).scaled(0.5)).x += i.width / 2), (l.x = Math.round(l.x));
                break;
              case 'right':
                d.extendLines.value()
                  ? (l = new n(h - 4, this._levels[t].y))
                  : (((l = new n(h + 4, this._levels[t].y)).x += i.width), (l.x = Math.round(l.x)));
            }
            var c = {
                left: i.left,
                top: this._cache.topByRow(this._cacheState.row),
        ...
        _updateImpl() {
          ...
          if (!(this._points.length < 2)) {
              ...
              for (T = 0; T < this._levels.length; T++)
                if (T > 0 && A) {
                  var O = this._levels[T - 1],
                    H = ((i = new n(N, this._levels[T].y)), (c = new n(D, O.y)), {});
                  (H.points = [i, c]),
            ...
            for (T = 0; T < this._levels.length; T++) {
              I = {
                points: [(i = new n(V, this._levels[T].y)), (c = new n(W, this._levels[T].y))],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
              ...
              if (
                (F.setData(I),
                F.setHitTest(new o(o.MOVEPOINT, { snappingPrice: this._levels[T].price }, this._levels[T].index)),
                M.append(F),
          ...
          if ((super._updateImpl(), (this._renderer = null), 3 === this._source.points().length)) {
            ...
            for (var p = 1; p <= 11; p++) {
              ...
              if (g.visible.value()) {
                ...
                l.showCoeffs.value() && ((w.text = f), (w.y = this._source.priceScale().height())),
                  this._levels.push(w);
              }
            }
          }
          if (!(this._points.length < 2)) {
            ...
            if (y)
              for (p = 1; p < this._levels.length; p++) {
                var S = this._levels[p - 1],
                  P = ((e = new n(S.x, 0)), (t = new n(this._levels[p].x, this._source.priceScale().height())), {});
                (P.points = [e, t]),
            ...
            for (p = 0; p < this._levels.length; p++) {
              if (void 0 !== this._levels[p].text) {
                ...
                switch (((M = 'left' === M ? 'right' : 'right' === M ? 'left' : 'center'), l.vertLabelsAlign.value())) {
                  case 'top':
      ...
      t.TrendLinePaneView = class extends a {
              ...
              if (!(n.length < 2)) {
                ...
                if (
                  ...
                  if (
                    ...
                    b = 'left' === C ? L.clone() : 'right' === C ? S.clone() : new r((s.x + a.x) / 2, (s.y + a.y) / 2);
                    ...
                    this._labelRenderer.setData(I), f.append(this._labelRenderer);
                  }
                  this._renderer = f;
                }
              }
        ...
        _statLabelData() {
          ...
          if (_.showPriceRange.value() && this._source.priceScale()) {
            ...
            e =
              this._source.ownerSource().formatter().format(n) + ' (' + this._percentageFormatter.format(100 * g) + ')';
            var x = this._model.mainSeries().symbolInfo();
            x &&
              x !== this._lastSymbolInfo &&
              ((this._pipFormatter = new u(x.pricescale, x.minmov, x.type, x.minmove2)), (this._lastSymbolInfo = x)),
          ...
          if (L || y) {
            ...
            (a = this._source.pointToScreenPoint(h).subtract(S)), (o = Math.round(1e5 * a.length()) / 1e5);
          }
          if (m || R || y) {
            if (((t = ''), m && ((r = h.index - d.index), (t += s('{count} bars').format({ count: T(r) }))), R)) {
          ...
          if (!o) {
            if (1 === this._points.length) {
              ...
              (t.data = 0),
                ...
                l.append(this.createLineAnchor({ points: [t], pointsCursorType: c }, 0));
            }
            this._renderer = l;
          }
        }
