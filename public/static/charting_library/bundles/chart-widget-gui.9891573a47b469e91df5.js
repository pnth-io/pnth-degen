  ...
  [5093],
  {
    ...
    30194: (e, t, s) => {
      ...
      const E = (0, c.humanReadableModifiers)(c.Modifiers.Alt, !1),
        ...
        H = (0, h.hotKeySerialize)({ keys: [E, k, y], text: '{0} + {1} + {2}' }),
        B = (0, l.t)('Zoom Out'),
        N = (0, l.t)('Zoom In'),
        ...
        Y = u.CheckMobile.any(),
        G = { zoomInOut: !0, maximize: !0, scrollLeftRight: !0, resetScale: !0, goToRealtime: !0 };
      class $ {
        constructor(e, t, s) {
          (this._widget = (0, i.ensureNotNull)((0, d.parseHtml)(U).querySelector('.control-bar-wrapper'))),
            ...
            (this._back = (0, i.ensureNotNull)((0, d.parseHtml)(j).querySelector('.control-bar__btn--back-present'))),
    ...
    56786: (e, t, s) => {
      ...
      class M {
        ...
        _renderTitle() {
          ...
          for (let t = 0; t < this._titlesSpawns.length; t++) {
            ...
            l.classList.add(y.title, i, 'apply-overflow-tooltip'),
              ...
              s.length > 0
                ? (l.appendChild(document.createTextNode(s)), l.classList.add(y.withDot))
        ...
        _updateTitlesHandler(e, t) {
          const s = (0, i.ensureNotNull)(this._titleElements[e]),
            l = 0 === t.length;
          s.classList.toggle(m.blockHidden, l), s.classList.toggle(y.withDot, !l), w(s, t);
        }
        _updateStates(e) {
      ...
      class f extends M {
        ...
        _updateValuesTitleHTMLElHandler(e, t = '') {
          ...
          w(s, t), s.classList.toggle(m.blockHidden, 0 === t.length), this._updateShowValues();
        }
        _isWidthButtonsMode() {
          return (
            null !== this._el &&
        ...
        _updateFlaggedState() {
          ...
          (0, i.ensureNotNull)(this._el).classList.toggle(y.flagged, Boolean(this._flagged.value())),
            this._updateTitleMaxWidth();
        }
      }
      ...
      class N {
        constructor(e, t, s) {
          (this._el = null),
            ...
            (this._toggleStateHandler = (0, p.wrapHandlerWithPreventEvent)(s.onCollapseDataSources)),
            (this._showObjectTreeHandler = (0, p.wrapHandlerWithPreventEvent)(s.onShowObjectsTreeDialog)),
            null !== this._el &&
      ...
      class R {
        ...
        _renderToggle(e) {
          this._options.showToggleButton &&
            (this._renderToggler = new N(e, this._options.themedColor, this._togglerOptions));
        }
        ...
        _showCollapsedDataSourcesTooltip() {
          (0, P.showOnElement)(this._collapsedDataSourcesEl, { text: this._options.collapsedDataSourcesTitle.value() }),
      ...
      class se {
        constructor(e, t, s, i, l) {
          (this._values = new (a())([])),
            ...
            (this._disabledOnInterval = new (a())(this._getDisabledOnIntervalState())),
            ...
            (0, q.combine)(() => ({}), this._isTitleHidden, this._isValuesHidden, this._disabled).subscribe(
        ...
        onToggleDisabled() {
          ...
          this._model.setProperty(
            e,
            t,
            (t ? J : Q).format({ title: new G.TranslatedString(this._source.name(), this._source.title()) }),
          ),
        ...
        _calcNewPosition(e) {
          ...
          if (e.hasOwnProperty('touches') && e.touches.length > 0)
            ...
            t = { clientX: (0, Z.isRtl)() ? s.right : s.left, clientY: s.top + s.height + 3 };
          } else {
            const s = e;
      ...
      class _e extends se {
        ...
        _updateTitles() {
          ...
          this._titles.title.setValue((0, U.clean)(t.title, !0)),
            ...
            this._titles.branding.setValue((0, U.clean)(null !== (e = t.branding) && void 0 !== e ? e : '', !0));
        }
        _updateValues() {
          ...
          if (0 === t.length) {
            const t = { value: new (a())(''), color: new (a())(''), visible: new (a())(i), title: new (a())(s) },
              l = e
                .items()
                .map((e) => ({
                  value: new (a())(e.value()),
      ...
      function ct(e, t) {
        const s = ht(t);
        return 0 === e[s].entries.length ? ct(e, s) : { dayIndex: s, entries: e[s].entries };
      }
      function _t(e, t) {
        const s = ut(t);
      ...
      const mt = {
        [nt.WeekDays.MONDAY]: { title: ot.weekDaysShortNames[nt.WeekDays.MONDAY], isActive: !1, entries: [] },
        [nt.WeekDays.TUESDAY]: { title: ot.weekDaysShortNames[nt.WeekDays.TUESDAY], isActive: !1, entries: [] },
        [nt.WeekDays.WEDNESDAY]: { title: ot.weekDaysShortNames[nt.WeekDays.WEDNESDAY], isActive: !1, entries: [] },
        [nt.WeekDays.THURSDAY]: { title: ot.weekDaysShortNames[nt.WeekDays.THURSDAY], isActive: !1, entries: [] },
        [nt.WeekDays.FRIDAY]: { title: ot.weekDaysShortNames[nt.WeekDays.FRIDAY], isActive: !1, entries: [] },
        [nt.WeekDays.SATURDAY]: { title: ot.weekDaysShortNames[nt.WeekDays.SATURDAY], isActive: !1, entries: [] },
        [nt.WeekDays.SUNDAY]: { title: ot.weekDaysShortNames[nt.WeekDays.SUNDAY], isActive: !1, entries: [] },
      };
      function gt(e, t) {
        ...
        for (const i of t) {
          ...
          for (let l = 0; l < n.length; l++) {
            const a = n[l],
              ...
              u = {
                start: { value: d, title: pt(o), isFirstOrLastPoint: o === i.start() },
                end: { value: r / rt.minutesPerDay, title: pt(r), isFirstOrLastPoint: n.length - 1 === l },
                type: s,
                tooltip: vt(i),
      ...
      class St {
        ...
        currentTimeValue() {
          return null === this._todayInExchangeTime
            ? -1
            : rt.get_minutes_from_midnight(this._todayInExchangeTime) / rt.minutesPerDay;
        }
        timezone() {
          ...
          const s = this._createSubSessionSpecs(e),
            l =
              (a =
                ...
                new Date().getDay()) < nt.WeekDays.SATURDAY
                ? a + 1
                : nt.WeekDays.SUNDAY;
          var a;
            ...
            (function (e) {
              for (const i of Object.keys(e)) {
                ...
                r.start.isFirstOrLastPoint ||
                  (r.showStartForLastEntry = ((t = a), (s = e[o].entries), gt(t[t.length - 1], s[s.length - 1]))),
                  d.end.isFirstOrLastPoint || (d.showEndForFirstEntry = bt(a, e[n].entries));
              }
              var t, s;
            })(n),
        ...
        _createSubSessionSpecs(e) {
          ...
          if (void 0 === e.subsessions)
            return new Map([[0, new dt.SessionSpec(e.timezone, e.session, e.session_holidays, e.corrections)]]);
      ...
      function Lt(e) {
        const { segment: t, forceStart: s, forceEnd: i } = e,
          ...
          a = l < 0.03,
          o = { left: 100 * t.start.value + '%', width: `calc(${100 * l}% + ${a ? 2 : 0}px)` },
          n = ft(
            kt.segment,
            Tt.get(t.type),
        ...
        return Mt.createElement('div', { className: n, style: o, 'data-tooltip': r });
      }
      function At(e) {
      ...
      function Ht(e) {
        ...
        const r = i.map((e) => Mt.createElement('div', { key: Wt(e), className: kt.timeMark }, e.title)),
        ...
        return Mt.createElement(
          ...
          Mt.createElement(
            ...
            Mt.createElement('div', { className: h, style: { left: 100 * i[0].value + '%', width: d + '%' } }, r),
          ),
        );
      }
      class Bt {
        ...
        renderer(e, t) {
          return (function (e) {
            const { key: t, className: s, now: i, timezone: l } = e,
              a = (0, Ct.useWatchedValueReadonly)({ watchedValue: e.sessionDays }),
            ...
            return Mt.createElement(
              ...
              Mt.createElement(
                ...
                Mt.createElement(
                  ...
                  Mt.createElement('div', { className: kt.now, style: { left: 100 * i + '%' } }),
                ),
              ),
      ...
      const Qt = (0, be.getLogger)('Chart.LegendWidget'),
        ...
        gs = (0, Pt.htmlEscape)((0, k.t)('Paid plans feature faster data updates.')),
      ...
      class Ss extends zt {
        ...
        setModel(e) {
          if ((this._dataUpdatedMode.destroy(), null === e))
            return (this._model = e), void (this._dataUpdatedMode = new (a())(null).spawn());
        ...
        async _getHtmls() {
          ...
          for (const a of e)
            if (
              ((t[a] = []),
              ['DelayToRealtime', 'DelayNoRealtime', 'DelayWithoutMarketAgreement', ...es].includes(a) &&
                (t[a].push(ds.format({ symbolName: s, time: this._model.time().toString() })),
                this._options.subscriptionFullInfo &&
                  null !== i &&
                  'DelayToRealtime' === a &&
                  t[a].push(us.format({ description: `<b>${i}</b>` })),
                null !== i && 'DelayNoRealtime' === a && t[a].push(cs.format({ description: `<b>${i}</b>` })),
                'DelayWithoutMarketAgreement' === a &&
                  t[a].push(ys.format({ listedExchange: this._model.listedExchange() })),
                this._options.subscriptionFullInfo &&
                  es.includes(a) &&
                  t[a].push(hs.format({ listedExchange: this._model.listedExchange() }))),
              'EOD' === a && (t[a] = [_s]),
              'TickByTick' === a &&
              ...
              0, t[a].push(bs.format({ symbolName: s, exchange: l }), '' !== e ? ws.format({ exchange: e }) : vs);
            }
        ...
        _getShortTexts() {
          ...
          for (const i of t)
            if (
              (['DelayToRealtime', 'DelayNoRealtime', ...es, 'DelayWithoutMarketAgreement'].includes(i) && (s[i] = ls),
              'EOD' === i && (s[i] = as),
              'TickByTick' === i && (s[i] = os),
              'BATSToRealtime' === i)
            ) {
              let t = null !== (e = this._model.firstReplacedByBatsExchange()) && void 0 !== e ? e : '';
              0, (s[i] = '' !== t ? rs.format({ exchange: t, originalExchange: ns }) : ns);
            }
      ...
      class xs extends zt {
        constructor(e, t, s) {
          super({ iconMap: Es, classNameMap: ks, tooltipMap: Vs, titleMap: Ws, titleColorMap: Ts, size: t }),
      ...
      class Ns extends zt {
        constructor(e, t) {
          super({ tooltipMap: Hs, iconMap: Ls, classNameMap: As, titleMap: Hs, titleColorMap: Bs, size: t }),
      ...
      const ai = (0, k.t)('Market open'),
        ...
        Vi = { market: hi, pre_market: ui, post_market: ci, out_of_session: _i, holiday: pi };
      function Wi(e) {
      ...
      const Di = {
          market: (e) => ('post_market' === e.status ? yi : wi).format({ remainingTime: xi(e.remainingSeconds) }),
          pre_market: (e) => vi.format({ remainingTime: xi(e.remainingSeconds) }),
          post_market: (e) => wi.format({ remainingTime: xi(e.remainingSeconds) }),
          out_of_session: (e) =>
            ('pre_market' === e.status ? Si : vi).format({ remainingTime: xi(e.remainingSeconds) }),
          holiday: (e) => ('pre_market' === e.status ? Si : vi).format({ remainingTime: xi(e.remainingSeconds) }),
        },
        Li = new Map([
          ['market', null],
          ['pre_market', null],
      ...
      class Ai extends zt {
        ...
        setModel(e) {
          if ((this._marketStatus.destroy(), this._sessionEdge.destroy(), null === e))
            return (this._marketStatus = new (a())(null).spawn()), void (this._sessionEdge = new (a())(null).spawn());
          (this._model = e),
      ...
      class Hi {
        constructor(e, t) {
          ...
          (this.visibleWidgetsCount = new (a())(0)),
            ...
            (this._renderer = new qs(this._size, this.visibleWidgetsCount, this._tooltips, {
        ...
        _recreateWidgets() {
          ...
          if (this._options.sourceStatusesEnabled) {
            ...
            if (null === this._dataSourceErrorStatusViewModel) {
              (this._dataSourceErrorStatusViewModel = new xs(this._source, this._size, this._options.sourceStatuses)),
          ...
          if (this._options.marketStatusEnabled) {
            ...
            if (null === this._marketStatusViewModel) {
              ...
              null !== t &&
                ((this._sessionWidget = new Bt(this._source)), (s.additionalWidgets = [this._sessionWidget])),
        ...
        _updateDropdownMenu() {
          Promise.all([s.e(7610), s.e(3894), s.e(9917), s.e(5514), s.e(306), s.e(4940), s.e(8643)])
            .then(s.bind(s, 36783))
            .then((e) => {
              e.render(
                this._menuOpened,
      ...
      class Ni {
        constructor(e, t) {
          ...
          this._dataSourceErrorStatus = (0, Bi.createWVFromGetterAndSubscriptions)(
      ...
      class $i {
        ...
        onShowLegendWidgetContextMenu(e, t) {
          ...
          return (function (e, t, s, i, l, a) {
            ...
            return (
              ...
              Be.ContextMenuManager.showMenu(o, l, void 0, { menuName: 'LegendPropertiesContextMenu' }, a)
            );
        ...
        updateLayout() {
          ...
          s > -1
            ? (e.splice(s, 1),
              ji ||
                ...
                (this._mainSeriesStatusWidget = new Oi(t, this._model.model(), this._options.statusesWidgets)),
          ...
          if (0 === o)
            for (let t = e.length - 1; t >= 0; t--)
              l.push(
                ...
                a.push(new Hi(new Ni(e[t], this._model.model()), this._options.statusesWidgets));
          else {
            let t = 0;
            for (let s = e.length - 1; s >= 0; s--)
              this._dataSourceViewModels[t]
                ? (this._dataSourceViewModels[t].updateSource(e[s]),
                  this._dataSourcesStatusesWidgets[t].updateSource(new Ni(e[s], this._model.model())))
                : (l.push(
                    new Ae(
                      this._model,
                      e[s],
                  ...
                  a.push(new Hi(new Ni(e[s], this._model.model()), this._options.statusesWidgets))),
                t++;
          ...
          0 !== l.length &&
            ...
            o !== this._dataSourceViewModels.length && this._updateCollapsedSourcesMode(),
          ...
          if (this._availableHeight > 0 && e > 2) {
            ...
            if (null !== s) {
              ...
              if (e > a + 1) {
                ...
                return (
                  this._collapsedDataSourcesTitle.setValue(t), void this._collapsedDataSourcesCount.setValue(e - a)
                );
              }
            }
          }
        ...
        _addCustomWidgetForLayerBlock(e) {
          ...
          for (const l of Array.from(t.keys())) {
            ...
            for (let t = a.length; t < o.length; t++) {
              ...
              0 === e && 0 === l && s.setGlobalVisibility(this._hideNotMainSources.opposite()),
                a.push(s),
      ...
      class _ {
        constructor(e, t, s) {
          ...
          this._render(),
            ...
            this._updateThemedColor(this._themedColor.value()),
            this._parentEl.classList.toggle(u.touchMode, d.trackingModeIsAvailable),
        ...
        updateWidgetModeByWidth(e) {
          ...
          i.classList.toggle(c.blockHidden, t || s),
            l.classList.toggle(c.blockHidden, t || !s || !this._actions.more.visible.value());
        }
        _render() {
        ...
        _renderActions() {
          ...
          for (const e of Object.keys(this._listActionsElements))
            (0, n.ensureNotNull)(this._listActionsElements[e]).classList.add(u.newButton);
        ...
        _updatePaneControlsWidgetVisibility() {
          ...
          this._parentEl.classList.toggle(u.hidden, !e),
            this._parentEl.classList.toggle(u.forceHidden, !this._globalVisibility.value() || t);
        }
        _updateThemedColor(e) {
          if (e.length > 0) {
            const [t, s, i] = (0, r.parseRgb)(e);
            this._parentEl.style.color = (0, r.rgbaToString)([t, s, i, (0, r.normalizeAlphaComponent)(0.8)]);
      ...
      class F {
        constructor(e, t, s, i, l) {
          (this._actions = {}),
            ...
            (this._upButtonVisibility = new (M())(this._getUpButtonVisibility())),
            (this._downButtonVisibility = new (M())(this._getDownButtonVisibility())),
            (this._maximizeButtonVisibility = new (M())(this._getMaximizeButtonVisibility())),
            ...
            (this._visibilityType = new (M())(this._visibilityTypeProperty.value())),
        ...
        _getCloseButtonVisibility() {
          ...
          let t = !1;
          return (
            e.containsMainSeries() || e.isMaximized() || L || (t = e.dataSources().some((e) => (0, o.isStudy)(e))), t
          );
        }
        _onCloseButton() {
      ...
      function l(e, t, s, l, a) {
        ...
        (o.className = t),
          ...
          void 0 !== e.title &&
            ...
            void 0 !== e.hotKeyTitle && (o.dataset.tooltipHotkey = e.hotKeyTitle)),
